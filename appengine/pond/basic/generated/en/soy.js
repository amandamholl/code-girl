...
Pond.Basic.soy.start = function(opt_data, opt_ignored, opt_ijData) {
  return Pond.Basic.soy.messages(null, null, opt_ijData) + '<div id="header"><div id="logo"><a href="./"> <img src="./index/horizontal-logo-01.png"></a></div><div class="farSide"><select id="languageMenu"></select>&nbsp;<button id="helpButton">Help &nbsp;<i class="fa fa-question"></i></button></div></div><div id="workspace">' + Pond.Basic.soy.toolbox(null, null, opt_ijData) + '<div id="blockly"></div>' + Pond.soy.visualization(null, null, opt_ijData) + '</div>' + BlocklyGames.soy.dialog(null, null, opt_ijData) + BlocklyGames.soy.doneDialog(null, null, opt_ijData) + BlocklyGames.soy.storageDialog(null, null, opt_ijData) + ((opt_ijData.level == 3) ? Pond.soy.helpUseScan(null, null, opt_ijData) : '') + '<div id="help" class="dialogHiddenContent"><div style="padding-bottom: 0.7ex; font-size: large; margin: 1em;">' + ((opt_ijData.level == 1) ? '<h3> Grace needs your help getting dressed for a mission! </h3>Put Grace\'s superhero outfit on in the correct order. Press "Check outfit!" to finish.<br><br><img src="pond/docs/order.png" width=146 style="margin-top:-10px;margin-bottom: -50px">' : '') + '</div>' + BlocklyGames.soy.ok(null, null, opt_ijData) + '</div><div id="error" class="dialogHiddenContent"><div style="padding-bottom: 0.7ex;margin: 1em;">' + ((opt_ijData.level == 1) ? '<table><tr><td><img src="common/ErrorAlert.png" width="100" height="100"></td><td>&nbsp;</td><td valign="top"><h3> Error </h3><p id="message"></p><p id="hint" style="display:none"><strong>Hint:</strong> Try moving the <span id="blockHint"></span> block.</p></td></tr></table>' : '') + '</div>' + BlocklyGames.soy.ok(null, null, opt_ijData) + '</div>';
};
