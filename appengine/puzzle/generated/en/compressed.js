...
function Hb(a){if(a.fa){var b=a.za;Kb(a.fa);b=b.replace(/\s/g,"\u00a0");x&&b&&(b+="\u200f");b||(b="\u00a0");a.fa.appendChild(document.createTextNode(b));a.Xc.width=0}}f.Gc=function(){return this.nb()};f.Ma=function(a){this.La(a)};f.Tf=function(a){if(!yb&&!zb||0===a.layerX||0===a.layerY)Lb(a)||2!=Mb&&this.h.Bc&&!I&&Nb(this)};f.Wc=function(){};/*
 ...
 limitations under the License.
*/
function Ob(){for(var a=J.vb(),b=[],c=[],d=0;d<a.length;d++){var e=a[d].Ak;e&&(e=e.call(a[d]))&&(e[2]?b.push(e):c.push(e))}c.sort(Pb);b.sort(Pb);return[c,b]}function Pb(a,b){var c=a[0].toLowerCase(),d=b[0].toLowerCase();return c>d?1:c<d?-1:0}
function Qb(a,b,c,d){function e(e,g){for(var l=0;l<e.length;l++){var m=Rb(d,g);Sb(m,"NAME").Ma(e[l][0]);for(var q=[],v=0;v<e[l][1].length;v++)q[v]="ARG"+v;m.Tk(e[l][1],q);m.eb();a.push(m);b.push(2*c)}}if(K.procedures_defnoreturn){var g=Rb(d,"procedures_defnoreturn");g.eb();a.push(g);b.push(2*c)}K.procedures_defreturn&&(g=Rb(d,"procedures_defreturn"),g.eb(),a.push(g),b.push(2*c));K.procedures_ifreturn&&(g=Rb(d,"procedures_ifreturn"),g.eb(),a.push(g),b.push(2*c));b.length&&(b[b.length-1]=3*c);g=Ob();
...
f.kh=function(){return C||void 0!==this.ta.offsetX?this.ta.offsetX:this.ta.layerX};f.Pj=function(a){Object.defineProperties(this,{offsetX:{writable:!0,enumerable:!0,configurable:!0,value:a}})};f.lh=function(){return C||void 0!==this.ta.offsetY?this.ta.offsetY:this.ta.layerY};f.Qj=function(a){Object.defineProperties(this,{offsetY:{writable:!0,enumerable:!0,configurable:!0,value:a}})};var vd="closure_lm_"+(1E6*Math.random()|0),wd={},xd=0;function yd(a,b,c,d,e){if(ea(b)){for(var g=0;g<b.length;g++)yd(a,b[g],c,d,e);return null}c=zd(c);if(a&&a[cd])a=a.w(b,c,d,e);else{if(!b)throw Error("Invalid event type");var g=!!d,h=Ad(a);h||(a[vd]=h=new gd(a));c=h.add(b,c,!1,d,e);c.He||(d=Bd(),c.He=d,d.src=a,d.cc=c,a.addEventListener?a.addEventListener(b.toString(),d,g):a.attachEvent(Cd(b.toString()),d),xd++);a=c}return a}
...
f.X=function(){this.v&&this.Ta();this.Jb&&(this.Jb.k(),delete this.Jb);Ud(this,function(a){a.k()});!this.bk&&this.s&&H(this.s);this.ra=this.ze=this.s=this.Db=this.R=null;Od.j.X.call(this)};f.Qd=function(a,b){this.vc(a,Vd(this),b)};
...
f.X=function(){P.j.X.call(this);this.qa&&(this.qa.k(),delete this.qa);delete this.F;this.kb=this.tb=null};f.Oj=function(a){this.tb=a};f.xf=function(){var a=this.tb;if(!a)return"";if(!p(a))if(ea(a))a=nb(a,Mc).join("");else{if(wc&&"innerText"in a)a=a.innerText.replace(/(\r\n|\r|\n)/g,"\n");else{var b=[];Nc(a,b,!0);a=b.join("")}a=a.replace(/ \xAD /g," ").replace(/\xAD/g,"");a=a.replace(/\u200B/g,"");wc||(a=a.replace(/ +/g," "));" "!=a&&(a=a.replace(/^\s*/,""))}return Ja(a)};
...
f.Fd=function(a){var b=this.getParent();b&&"function"==typeof b.isEnabled&&!b.isEnabled()||!Be(this,1,!a)||(a||(this.setActive(!1),this.gb(!1)),this.u()&&this.F.nc(this,a),this.hb(1,!a,!0))};f.gb=function(a){Be(this,2,a)&&this.hb(2,a)};f.setActive=function(a){Be(this,4,a)&&this.hb(4,a)};f.se=function(){return!!(this.$&8)};f.Rj=function(){Be(this,8,!0)&&this.hb(8,!0)};function Ce(a,b){Be(a,16,b)&&a.hb(16,b)}f.Lc=function(){return!!(this.$&64)};function De(a,b){Be(a,64,b)&&a.hb(64,b)}
...
f.nh=function(a){this.isEnabled()&&this.Bd(a)};f.Bd=function(a){Ee(this,16)&&Ce(this,!(this.$&16));Ee(this,8)&&this.Rj();Ee(this,64)&&De(this,!this.Lc());var b=new qd("action",this);a&&(b.altKey=a.altKey,b.ctrlKey=a.ctrlKey,b.metaKey=a.metaKey,b.shiftKey=a.shiftKey,b.Vf=a.Vf);return this.dispatchEvent(b)};f.ke=function(){Ee(this,32)&&Be(this,32,!0)&&this.hb(32,!0)};f.rd=function(){Ee(this,4)&&this.setActive(!1);Ee(this,32)&&Be(this,32,!1)&&this.hb(32,!1)};
...
kf:"goog-tree-expanded-folder-icon",Ng:"goog-tree-collapsed-folder-icon",lf:"goog-tree-file-icon",Sg:"goog-tree-expanded-folder-icon",Og:"goog-tree-collapsed-folder-icon",Xg:"selected"};function Tf(a,b,c){Q.call(this,a,b,c)}w(Tf,Q);Tf.prototype.ua=function(){if(this.rc)return this.rc;var a=this.getParent();return a&&(a=a.ua())?(Hf(this,a),a):null};Tf.prototype.be=function(){var a=this.Da(),b=this.Ri;if(a&&b)return b;b=this.jj;if(!a&&b)return b;b=this.ha;if(Xd(this)){if(a&&b.kf)return b.Xb+" "+b.kf;if(!a&&b.Ng)return b.Xb+" "+b.Ng}else if(b.lf)return b.Xb+" "+b.lf;return""};/*
 ...
 limitations under the License.
*/
function Uf(a){var b;x&&(b=workarea.je());var c=M("xml");a=Fa(a,!0);for(var d=0,e;e=a[d];d++){var g=Vf(e);e=e.O();g.setAttribute("x",x?b-e.x:e.x);g.setAttribute("y",e.y);c.appendChild(g)}c.setAttribute("level",R);return c}
...
n.Blockly.Xml.workspaceToDom=Uf;/*
 ...
 limitations under the License.
*/
function hg(a,b,c,d,e,g,h){var k=ig;x&&(k=-k);this.si=k*Math.PI/180;this.p=a;this.tb=b;this.Qh=c;a.Yc.appendChild(this.jf(b,!(!g||!h)));jg(this,d,e);g&&h||(a=this.tb.getBBox(),g=a.width+2*kg,h=a.height+2*kg);this.lc(g,h);lg(this);mg(this);this.ag=!0;I||(F(this.Td,"mousedown",this,this.wi),this.Ab&&F(this.Ab,"mousedown",this,this.Lj))}var kg=6,ig=20,ng=null,og=null;function pg(){ng&&(G(ng),ng=null);og&&(G(og),og=null)}f=hg.prototype;f.ag=!1;f.Wa=0;f.af=0;f.ic=0;f.Cd=0;f.A=0;f.ea=0;f.df=!0;
...
f.Lj=function(a){qg(this);pg();Lb(a)||(sg(tg),this.Kj=x?this.A+a.clientX:this.A-a.clientX,this.Jj=this.ea-a.clientY,ng=F(document,"mouseup",this,pg),og=F(document,"mousemove",this,this.Mj),ug(),a.stopPropagation())};f.Mj=function(a){this.df=!1;var b=this.Kj,c=this.Jj+a.clientY,b=x?b-a.clientX:b+a.clientX;this.lc(b,c);x&&lg(this)};function qg(a){a.Xa.parentNode.appendChild(a.Xa)}function jg(a,b,c){a.Wa=b;a.af=c;a.ag&&lg(a)}
...
f.lc=function(a,b){var c=2*kg;a=Math.max(a,c+45);b=Math.max(b,c+18);this.A=a;this.ea=b;this.Td.setAttribute("width",a);this.Td.setAttribute("height",b);this.Ab&&(x?this.Ab.setAttribute("transform","translate("+2*kg+", "+(b-c)+") scale(-1 1)"):this.Ab.setAttribute("transform","translate("+(a-c)+", "+(b-c)+")"));if(this.ag){if(this.df){var c=-this.A/4,d=-this.ea-25,e=this.p.wb();x?this.Wa-e.Oa-c-this.A<T?c=this.Wa-e.Oa-this.A-T:this.Wa-e.Oa-c>e.V&&(c=this.Wa-e.Oa-e.V):this.Wa+c<e.Oa?c=e.Oa-this.Wa:
e.Oa+e.V<this.Wa+c+this.A+10+T&&(c=e.Oa+e.V-this.Wa-this.A-T);this.af+d<e.Sb&&(d=this.Qh.getBBox().height);this.ic=c;this.Cd=d}lg(this);mg(this)}vg(this.Xa,"resize")};
...
f.od=function(){var a=Cg(this.g);return new Ub(a.x-this.Pd,a.y-this.Pd,this.bd+2*this.Pd,this.Ue+this.ad+2*this.Pd)};function Bg(a,b){a.Lc!=b&&(n.clearTimeout(a.Mf),a.Lc=b,a.bf())}f.bf=function(){this.Ob+=this.Lc?.2:-.2;this.Ob=Math.min(Math.max(this.Ob,0),1);var a=45*this.Ob;this.Se.setAttribute("transform","rotate("+(x?-a:a)+", "+(x?4:this.bd-4)+", "+(this.ad-2)+")");this.g.style.opacity=.2+.2*this.Ob;if(0<this.Ob||1>this.Ob)this.Mf=Cf(this.bf,20,this)};f.close=function(){Bg(this,!1)};/*
 ...
 limitations under the License.
*/
function Dg(a){this.p=a;this.P=null;this.qd=new Eg(a,!0,!0);this.Nd=new Eg(a,!1,!0);this.ed=E("rect",{height:T,width:T,style:"fill: #fff"},null);Fg(this.ed,a.Yc)}Dg.prototype.k=function(){G(this.Ee);this.Ee=null;H(this.ed);this.P=this.p=this.ed=null;this.qd.k();this.qd=null;this.Nd.k();this.Nd=null};
...
Dg.prototype.set=function(a,b){this.qd.set(a);this.Nd.set(b)};function Eg(a,b,c){this.p=a;this.Fe=c||!1;this.va=b;this.jf();b?(this.Ua.setAttribute("height",T),this.ba.setAttribute("height",T-6),this.ba.setAttribute("y",3)):(this.Ua.setAttribute("width",T),this.ba.setAttribute("width",T-6),this.ba.setAttribute("x",3));this.Dh=F(this.Ua,"mousedown",this,this.xj);this.Eh=F(this.ba,"mousedown",this,this.yj)}var Gg,Hg,T=15;aa("document.documentElement.ontouchstart")&&(T=25);f=Eg.prototype;
...
f.resize=function(a){if(!a&&(a=this.p.wb(),!a))return;if(this.va){var b=a.V;this.Fe?b-=T:this.G(b<a.Sa);this.Ea=b/a.yc;if(-Infinity===this.Ea||Infinity===this.Ea||isNaN(this.Ea))this.Ea=0;var c=a.V*this.Ea,d=(a.Oa-a.sb)*this.Ea;this.ba.setAttribute("width",Math.max(0,c));this.Tb=a.Pa;this.Fe&&x&&(this.Tb+=a.Pa+T);this.Te=a.Qa+a.la-T;this.g.setAttribute("transform","translate("+this.Tb+", "+this.Te+")");this.Ua.setAttribute("width",Math.max(0,b));this.ba.setAttribute("x",Ig(this,d))}else{b=a.la;this.Fe?
b-=T:this.G(b<a.Sa);this.Ea=b/a.Sa;if(-Infinity===this.Ea||Infinity===this.Ea||isNaN(this.Ea))this.Ea=0;c=a.la*this.Ea;d=(a.Sb-a.Za)*this.Ea;this.ba.setAttribute("height",Math.max(0,c));this.Tb=a.Pa;x||(this.Tb+=a.V-T);this.Te=a.Qa;this.g.setAttribute("transform","translate("+this.Tb+", "+this.Te+")");this.Ua.setAttribute("height",Math.max(0,b));this.ba.setAttribute("y",Ig(this,d))}Jg(this)};
...
f.yj=function(a){this.De();Lb(a)||(this.Tj=parseFloat(this.ba.getAttribute(this.va?"x":"y")),this.Vj=this.va?a.clientX:a.clientY,Gg=F(document,"mouseup",this,this.De),Hg=F(document,"mousemove",this,this.Aj));a.stopPropagation()};f.Aj=function(a){this.ba.setAttribute(this.va?"x":"y",Ig(this,this.Tj+((this.va?a.clientX:a.clientY)-this.Vj)));Jg(this)};f.De=function(){Lg();ug(!0);Gg&&(G(Gg),Gg=null);Hg&&(G(Hg),Hg=null)};
...
function fg(a,b){if(a.h==b.h)throw"Attempted to connect a block to itself.";if(a.h.o!==b.h.o)throw"Blocks are on different workspaces.";if(dh[a.type]!=b.type)throw"Attempt to connect incompatible types.";if(1==a.type||2==a.type){if(a.m)throw"Source connection already connected (value).";if(b.m){var c=S(b);c.ya(null);if(!c.K)throw"Orphan block does not have an output connection.";for(var d=a.h;d=eh(d,c);)if(S(d))d=S(d);else{fg(d,c.K);c=null;break}c&&setTimeout(function(){fh(c.K,b)},gh)}}else{if(a.m)throw"Source connection already connected (block).";
...
function lh(a){var b=Math.round(a.m.ib-a.ib),c=Math.round(a.m.N-a.N);if(0!=b||0!=c){a=S(a);var d=a.D();if(!d)throw"block is not rendered.";d=Yg(d);a.D().setAttribute("transform","translate("+(d.x-b)+", "+(d.y-c)+")");mh(a,-b,-c)}}
function nh(a,b,c,d){function e(a){var c=g[a];if((2==c.type||4==c.type)&&c.m||1==c.type&&c.m&&(!S(c).zb||I)||!hh(v,c))return!0;c=c.h;do{if(q==c)return!0;c=c.getParent()}while(c);var d=h-g[a].ib,c=k-g[a].N,d=Math.sqrt(d*d+c*c);d<=b&&(m=g[a],b=d);return c<b}if(a.m)return{n:null,Ih:b};var g=a.Fb[dh[a.type]],h=a.ib+c,k=a.N+d;c=0;for(var l=d=g.length-2;c<l;)g[l].N<k?c=l:d=l,l=Math.floor((c+d)/2);d=c=l;var m=null,q=a.h,v=a;if(g.length){for(;0<=c&&e(c);)c--;do d++;while(d<g.length&&e(d))}return{n:m,Ih:b}}
function hh(a,b){if(!a.wc||!b.wc)return!0;for(var c=0;c<a.wc.length;c++)if(-1!=b.wc.indexOf(a.wc[c]))return!0;return!1}f.Tc=function(a){a?(ea(a)||(a=[a]),this.wc=a,this.m&&!hh(this,this.m)&&(ch(this)?S(this).ya(null):this.h.ya(null),this.h.Ca())):this.wc=null;return this};
function oh(a){var b=V;function c(a){var c=e-d[a].ib,h=g-d[a].N;Math.sqrt(c*c+h*h)<=b&&l.push(d[a]);return h<b}var d=a.Fb[dh[a.type]],e=a.ib,g=a.N;a=0;for(var h=d.length-2,k=h;a<k;)d[k].N<g?a=k:h=k,k=Math.floor((a+h)/2);var h=a=k,l=[];if(d.length){for(;0<=a&&c(a);)a--;do h++;while(h<d.length&&c(h))}return l}
function ph(a){a.ob||kh(a.Fb[a.type],a);var b=[];if(1!=a.type&&3!=a.type)return b;if(a=S(a)){var c;a.isCollapsed()?(c=[],a.K&&c.push(a.K),a.J&&c.push(a.J),a.B&&c.push(a.B)):c=qh(a,!0);for(var d=0;d<c.length;d++)b.push.apply(b,ph(c[d]));0==b.length&&(b[0]=a)}return b}function Ng(){}Ng.prototype=[];function kh(a,b){if(b.ob)throw"Connection already in database.";for(var c=0,d=a.length;c<d;){var e=Math.floor((c+d)/2);if(a[e].N<b.N)c=e+1;else if(a[e].N>b.N)d=e;else{c=e;break}}a.splice(c,0,b);b.ob=!0}
function $g(a,b){if(!b.ob)throw"Connection not in database.";b.ob=!1;for(var c=0,d=a.length-2,e=d;c<e;)a[e].N<b.N?c=e:d=e,e=Math.floor((c+d)/2);for(d=c=e;0<=c&&a[c].N==b.N;){if(a[c]==b){a.splice(c,1);return}c--}do{if(a[d]==b){a.splice(d,1);return}d++}while(d<a.length&&a[d].N==b.N);throw"Unable to find connection in connectionDB.";};/*
 ...
 limitations under the License.
*/
var K={ak:0,Ti:function(){var a=(++K.ak).toString();return Pg?rh(a):a},jk:function(a){var b={I:function(){var b=this;this.Uc(a.rk);this.Kb=a.Kb;"string"==typeof a.Aa?this.Wc(a.Aa):"function"==typeof a.Aa&&this.Wc(function(){return a.Aa(b)});"undefined"!=a.Ej?sh(this,a.Ej):(th(this,"undefined"==typeof a.Gj?!0:a.Gj),uh(this,"undefined"==typeof a.wj?!0:a.wj));var d=[];d.push(a.text);a.ri&&a.ri.forEach(function(a){"undefined"==a.type||1==a.type?d.push([a.name,a.check,"undefined"==typeof a.align?1:a.align]):
jb("addTemplate() can only handle value inputs.")});d.push(1);a.nj&&this.Sk(a.nj);vh.prototype.xd.apply(this,d)}};b.Pc=a.Vk?function(){var b=a.tj?a.Jk():document.createElement("mutation");b.setAttribute("is_statement",this.isStatement||!1);return b}:a.tj;K[a.nk]=b}};/*
...
f.Ij=function(){var a=this.ga.$b(),b=2*kg;this.ld.setAttribute("width",a.width-b);this.ld.setAttribute("height",a.height-b);this.Fa.style.width=a.width-b-4+"px";this.Fa.style.height=a.height-b-4+"px"};
...
d.appendChild(this.Fa);this.ld.appendChild(d);F(this.Fa,"mouseup",this,this.Zj);this.ga=new hg(a,this.ld,this.Ba.Cb,this.Ic,this.Jc,this.A,this.ea);F(this.ga.Xa,"resize",this,this.Ij);this.sc();this.za=null}else this.ga.k(),this.ld=this.Fa=this.ga=null;this.La(b);this.lc(c.width,c.height)}};f.Zj=function(){qg(this.ga);this.Fa.focus()};f.$b=function(){return this.u()?this.ga.$b():{width:this.A,height:this.ea}};f.lc=function(a,b){this.Fa?this.ga.lc(a,b):(this.A=a,this.ea=b)};
...
f.G=function(a){var b=[];if(this.Q==a)return b;for(var c=(this.Q=a)?"block":"none",d=0,e;e=this.oa[d];d++)e.G(a);if(this.n){if(a)b=ph(this.n);else if(d=this.n,d.ob&&$g(d.Fb[d.type],d),d.m){e=S(d).mb();for(var g=0;g<e.length;g++){for(var h=e[g],k=qh(h,!0),l=0;l<k.length;l++){var m=k[l];m.ob&&$g(d.Fb[m.type],m)}h=Vh(h);for(k=0;k<h.length;k++)h[k].G(!1)}}if(d=S(this.n))d.D().style.display=c,a||(d.t=!1)}return b};f.Tc=function(a){if(!this.n)throw"This input does not have a connection.";this.n.Tc(a);return this};
...
function ag(a,b){return Pg?Zh.get(a):Ga(b,a)}f.k=function(a,b,c){$h(this,a);this.o&&!c&&(this.o.Ne(this),this.o=null);U==this&&(U=null);for(a=this.jb.length-1;0<=a;a--)this.jb[a].k(!1);for(a=0;b=this.S[a];a++)b.k();this.S.length=0;b=qh(this,!0);for(a=0;a<b.length;a++)c=b[a],c.m&&c.disconnect(),b[a].k();if(Pg&&!ai)Zh["delete"](this.id.toString())};
function $h(a,b){var c;c=!1;if(a.K)a.K.m&&a.ya(null);else{var d=null;a.B&&a.B.m&&(d=a.B.m,a.ya(null));var e=Wf(a);if(b&&e){var g=a.J.m;e.ya(null);d&&hh(d,g)&&fg(d,g)}}c&&a.moveBy(V*(x?-1:1),2*V)}function qh(a,b){var c=[];if(b||a.t)if(a.K&&c.push(a.K),a.J&&c.push(a.J),a.B&&c.push(a.B),b||!a.Wb)for(var d=0,e;e=a.S[d];d++)e.n&&c.push(e.n);return c}
f.Ca=function(){if(0==Mb){var a=jh(this);if(!a.Mb)for(var b=qh(this,!1),c=0;c<b.length;c++){var d=b[c];d.m&&ch(d)&&S(d).Ca();for(var e=oh(d),g=0;g<e.length;g++){var h=e[g];d.m&&h.m||jh(h.h)!=a&&(ch(d)?fh(h,d):fh(d,h))}}}};f.getParent=function(){return this.ec};function bi(a){for(;;){do{var b=a;a=a.getParent();if(!a)return null}while(Wf(a)==b);return a}}function Wf(a){return a.J&&S(a.J)}function jh(a){var b=a;do a=b,b=a.ec;while(b);return a}f.ac=function(){return this.jb};
...
1);fj.Wd=null}else fj.xb()},xb:function(){lf==fj&&mf();fj.Wd=null},qk:function(a,b){return function(){var c=$f(a.o,b),d=a.O();d.x=x?d.x-V:d.x+V;d.y+=2*V;c.moveBy(d.x,d.y);c.select()}}};/*
...
f.eb=function(){for(var a=0,b;b=this.S[a];a++)b.I();this.Ae&&this.Ae.sk();this.sc();I||F(this.D(),"mousedown",this,this.Ce);this.o.aa.appendChild(this.D());u(this.onchange)&&F(this.o.aa,"blocklyWorkspaceChange",this,this.onchange)};f.select=function(){U&&Tg(U);U=this;this.Xe();vg(this.o.aa,"blocklySelectChange")};function Tg(a){U=null;a.Me();vg(a.o.aa,"blocklySelectChange")}f.Ae=null;f.L=null;f.Od=null;function Vh(a){var b=[];a.Ae&&b.push(a.Ae);a.L&&b.push(a.L);a.Od&&b.push(a.Od);return b}
...
f.Tf=function(a){var b=this;lj(function(){si();if(U&&ah){fg(bh,ah);if(b.t){var c=(ch(bh)?ah:bh).h;mj("click");var d=Cg(c.g);c.K?(d.x+=x?3:-3,d.y+=13):c.B&&(d.x+=x?-23:23,d.y+=3);c=E("circle",{cx:d.x,cy:d.y,r:0,fill:"none",stroke:"#888","stroke-width":10},z);c.kg=new Date;nj(c)}b.o.Na&&b.o.Na.close()}else Ug(b.o,a)&&((c=b.o.Na)&&Cf(c.close,100,c),U.k(!1,!0),vg(window,"resize"));ah&&(H(Zg.me),delete Zg.me,ah=null);sg(oj.OPEN)})};
function ti(a,b){if(!I&&a.contextMenu){var c=[];if(a.Ac&&!I&&a.zb&&!I&&!a.Mb){var d={text:pj,enabled:!0,Ya:function(){var b=Vf(a);gg(b);var b=$f(a.o,b),c=a.O();c.x=x?c.x-V:c.x+V;c.y+=2*V;b.moveBy(c.x,c.y);b.select()}};a.mb().length>Ha(a.o)&&(d.enabled=!1);c.push(d);a.Bc&&!I&&!a.Wb&&sa&&(d={enabled:!0},a.L?(d.text=qj,d.Ya=function(){a.Dd(null)}):(d.text=rj,d.Ya=function(){a.Dd("")}),c.push(d));if(!a.Wb)for(d=0;d<a.S.length;d++)if(1==a.S[d].type){d={enabled:!0};d.text=a.wd?sj:tj;d.Ya=function(){bg(a,
...
(1==y.type?h=!0:5==y.type&&(l=!0),c=Math.max(c,t.$a)))}for(e=0;y=b[e];e++)if(y.Wh=!1,-1==y.type)for(g=0;t=y[g];g++)if(1==t.type){y.height+=20;y.Wh=!0;break}b.Re=20+d;k&&(b.T=Math.max(b.T,b.Re+30));h?b.T=Math.max(b.T,c+20+8):l&&(b.T=Math.max(b.T,c+20));b.ij=h;b.Dk=k;b.Ck=l;d=a;this.K?this.jg=this.Qe=!0:(this.jg=this.Qe=!1,this.B&&(a=S(this.B))&&Wf(a)==this&&(this.Qe=!0),Wf(this)&&(this.jg=!0));h=this.O();k=[];l=[];a=[];c=[];t=b.T;this.Qe?(k.push("m 0,0"),a.push("m 1,1")):(k.push("m 0,2"),a.push(x?
...
var of=null,lf=null,dk=null;function kf(a){mf();lf=a;dk=null;of.style.display="block"}function mf(){lf&&(of.style.display="none",dk&&dk(),dk=lf=null,Kb(of))}function pf(a,b,c,d){b<d.y&&(b=d.y);x?a>c.width+d.x&&(a=c.width+d.x):a<d.x&&(a=d.x);of.style.left=a+"px";of.style.top=b+"px"};/*
 ...
 limitations under the License.
*/
function ek(a,b,c,d){this.h=null;this.ea=Number(c);this.A=Number(b);this.Xc={height:this.ea+10,width:this.A};this.za=d||"";this.Y=E("g",{},null);this.oe=E("image",{height:this.ea+"px",width:this.A+"px",y:-12},this.Y);this.Ma(a);vb&&(this.Ie=E("rect",{height:this.ea+"px",width:this.A+"px",y:-12,"fill-opacity":0},this.Y))}w(ek,Gb);f=ek.prototype;f.clone=function(){return new ek(this.Bk(),this.A,this.ea,this.nb())};f.Ie=null;f.uc=!1;
f.I=function(a){this.h||(this.h=a,a.D().appendChild(this.Y),a=this.Ie||this.oe,a.Aa=this.h,Jh(a))};f.k=function(){H(this.Y);this.Ie=this.oe=this.Y=null};f.Wc=function(a){(this.Ie||this.oe).Aa=a};f.Gc=function(){return this.Sj};f.Ma=function(a){null!==a&&(this.Sj=a,this.oe.setAttributeNS("http://www.w3.org/1999/xlink","xlink:href",p(a)?a:""))};f.La=function(a){null!==a&&(this.za=a)};f.Sc=function(){};/*
...
function hk(a){this.zi=W(a,"clientId");this.vg=gk.userId;document.getElementById(W(a,"authButtonElementId"));document.getElementById(W(a,"authDivElementId"))}hk.prototype.start=function(){gapi.load("auth:client,drive-realtime,drive-share",function(){})};
function ik(a,b,c,d){function e(c){gapi.Eb.ca.files.re({resource:{mimeType:b,title:a,parents:[{id:c}]}}).Zb(d)}function g(){function a(b){gapi.Eb.ca.Hj.re({fileId:"appdata",resource:{key:"folderId",value:b}}).Zb(function(){e(b)})}function b(){gapi.Eb.ca.files.re({resource:{mimeType:"application/vnd.google-apps.folder",title:c}}).Zb(function(b){a(b.id)})}gapi.Eb.ca.Hj.get({fileId:"appdata",propertyKey:"folderId"}).Zb(function(d){if(d.error)c?b():a("root");else{var g=d.result.value;gapi.Eb.ca.files.get({fileId:g}).Zb(function(a){a.error||
a.labels.Wk?b():e(g)})}})}gapi.Eb.load("drive","v2",function(){g()})}function jk(a){this.Ch=W(a,"onFileLoaded");this.uj=W(a,"newFileMimeType","application/vnd.google-apps.drive-sdk");this.sh=W(a,"initializeModel");this.Kh=W(a,"registerTypes",function(){});this.Ag=W(a,"afterAuth",function(){});this.ti=W(a,"autoCreate",!1);this.Mi=W(a,"defaultTitle","New Realtime File");this.Li=W(a,"defaultFolderTitle","");this.Bg=W(a,"afterCreate",function(){});this.cf=new hk(a)}
...
jk.prototype.oh=function(a){a.type!=gapi.ca.qb.xg.hk&&(a.type==gapi.ca.qb.xg.ck?(alert("An Error happened: "+a.message),window.location.href="/"):a.type==gapi.ca.qb.xg.fk&&(alert("The file was not found. It does not exist or you do not have read access to the file."),window.location.href="/"))};
jk.prototype.load=function(){var a=gk.fileIds;a&&(a=a.split(","));var b=this.cf.vg,b=gk.state;if(a)for(var c in a)gapi.ca.qb.load(a[c],this.Ch,this.sh,this.oh);else{if(b){var d;try{d=JSON.parse(b)}catch(e){d=null}if("open"==d.action){a=d.Ek;b=d.vg;kk(this,a,b);return}}this.ti&&lk(this)}};function lk(a){ik(a.Mi,a.uj,a.Li,function(b){b.id?(a.Bg&&a.Bg(b.id),kk(a,[b.id],a.cf.vg)):(console.error("Error creating file."),console.error(b))})};/*
...
function zk(a,b){gapi.Eb.ca.Gh.list({fileId:a}).Zb(function(a){for(var d=0;d<a.items.length;d++){var e=a.items[d];if("owner"==e.Nk){b(e.domain);break}}})}
var Dk={clientId:null,authButtonElementId:"authorizeButton",authDivElementId:"authButtonDiv",initializeModel:function(a){Xh=a;var b=a.uk();a.Ec().set("blocks",b);b=a.tk();a.Ec().set("topBlocks",b);rk&&a.Ec().set(rk,a.vk(sk))},autoCreate:!0,defaultTitle:"Realtime Blockly File",defaultFolderTitle:"Realtime Blockly Folder",newFileMimeType:null,onFileLoaded:function(a){nk=a;a:{for(var b=a.Vi(),c=0;c<b.length;c++){var d=b[c];if(d.pj){ok=d.Qk;break a}}ok=void 0}Xh=a.ze;Zh=Xh.Ec().get("blocks");Qg=Xh.Ec().get("topBlocks");
Xh.Ec().addEventListener(gapi.ca.qb.We.gk,tk);Zh.addEventListener(gapi.ca.qb.We.ik,xk);pk();a.addEventListener(gapi.ca.qb.We.dk,Ak);a.addEventListener(gapi.ca.qb.We.ek,Bk);Ck();a=Qg;for(b=0;b<a.length;b++)c=a.get(b),vk(c,!0)},registerTypes:function(){var a=gapi.ca.qb.wk;a.Lk(vh,"Block");vh.prototype.id=a.gf("id");vh.prototype.wg=a.gf("xmlDom");vh.prototype.Je=a.gf("relativeX");vh.prototype.Ke=a.gf("relativeY");a.Rk(vh,vh.prototype.initialize)},afterAuth:function(){setTimeout(function(){},18E5)},afterCreate:function(a){var b=
gapi.Eb.ca.Gh.re({fileId:a,resource:{type:"anyone",role:"writer",value:"default",withLink:!0}});b.Zb(function(c){c.error&&zk(a,function(c){b=gapi.Eb.ca.Gh.re({fileId:a,resource:{type:"domain",role:"writer",value:c,withLink:!0}});b.Zb(function(){})})})}};function Ek(){var a=wa,b=W(a,"chatbox");b&&(rk=W(b,"elementId"),sk=W(b,"initText",Fk));Dk.zi=W(a,"clientId");mk=W(a,"collabElementId")}
function Tj(a,b){Ek();Pg=!0;Gk(b);pk=function(){a();if(rk){var b=Xh.Ec().get(rk),d=document.getElementById(rk);gapi.ca.qb.xk.mk(b,d);d.disabled=!1}};qk=new jk(Dk);qk.start()}
function Gk(a){a.style.background="url("+zg+"progress.gif) no-repeat center center";var b=Wc(a),c=M("div");c.id=Dk.authDivElementId;var d=M("p",null,Hk);c.appendChild(d);d=M("button",null,"Authorize");d.id=Dk.kk;c.appendChild(d);a.appendChild(c);c.style.display="none";c.style.position="relative";c.style.textAlign="center";c.style.border="1px solid";c.style.backgroundColor="#f6f9ff";c.style.borderRadius="15px";c.style.boxShadow="10px 10px 5px #888";c.style.width=b.width/3+"px";a=Wc(c);c.style.left=
(b.width-a.width)/3+"px";c.style.top=(b.height-a.height)/4+"px"}function Ck(){if(mk){var a;a=mk;a=p(a)?document.getElementById(a):a;Kb(a);for(var b=nk.Vi(),c=0;c<b.length;c++){var d=b[c],e=M("img",{src:d.Kk||zg+"anon.jpeg",alt:d.displayName,title:d.displayName+(d.pj?" ("+Ik+")":"")});e.style.backgroundColor=d.color;a.appendChild(e)}}}function Ak(){Ck()}function Bk(){Ck()}function rh(a){var b=ok+"-"+a;return Zh.has(b)?rh("-"+a):b};/*
...
/*
 ...
 limitations under the License.
*/
var zg="https://blockly-demo.appspot.com/static/media/",xg=64,yg=92,Ag="sprites.png",dh=[,2,1,4,3],ck=Object.create(null),U=null,I=!1,ah=null,bh=null,vi=5,V=20,gh=250,jj=30,J=null,Jk=null,Mb=0,Kk=null;function Rh(){return{width:z.Gg,height:z.Fg}}function kj(){var a=z,b=a.parentNode,c=b.offsetWidth,b=b.offsetHeight;a.Gg!=c&&(a.setAttribute("width",c+"px"),a.Gg=c);a.Fg!=b&&(a.setAttribute("height",b+"px"),a.Fg=b);J.Rb&&J.Rb.resize()}
function Xj(a){kj();si();ug();var b=a.target&&a.target.nodeName&&"svg"==a.target.nodeName.toLowerCase();!I&&U&&b&&Tg(U);a.target==z&&Lb(a)?Lk(a):(I||b)&&J.Rb&&(J.rf=!0,J.mg=a.clientX,J.ng=a.clientY,J.Uj=J.wb(),J.Wj=J.scrollX,J.Xj=J.scrollY,"mouseup"in Jj&&(Kk=F(document,"mouseup",null,ak)),Da=F(document,"mousemove",null,Mk))}function ak(){sg(oj.OPEN);J.rf=!1;Kk&&(G(Kk),Kk=null);Da&&(G(Da),Da=null)}
function Mk(a){if(J.rf){Lg();var b=J.Uj,c=J.Wj+(a.clientX-J.mg),d=J.Xj+(a.clientY-J.ng),c=Math.min(c,-b.sb),d=Math.min(d,-b.Za),c=Math.max(c,b.V-b.sb-b.yc),d=Math.max(d,b.la-b.Za-b.Sa);J.Rb.set(-c-b.sb,-d-b.Za);a.stopPropagation()}}
function Zj(a){if(!rg(a))if(27==a.keyCode)ug();else if(8==a.keyCode||46==a.keyCode)try{U&&U.Ac&&!I&&(ug(),U.k(!0,!0))}finally{a.preventDefault()}else if(a.altKey||a.ctrlKey||a.metaKey)if(U&&U.Ac&&!I&&U.zb&&!I&&U.o==J&&(ug(),67==a.keyCode?Nk():88==a.keyCode&&(Nk(),U.k(!0,!0))),86==a.keyCode&&Jk){a=J;var b=Jk;if(!(b.getElementsByTagName("block").length>=Ha(a))){var c=$f(a,b),d=parseInt(b.getAttribute("x"),10),b=parseInt(b.getAttribute("y"),10);if(!isNaN(d)&&!isNaN(b)){x&&(d=-d);do for(var e=!1,g=a.vb(),
h=0,k;k=g[h];h++)k=k.O(),1>=Math.abs(d-k.x)&&1>=Math.abs(b-k.y)&&(d=x?d-V:d+V,b+=2*V,e=!0);while(e);c.moveBy(d,b)}c.select()}}}function si(){gj&&(G(gj),gj=null);hj&&(G(hj),hj=null);var a=U;if(2==Mb&&a){var b=a.O();mh(a,b.x-a.Sh,b.y-a.Th);delete a.$d;Bj(a,!1);a.C();Cf(a.Ca,gh,a);vg(window,"resize");a.o.lb()}Mb=0;sg(oj.OPEN);ui()}function Nk(){var a=U,b=Vf(a);gg(b);a=a.O();b.setAttribute("x",x?-a.x:a.x);b.setAttribute("y",a.y);Jk=b}
...
jl()+'</div><div id="answers" class="dialogHiddenContent"><div id="answerMessage"></div><div id="graph"><div id="graphValue"></div></div>'+jl()+"</div>"};var bl="puzzle";Y.Qf=function(){window.location=window.location.protocol+"//"+window.location.host+"/movie?lang="+Uk+"&level="+(R+1)};
function ml(){function a(){c.style.width=window.innerWidth-20+"px";c.style.height=window.innerHeight-c.offsetTop-15+"px"}document.body.innerHTML=ll();Y.I();var b=-1!=Tk.indexOf(Uk),c=document.getElementById("blockly");a();window.addEventListener("resize",a);Pj(document.getElementById("blockly"),{media:"media/",rtl:b,scrollbars:!1,trashcan:!1});var d=$k(R);try{var e=window.sessionStorage.we}catch(g){e=null}if(e)delete window.sessionStorage.we,b=Yf(e),Zf(J,b);else if(d)b=Yf(d),Zf(J,b);else{for(var h=
[],k=[],l=[],e=1;cl("Puzzle_animal"+e);){var m=Rb(J,"animal");m.fc(e);h.push(m);m=Rb(J,"picture");m.fc(e);k.push(m);for(var q=1;cl("Puzzle_animal"+e+"Trait"+q);)m=Rb(J,"trait"),m.fc(e,q),l.push(m),q++;e++}nl(h);nl(k);nl(l);h=[].concat(h,k,l);b&&h.reverse();for(e=0;m=h[e];e++)cg(m,!1),m.eb(),m.C();for(e=k=0;m=h[e];e++){var v=m.D().getBBox();m.pk=v.width;m.ok=v.height;m.Hg=v.width*v.height;k+=m.Hg}kj();l=Rh();l.width-=50;l.height-=50;for(e=q=0;m=h[e];e++){var v=m.D().getBBox(),t=b?v.width+q/k*l.width:
q/k*(l.width-v.width),t=Math.round(t+50*Math.random()),v=Math.round(Math.random()*(l.height-v.height));m.moveBy(t,v);q+=m.Hg}}dl("checkButton",ol);dl("helpButton",function(){pl(!0)});d||pl(!1);if(C){h=J.vb();for(e=0;m=h[e];e++)m.select();Tg(U)}V*=2;bk(["puzzle/win.mp3","puzzle/win.ogg"],"win")}window.location.pathname.match(/readonly.html$/)?window.addEventListener("load",function(){Y.mj(kl()+'<div id="blockly"></div>')}):window.addEventListener("load",ml);
...
function ol(){for(var a=J.vb(),b=0,c=[],d=0,e;e=a[d];d++)e.Jf()||(b++,e.select(),c.push(e));var g=document.getElementById("graphValue");setTimeout(function(){g.style.width=100*(a.length-b)/a.length+"px"},500);1==b?d=[X("Puzzle_error1"),X("Puzzle_tryAgain")]:b?d=[X("Puzzle_error2").replace("%1",b),X("Puzzle_tryAgain")]:(d=[X("Puzzle_error0").replace("%1",a.length)],Y.Nj(),document.getElementsByClassName("secondary").addEventListener("click",Z.Ai()));e=document.getElementById("answerMessage");e.textContent=
"";for(var h=0;h<d.length;h++){var k=document.createElement("div");k.appendChild(document.createTextNode(d[h]));e.appendChild(k)}d=document.getElementById("answers");e=document.getElementById("checkButton");Z.pc(d,e,!0,!0,{width:"25%",left:-1!=Tk.indexOf(Uk)?"5%":"70%",top:"5em"},b?Z.og:Y.pe);Z.lg();if(c.length){nl(c);var l=c[0],m=function(){l.select();Z.yb&&(setTimeout(function(){Tg(l)},150),setTimeout(m,300))};m()}else setTimeout(ql,2E3),U&&Tg(U)}
