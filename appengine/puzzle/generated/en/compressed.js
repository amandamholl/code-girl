...
y=[],y.type=q&&3!=t.type?-1:t.type,y.height=0,b.push(y));y.push(t);t.jc=25;t.ka=q&&1==t.type?20.5:0;if(t.n&&t.n.m){var ya=pi(S(t.n));t.jc=Math.max(t.jc,ya.height);t.ka=Math.max(t.ka,ya.width)}v==g.length-1&&t.jc--;y.height=Math.max(y.height,t.jc);t.$a=0;1==b.length&&(t.$a+=x?-e:e);for(var ya=!1,Df=0,hb;hb=t.oa[Df];Df++){0!=Df&&(t.$a+=10);var gi=hb.nh();hb.ka=gi.width;hb.Pe=ya&&hb.uc?10:0;t.$a+=hb.ka+hb.Pe;y.height=Math.max(y.height,gi.height);ya=hb.uc}-1!=y.type&&(3==y.type?(k=!0,d=Math.max(d,t.$a)):
...
!0);Z.pc(a,null,!1,!0,{width:"40%",left:"30%"},function(){document.body.removeEventListener("keydown",Z.Ag,!0)});document.body.addEventListener("keydown",Z.Ag,!0)}},Lk:function(){var a=document.getElementById("dialogDone");J&&(document.getElementById("dialogLinesText").textContent="Play a challenge to unlock new features.");var b=document.getElementById("containerCode");a.removeChild(b);10>R?X("Games_nextLevel").replace("%1",R+1):X("Games_finalLevel");b=document.getElementById("doneCancel");b.addEventListener("click",
Z.Ha,!0);b.addEventListener("touchend",Z.Ha,!0);b=document.getElementById("doneOk");1==R&&(b.addEventListener("click",function(){window.open("/turtle","_self")},!0),b.addEventListener("touchend",function(){window.open("/turtle","_self")},!0));2==R&&(b.addEventListener("click",function(){window.open("/turtle?lang=en?level=2","_self")},!0),b.addEventListener("touchend",function(){window.open("/turtle?lang=en?level=2","_self")},!0));3==R&&(b.addEventListener("click",function(){window.open("/bird?lang=en?level=3",
"_self")},!0),b.addEventListener("touchend",function(){window.open("/bird?lang=en?level=3","_self")},!0));4==R&&(b.addEventListener("click",function(){window.open("/maze?lang=en?level=5","_self")},!0),b.addEventListener("touchend",function(){window.open("/maze?lang=en?level=5","_self")},!0));5==R&&(b.addEventListener("click",function(){window.open("/maze?lang=en?level=6","_self")},!0),b.addEventListener("touchend",function(){window.open("/maze?lang=en?level=6","_self")},!0));6==R&&(b.addEventListener("click",
function(){window.open("/maze?lang=en?level=10","_self")},!0),b.addEventListener("touchend",function(){window.open("/maze?lang=en?level=10","_self")},!0));Z.pc(a,null,!1,!0,{width:"40%",left:"30%"},function(){document.body.removeEventListener("keydown",Z.xc,!0)});document.body.addEventListener("keydown",Z.xc,!0)}};
...
('<div id="dialogStorage" class="dialogHiddenContent"><div id="containerStorage"></div>'+kl()+"</div>")+'<div id="help" class="dialogHiddenContent"><div style="padding-bottom: 0.7ex; font-size: large; margin: 1em;">For each animal (blue), attach its picture and choose its number of legs.</div><iframe style="height: 180px; width: 90%; border: none; margin: 1em;" src="readonly.html?app=puzzle&lang=',b;b=Vk&&Vk.Di&&Vk.Di===gl?Vk.content:String(Vk).replace(jl,il);return a+b+'&xml=%3Cblock+type%3D%22animal%22+x%3D%225%22+y%3D%225%22%3E%3Cmutation+animal%3D%221%22%3E%3C%2Fmutation%3E%3Ctitle+name%3D%22LEGS%22%3E1%3C%2Ftitle%3E%3Cvalue+name%3D%22PIC%22%3E%3Cblock+type%3D%22picture%22%3E%3Cmutation+animal%3D%221%22%3E%3C%2Fmutation%3E%3C%2Fblock%3E%3C%2Fvalue%3E%3Cstatement+name%3D%22TRAITS%22%3E%3Cblock+type%3D%22trait%22%3E%3Cmutation+animal%3D%221%22+trait%3D%222%22%3E%3C%2Fmutation%3E%3Cnext%3E%3Cblock+type%3D%22trait%22%3E%3Cmutation+animal%3D%221%22+trait%3D%221%22%3E%3C%2Fmutation%3E%3C%2Fblock%3E%3C%2Fnext%3E%3C%2Fblock%3E%3C%2Fstatement%3E%3C%2Fblock%3E"></iframe>'+
kl()+'</div><div id="answers" class="dialogHiddenContent"><div id="answerMessage"></div><div id="graph"><div id="graphValue"></div></div>'+kl()+"</div>"};var cl="puzzle";Y.Rf=function(){window.location=window.location.protocol+"//"+window.location.host+"/movie?lang="+Vk+"&level="+R};
...
"";for(var h=0;h<d.length;h++){var k=document.createElement("div");k.appendChild(document.createTextNode(d[h]));e.appendChild(k)}d=document.getElementById("answers");e=document.getElementById("checkButton");Z.pc(d,e,!0,!0,{width:"25%",left:-1!=Uk.indexOf(Vk)?"5%":"70%"},b?Z.pg:Y.qe);Z.mg();if(c.length){ol(c);var l=c[0],m=function(){l.select();Z.yb&&(setTimeout(function(){Ug(l)},150),setTimeout(m,300))};m()}else setTimeout(rl,2E3),U&&Ug(U)}
...
c);setTimeout(sl.bind(null,a,b),50)}}function ql(a){var b=document.getElementById("help"),c=document.getElementById("helpButton");Z.pc(b,c,a,!0,{width:"50%",left:"25%"},Z.pg);Z.mg()};
