...
Movie.soy.start = function(opt_data, opt_ignored, opt_ijData) {
  return Movie.soy.messages(null, null, opt_ijData) + '<div id="header"><div id="logo"><a href="./"> <img src="./index/horizontal-logo-01.png"></a></div><div class="farSide"><select id="languageMenu"></select>&nbsp;<button id="signoutButton" onClick="location.href=\'/\'">Signout</button><button id="linkButton" title="Save and link to blocks."><img src="media/1x1.gif" class="link icon21"></button>&nbsp;<button id="helpButton">Help</button></div></div><div id="workspace"><div id="levelLinks">' + BlocklyGames.soy.levelLinks({level: opt_ijData.level, maxLevel: opt_ijData.maxLevel, lang: opt_ijData.lang, suffix: ''}, null, opt_ijData) + '<div class="farSide" id="unlock"><button class="secondary" title="Unlock">Unlock Accessories</button></div></div>' + Movie.soy.toolbox(null, null, opt_ijData) + '<div id="blockly"></div><div id="visualization"><canvas id="scratch" width="400" height="580" style="display: none"></canvas><canvas id="superhero" width="400" height="580" style="display: block"></canvas><canvas id="hatching" width="400" height="580" style="display: none"></canvas><canvas id="axies" width="400" height="580" style="display: none"></canvas><canvas id="display" width="400" height="580" style="vertical-align: bottom;z-index:20"></canvas></div></div>' + BlocklyGames.soy.dialog(null, null, opt_ijData) + BlocklyGames.soy.doneDialog(null, null, opt_ijData) + BlocklyGames.soy.abortDialog(null, null, opt_ijData) + BlocklyGames.soy.storageDialog(null, null, opt_ijData) + '<div id="help" class="dialogHiddenContent"><div style="padding-bottom: 0.7ex">' + ((opt_ijData.level == 1) ? 'Customize your avatar using the toolbar! Start with the shirts.' : (opt_ijData.level == 2) ? 'Add bottoms to your avatar using the toolbar.' : (opt_ijData.level == 3) ? 'Add shoes to your avatar using the toolbar.' : (opt_ijData.level == 4) ? 'Add accessories to your avatar using the toolbar.' : '') + '</div>' + BlocklyGames.soy.ok(null, null, opt_ijData) + '</div>';
};
