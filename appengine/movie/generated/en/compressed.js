...
function ln(a){var b=document.getElementById("visualization"),c=document.createElement("canvas");c.id="answer"+a;c.width=400;c.height=600;c.style.display="none";b.appendChild(c);var d=c.getContext("2d"),e=new Image;e.onload=function(){d.drawImage(e,0,0,400,400)};e.src="./movie/superhero.jpg";X.canvas.width=X.canvas.width;Dm(a);d=c.getContext("2d");d.globalCompositeOperation="copy";d.drawImage(X.canvas,0,0)}
function kn(){var a=document.getElementById("hatching").getContext("2d");a.strokeStyle="#fff";a.lineWidth=1;for(var b=-600;600>b;b+=4)a.beginPath(),a.moveTo(b,-b),a.lineTo(b+600,-b+400),a.stroke()}
function mn(){var a=document.getElementById("axies").getContext("2d");a.lineWidth=1;a.strokeStyle="#bba";a.fillStyle="#bba";a.font="normal 14px sans-serif";for(var b=1,c=.1;.9>c;c+=.1)a.beginPath(),a.moveTo(400*c,600),a.lineTo(400*c,600-9*b),a.stroke(),a.beginPath(),a.moveTo(0,600*c),a.lineTo(9*b,600*c),a.stroke(),2==b&&(a.fillText(Math.round(100*c),400*c+2,596),a.fillText(Math.round(100-100*c),3,600*c-2)),b=1==b?2:1}
