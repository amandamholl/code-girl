...
function zc(a){return Infinity==a.Kh?Infinity:a.Kh-a.cb().length}f.wb=function(){};/*
...
function ud(a,b){if(0>=b||isNaN(b))b=0;else{var c=a.hb?"width":"height",d=parseFloat(a.Jb.getAttribute(c)),c=parseFloat(a.Da.getAttribute(c));b=Math.min(b,d-c)}return b}function vd(a){var b=parseFloat(a.Da.getAttribute(a.hb?"x":"y")),c=parseFloat(a.Jb.getAttribute(a.hb?"width":"height")),b=b/c;isNaN(b)&&(b=0);c={};a.hb?c.x=b:c.y=b;a.v.Mk(c)}f.set=function(a){this.Da.setAttribute(this.hb?"x":"y",a*this.mb);vd(this)};
function rd(a,b){var c=b.nextSibling,d=b.parentNode;if(!d)throw"Reference node has no parent.";c?d.insertBefore(a,c):d.appendChild(a)};/*
 ...
 limitations under the License.
*/
function yd(a,b){yd.j.constructor.call(this);this.yc=a;this.Mk=b;var c=[];c[1]=new zd;c[2]=new zd;c[3]=new zd;c[4]=new zd;this.sr=c}n(yd,wc);f=yd.prototype;f.B=!0;f.hk=!1;f.nh=!1;f.scrollX=0;f.scrollY=0;f.Ab=null;f.ph=null;f.Ic=null;f.I=function(){this.o=F("g",{},null);this.ba=F("g",{},this.o);this.be=F("g",{},this.o);this.wb();return this.o};
f.m=function(){this.B=!1;yd.j.m.call(this);this.o&&(ed(this.o),this.o=null);this.be=this.ba=null;this.Z&&(this.Z.m(),this.Z=null);this.Ab&&(this.Ab.m(),this.Ab=null)};function Ad(){var a=G;if(ic&&!y){a.Ab=new id(a);var b=a.Ab.I();a.o.insertBefore(b,a.ba);a.Ab.g()}}f.oe=function(a){yd.j.oe.call(this,a);Bd&&this==G&&-1==Cd.indexOf(a)&&Cd.push(a)};f.qg=function(a){yd.j.qg.call(this,a);Bd&&this==G&&Cd.Hu(a)};f.clear=function(){bd();yd.j.clear.call(this)};f.Kf=function(){return this.yc().xa};
...
f.eh=function(){this.td=F("svg",{x:Rc,y:Rc},null);F("rect",{"class":"blocklyMutatorBackground",height:"100%",width:"100%"},this.td);var a=this;this.v=new yd(function(){var b=0;t&&(b+=a.fe);return{Ta:a.df,xa:0,sb:0,rb:b}},null);this.v.Z=new Td;this.v.Z.pe=!1;this.td.appendChild(this.v.Z.I());this.td.appendChild(this.v.I());return this.td};f.sc=function(){this.J.wc&&!y?Kd.prototype.sc.call(this):(this.P(!1),Ld(this.Ia,"blocklyIconGroup"))};
...
Fd)for(var a=xc(b.v,!1),c=0,d;d=a[c];c++){var m=d.ia(),p=Vd(d);20>m.y+p.height&&d.moveBy(0,20-p.height-m.y)}b.pc.u==b.v&&(a=b.J.B,b.J.B=!1,b.J.Cd(b.pc),b.J.B=a,b.J.sa(),b.J.B&&b.J.G(),b.sg(),b.J.u.wb())});this.Lc()}else this.td=null,this.v.m(),this.pc=this.v=null,this.la.m(),this.la=null,this.df=this.fe=0,this.ki&&(D(this.ki),this.ki=null)};f.m=function(){this.J.Gb=null;Kd.prototype.m.call(this)};/*
...
function K(a,b){var c;a.L&&(a.L.m(),a.L=null);b&&(void 0===c&&(c=null),a.L=new Wd(a,4),a.L.s(c));a.B&&(a.G(),a.Ma())}function L(a,b){var c;a.C&&(a.C.m(),a.C=null);b&&(void 0===c&&(c=null),a.C=new Wd(a,3),a.C.s(c));a.B&&(a.G(),a.Ma())}function I(a,b,c){a.H&&(a.H.m(),a.H=null);b&&(void 0===c&&(c=null),a.H=new Wd(a,2),a.H.s(c));a.B&&(a.G(),a.Ma())}function A(a,b){a.Ke=b;a.B&&(a.G(),a.Ma(),a.u.wb())}f.Te=function(a){this.disabled=a};
...
R.ai=function(a,b){var c="";if(!a.H||!a.H.w){var d=a.Df();d&&(c+=kf(d,"// ")+"\n");for(var e=0;e<a.T.length;e++)if(1==a.T[e].type){var h=v(a.T[e].t);if(h){for(var d=[],h=h.Eb(),k=0;k<h.length;k++){var m=h[k].Df();m&&d.push(m)}d.length&&d.push("");(d=d.join("\n"))&&(c+=kf(d,"// "))}}}e=jf(R,a.C&&v(a.C));return c+b+e};/*
 ...
 limitations under the License.
*/
R.ks={};R.lists_create_empty=function(){return["[]",R.qb]};R.lists_create_with=function(a){for(var b=Array(a.ja),c=0;c<a.ja;c++)b[c]=S(a,"ADD"+c,R.qa)||"null";b="["+b.join(", ")+"]";return[b,R.qb]};R.lists_repeat=function(a){var b=of("lists_repeat",["function "+R.Ea+"(value, n) {","  var array = [];","  for (var i = 0; i < n; i++) {","    array[i] = value;","  }","  return array;","}"]),c=S(a,"ITEM",R.qa)||"null";a=S(a,"NUM",R.qa)||"0";return[b+"("+c+", "+a+")",R.Q]};
...
"      throw 'Unhandled option (lists_getSublist).';","    }","    return at;","  }","  at1 = getAt(where1, at1);","  at2 = getAt(where2, at2) + 1;","  return list.slice(at1, at2);","}"])+"("+b+", '"+c+"', "+e+", '"+d+"', "+a+")",R.Q]};/*
 ...
 limitations under the License.
*/
R.ct={};R.variables_get=function(a){return[R.fa.getName(N(a,"VAR"),sf),R.qb]};R.variables_set=function(a){var b=S(a,"VALUE",R.Pc)||"0";return R.fa.getName(N(a,"VAR"),sf)+" = "+b+";\n"};/*
 ...
 limitations under the License.
*/
R.text={};R.text=function(a){return[R.Ck(N(a,"TEXT")),R.qb]};R.text_join=function(a){var b;if(0==a.ja)return["''",R.qb];if(1==a.ja)return b=S(a,"ADD0",R.D)||"''",["String("+b+")",R.Q];if(2==a.ja)return b=S(a,"ADD0",R.D)||"''",a=S(a,"ADD1",R.D)||"''",["String("+b+") + String("+a+")",R.Ng];b=Array(a.ja);for(var c=0;c<a.ja;c++)b[c]=S(a,"ADD"+c,R.qa)||"''";b="["+b.join(",")+"].join('')";return[b,R.Q]};
...
R.text_trim=function(a){var b={LEFT:".trimLeft()",RIGHT:".trimRight()",BOTH:".trim()"}[N(a,"MODE")];return[(S(a,"TEXT",R.W)||"''")+b,R.Q]};R.text_print=function(a){return"window.alert("+(S(a,"TEXT",R.D)||"''")+");\n"};R.text_prompt=function(a){var b="window.prompt("+R.Ck(N(a,"TEXT"))+")";"NUMBER"==N(a,"TYPE")&&(b="parseFloat("+b+")");return[b,R.Q]};R.text_prompt_ext=function(a){var b="window.prompt("+(S(a,"TEXT",R.D)||"''")+")";"NUMBER"==N(a,"TYPE")&&(b="parseFloat("+b+")");return[b,R.Q]};/*
 ...
 limitations under the License.
*/
R.qj={};R.colour_picker=function(a){return["'"+N(a,"COLOUR")+"'",R.qb]};R.colour_random=function(){return[of("colour_random",["function "+R.Ea+"() {","  var num = Math.floor(Math.random() * Math.pow(2, 24));","  return '#' + ('00000' + num.toString(16)).substr(-6);","}"])+"()",R.Q]};
...
f.Y=function(){this.R&&this.Db();this.zc&&(this.zc.m(),delete this.zc);bh(this,function(a){a.m()});!this.dt&&this.F&&ed(this.F);this.Za=this.ag=this.F=this.tc=this.ra=null;Wg.j.Y.call(this)};f.ne=function(a,b){this.Ad(a,ch(this),b)};
...
function dh(a,b){return a.ra?a.ra[b]||null:null}function bh(a,b,c){a.ra&&Xa(a.ra,b,c)}function gh(a,b){return a.ra&&b?Wa(a.ra,b):-1}f.removeChild=function(a,b){if(a){var c=l(a)?a:Zg(a);a=ah(this,c);if(c&&a){var d=this.tc;c in d&&delete d[c];bb(this.ra,a);b&&(a.Db(),a.F&&ed(a.F));a.$a(null)}}if(!a)throw Error("Child is not in parent component");return a};f.Gk=function(a){for(var b=[];fh(this);)b.push(this.removeChild(dh(this,0),a));return b};function hh(a){if(a.classList)return a.classList;a=a.className;return l(a)&&a.match(/\S+/g)||[]}function ih(a,b){return a.classList?a.classList.contains(b):ab(hh(a),b)}function jh(a,b){a.classList?a.classList.add(b):ih(a,b)||(a.className+=0<a.className.length?" "+b:b)}function kh(a,b){if(a.classList)Xa(b,function(b){jh(a,b)});else{var c={};Xa(hh(a),function(a){c[a]=!0});Xa(b,function(a){c[a]=!0});a.className="";for(var d in c)a.className+=0<a.className.length?" "+d:d}}
...
f.handleEvent=function(a){var b=a.bb,c,d,e=b.altKey;q&&"keypress"==a.type?(c=this.Cc,d=13!=c&&27!=c?b.keyCode:0):r&&"keypress"==a.type?(c=this.Cc,d=0<=b.charCode&&63232>b.charCode&&Ch(c)?b.charCode:0):sb?(c=this.Cc,d=Ch(c)?b.keyCode:0):(c=b.keyCode||this.Cc,d=b.charCode||0,Kh&&(e=this.Tg),vb&&63==d&&224==c&&(c=191));var h=c=Dh(c),k=b.keyIdentifier;c?63232<=c&&c in Hh?h=Hh[c]:25==c&&a.shiftKey&&(h=9):k&&k in Ih&&(h=Ih[k]);a=h==this.yb;this.yb=h;b=new Lh(h,d,a,b);b.altKey=e;this.dispatchEvent(b)};
f.n=function(){return this.F};function Gh(a,b,c){a.Wf&&a.detach();a.F=b;a.Vf=Sb(a.F,"keypress",a,c);a.Eh=Sb(a.F,"keydown",a.Tr,c,a);a.Wf=Sb(a.F,"keyup",a.Ur,c,a)}f.detach=function(){this.Vf&&($b(this.Vf),$b(this.Eh),$b(this.Wf),this.Wf=this.Eh=this.Vf=null);this.F=null;this.Cc=this.yb=-1};f.Y=function(){Fh.j.Y.call(this);this.detach()};function Lh(a,b,c,d){Mb.call(this,d);this.type="key";this.keyCode=a;this.charCode=b;this.repeat=c}n(Lh,Mb);function Mh(a,b,c){Wg.call(this,c);if(!b){b=this.constructor;for(var d;b;){d=ja(b);if(d=oh[d])break;b=b.j?b.j.constructor:null}b=d?ha(d.Yb)?d.Yb():new d:null}this.M=b;this.vg(void 0!==a?a:null)}n(Mh,Wg);f=Mh.prototype;f.Wa=null;f.$=0;f.va=39;f.Zg=255;f.sd=0;f.pa=!0;f.Xb=null;f.Ge=!0;f.Sg=!1;f.Fs=null;f.Ga=function(){return this.M.Ga(this)};f.Gf=function(){return this.Ya||(this.Ya=new Fh)};
f.te=function(a,b){b?a&&(this.Xb?ab(this.Xb,a)||this.Xb.push(a):this.Xb=[a],this.M.te(this,a,!0)):a&&this.Xb&&bb(this.Xb,a)&&(0==this.Xb.length&&(this.Xb=null),this.M.te(this,a,!1))};f.I=function(){var a=this.M.I(this);this.F=a;yh(this.M,a,this.If());this.Sg||this.M.di(a,!1);this.K()||this.M.P(a,!1)};f.If=function(){return this.Fs};f.xb=function(){return this.M.xb(this.n())};
f.za=function(){Mh.j.za.call(this);zh(this,this.F);this.M.Je(this);if(this.va&-2&&(this.Ge&&Nh(this,!0),this.va&32)){var a=this.Ga();if(a){var b=this.Gf();Gh(b,a);$g(this).O(b,"key",this.Fb).O(a,"focus",this.Lf).O(a,"blur",this.Ee)}}};
function Nh(a,b){var c=$g(a),d=a.n();b?(c.O(d,"mouseover",a.He).O(d,"mousedown",a.Ac).O(d,"mouseup",a.Ie).O(d,"mouseout",a.yh),a.Fe!=ba&&c.O(d,"contextmenu",a.Fe),q&&c.O(d,"dblclick",a.$j)):(c.Kb(d,"mouseover",a.He).Kb(d,"mousedown",a.Ac).Kb(d,"mouseup",a.Ie).Kb(d,"mouseout",a.yh),a.Fe!=ba&&c.Kb(d,"contextmenu",a.Fe),q&&c.Kb(d,"dblclick",a.$j))}f.Db=function(){Mh.j.Db.call(this);this.Ya&&this.Ya.detach();this.K()&&this.isEnabled()&&this.M.Kc(this,!1)};
...
f.wh=function(a){this.Rg&&this.Ga().focus();return ri.j.wh.call(this,a)};f.lj=function(a){return(this.ir||a.isEnabled())&&a.K()&&!!(a.va&2)};f.$c=function(a){var b=ri.j.$c.call(this,a);b||bh(this,function(c){!b&&c.Mr&&c.qk==a.keyCode&&(this.isEnabled()&&this.nb(c),b=c.Fb(a))},this);return b};
...
f.ka=function(a){this.h&&(this.of.style.fill=Nd(Od(this.h.bh)));null!==a&&a!==this.da&&(this.da=a,Qe(this),this.Ka&&(t?this.Ka.insertBefore(this.of,this.Ka.firstChild):this.Ka.appendChild(this.of)),this.h&&this.h.B&&(this.h.G(),this.h.Ma(),this.h.u.wb()))};f.m=function(){xi(this);T.j.m.call(this)};/*
...
var U={};/*
 ...
 limitations under the License.
*/
var sf="VARIABLE";function rf(a){a=a||G;var b;if(a.Eb)b=a.Eb();else if(a.cb)b=a.cb();else throw"Not Block or Workspace: "+a;a=Object.create(null);for(var c=0;c<b.length;c++){var d=b[c].Zb;if(d)for(var d=d.call(b[c]),e=0;e<d.length;e++){var h=d[e];h&&(a[h.toLowerCase()]=h)}}b=[];for(var k in a)b.push(a[k]);return b}function Ei(a,b){for(var c=G.cb(),d=0;d<c.length;d++){var e=c[d].Hb;e&&e.call(c[d],a,b)}}
...
f.select=function(){var a=this.gb();a&&a.Ib(this)};function cj(a,b){if(a.bi!=b){a.bi=b;dj(a);var c=a.n();c&&(rh(c,"selected",b),b&&(c=a.gb().n(),rh(c,"activedescendant",Zg(a))))}}f.lb=function(){return this.ue};
...
function ck(a){function b(a){var k=Yi(a);if(k){var m=!d||c==a.getParent()&&!e?a.Na.yj:a.Na.xj;k.className=m;if(k=a.Ef())k.className=gj(a)}bh(a,b)}var c=a,d=c.Xe,e=c.ji;b(a)}function dk(a){0!=a.ii&&(a.ii=!1,a.R&&ck(a))}function ek(a){if(0!=a.rd){a.rd=!1;if(a.R){var b=aj(a);b&&(b.className=a.Be())}a.Zc()==a&&dh(a,0)&&a.Ib(dh(a,0))}}f.Sf=function(){Yj.j.Sf.call(this);var a=this.n();qh(a,"tree");rh(a,"labelledby",Xi(this).id)};
f.za=function(){Yj.j.za.call(this);var a=this.n();a.className=this.Na.Ij;a.setAttribute("hideFocus","true");a=this.n();a.tabIndex=0;var b=this.Ya=new Fh(a),c=this.qh=new Xj(a);$g(this).O(c,"focusout",this.Nr).O(c,"focusin",this.Rr).O(b,"key",this.Fb).O(a,"mousedown",this.xh).O(a,"click",this.xh).O(a,"dblclick",this.xh);this.Sf()};f.Db=function(){Yj.j.Db.call(this);this.Ya.m();this.Ya=null;this.qh.m();this.qh=null};
...
f.sa=function(){for(var a=0,b;b=this.T[a];a++)b.g();this.Gb&&Sd(this.Gb);this.Lc();y||C(this.V(),"mousedown",this,this.eg);this.u.ba.appendChild(this.V());ha(this.onchange)&&C(this.u.ba,"blocklyWorkspaceChange",this,this.onchange)};f.select=function(){Gd&&Hd();Gd=this;this.Qg();dd(this.u.ba,"blocklySelectChange")};function Hd(){var a=Gd;Gd=null;a.pg();dd(a.u.ba,"blocklySelectChange")}f.Gb=null;f.ca=null;f.gc=null;
...
f.Ph=function(a){var b=this;tk(function(){uj();if(Gd&&Yd){Mc(Zd,Yd);if(b.B){var c=($d(Zd)?Yd:Zd).h;uk("click");var d=od(c.o);c.H?(d.x+=t?3:-3,d.y+=13):c.L&&(d.x+=t?-23:23,d.y+=3);c=F("circle",{cx:d.x,cy:d.y,r:0,fill:"none",stroke:"#888","stroke-width":10},jc);c.mi=new Date;vk(c)}b.u.Ab&&b.u.Ab.close()}else Id(b.u,a)&&((c=b.u.Ab)&&fc(c.close,100,c),Gd.m(!1,!0),dd(window,"resize"));Yd&&(ed(Wd.Of),delete Wd.Of,Yd=null);$c(wk.OPEN)})};
function vj(a,b){if(!y&&a.contextMenu){var c=[];if(a.Gd&&!y&&a.cc&&!y&&!a.ac){var d={text:U.nm,enabled:!0,Ua:function(){var b=Bc(a);Nc(b);var b=Gc(a.u,b),c=a.ia();c.x=t?c.x-he:c.x+he;c.y+=2*he;b.moveBy(c.x,c.y);b.select()}};a.Eb().length>zc(a.u)&&(d.enabled=!1);c.push(d);a.wc&&!y&&!a.Rc&&lc&&(d={enabled:!0},a.ca?(d.text=U.Qp,d.Ua=function(){a.Se(null)}):(d.text=U.el,d.Ua=function(){a.Se("")}),c.push(d));if(!a.Rc)for(d=0;d<a.T.length;d++)if(1==a.T[d].type){d={enabled:!0};d.text=a.Ke?U.rm:U.vm;d.Ua=
function(){A(a,!a.Ke)};c.push(d);break}mc&&(a.Rc?(d={enabled:!0},d.text=U.qm,d.Ua=function(){a.nd(!1)}):(d={enabled:!0},d.text=U.jl,d.Ua=function(){a.nd(!0)}),c.push(d));nc&&(d={text:a.disabled?U.om:U.mm,enabled:!cf(a),Ua:function(){a.Te(!a.disabled)}},c.push(d));var d=a.Eb().length,e=Cc(a);e&&(d-=e.Eb().length);d={text:1==d?U.km:U.lm.replace("%1",String(d)),enabled:!0,Ua:function(){a.m(!0,!0)}};c.push(d)}d={enabled:!(ha(a.p)?!a.p():!a.p)};d.text=U.um;d.Ua=function(){var b=ha(a.p)?a.p():a.p;b&&window.open(b)};
...
f.Te=function(a){this.disabled!=a&&(We.j.Te.call(this,a),fe(this),this.u.wb())};f.Qg=function(){Md(this.o,"blocklySelected");this.o.parentNode.appendChild(this.o)};f.pg=function(){Ld(this.o,"blocklySelected")};
f.G=function(){this.B=!0;var a=10;t&&(a=-a);for(var b=Te(this),c=0;c<b.length;c++){var d=b[c];d.J.isCollapsed()?d.Ia.setAttribute("display","none"):(d.Ia.setAttribute("display","block"),t&&(a-=16),d.Ia.setAttribute("transform","translate("+a+", 5)"),Pd(d),a=t?a-10:a+26)}var e=a+=t?10:-10,h=this.T,b=[];b.ua=e+20;if(this.L||this.C)b.ua=Math.max(b.ua,40);for(var d=c=0,k=!1,m=!1,p=!1,x=void 0,w=this.Ke&&!this.isCollapsed(),E=0,z;z=h[E];E++)if(z.K()){var J;w&&x&&3!=x&&3!=z.type?J=b[b.length-1]:(x=z.type,
J=[],J.type=w&&3!=z.type?-1:z.type,J.height=0,b.push(J));J.push(z);z.ld=25;z.Qa=w&&1==z.type?20.5:0;if(z.t&&z.t.w){var cb=Vd(v(z.t));z.ld=Math.max(z.ld,cb.height);z.Qa=Math.max(z.Qa,cb.width)}E==h.length-1&&z.ld--;J.height=Math.max(J.height,z.ld);z.Pb=0;1==b.length&&(z.Pb+=t?-e:e);for(var cb=!1,Ng=0,Wb;Wb=z.Pa[Ng];Ng++){0!=Ng&&(z.Pb+=10);var Ij=Wb.Ld();Wb.Qa=Ij.width;Wb.rg=cb&&Wb.wd?10:0;z.Pb+=Wb.Qa+Wb.rg;J.height=Math.max(J.height,Ij.height);cb=Wb.wd}-1!=J.type&&(3==J.type?(m=!0,d=Math.max(d,z.Pb)):
(1==J.type?k=!0:5==J.type&&(p=!0),c=Math.max(c,z.Pb)))}for(e=0;J=b[e];e++)if(J.Xk=!1,-1==J.type)for(h=0;z=J[h];h++)if(1==z.type){J.height+=20;J.Xk=!0;break}b.Bg=20+d;m&&(b.ua=Math.max(b.ua,b.Bg+30));k?b.ua=Math.max(b.ua,c+20+8):p&&(b.ua=Math.max(b.ua,c+20));b.Zr=k;b.zu=m;b.yu=p;d=a;this.H?this.li=this.Ag=!0:(this.li=this.Ag=!1,this.L&&(a=v(this.L))&&Cc(a)==this&&(this.Ag=!0),Cc(this)&&(this.li=!0));k=this.ia();m=[];p=[];a=[];c=[];z=b.ua;this.Ag?(m.push("m 0,0"),a.push("m 1,1")):(m.push("m 0,2"),a.push(t?
Ak:"m 1,1"),m.push("A 2,2 0 0,1 2,0"),a.push("A 1,1 0 0,1 2,1"));this.L&&(m.push("H",15),a.push("H",15),m.push("l 6,4 3,0 6,-4"),a.push("l 6.5,4 2,0 6.5,-4"),this.L.moveTo(k.x+(t?-30:30),k.y));m.push("H",z);a.push("H",z+(t?-1:0));this.width=z;for(J=z=0;e=b[J];J++){w=10;0==J&&(w+=t?-d:d);a.push("M",b.ua-1+","+(z+1));if(this.isCollapsed())h=e[0],E=z+18,Ek(h.Pa,w,E),m.push("l 8,0 0,4 8,4 -16,8 8,4"),t?a.push("l 8,0 0,3.8 7,3.2 m -14.5,9 l 8,4"):a.push("h 8"),h=e.height-20,m.push("v",h),t&&a.push("v",
...
f.Kc=function(a){this.Wc=a;this.X&&this.X.jb(32,a)};f.za=function(){Zk.j.za.call(this);this.X&&this.X.G(this.n());this.n().unselectable="on"};f.Y=function(){Zk.j.Y.call(this);this.X&&(this.X.m(),this.X=null)};f.focus=function(){this.X&&this.X.n().focus()};f.us=function(a){a.stopPropagation();this.dispatchEvent("change")};function $k(a,b){var c=new Wk(b,null,a.eb());c.xg(5);c.jb(32,a.Wc);a.ne(c);a.X=c;a.R&&a.X.G(a.n())};/*
 ...
 limitations under the License.
*/
function al(a,b){al.j.constructor.call(this,"\u00a0\u00a0\u00a0");this.ha=b;this.aa(a)}var bl;n(al,Pe);f=al.prototype;f.g=function(a){al.j.g.call(this,a);this.Cb.style.fillOpacity=1;this.aa(this.Aa())};f.clone=function(){return new al(this.Aa(),this.ha)};f.ef="default";f.m=function(){xi(this);al.j.m.call(this)};f.Aa=function(){return this.rj};f.aa=function(a){this.rj=a;this.Cb&&(this.Cb.style.fill=a);this.h&&this.h.B&&(qk(this.h),this.h.u.wb())};
...
g.Blockly.removeChangeListener=function(a){D(a)};/*
 ...
 limitations under the License.
*/
H.ct={};H.variables_get={g:function(){this.p=U.Wq;this.k(330);M(M(M(P(this),U.Zq),new Hi(U.Xq),"VAR"),U.Yq);I(this,!0);this.i(U.$q);this.uj=U.Vq;this.vj="variables_set"},Zb:function(){return[N(this,"VAR")]},Hb:function(a,b){uf(a,N(this,"VAR"))&&Lc(this,b,"VAR")},ub:function(a){var b={enabled:!0},c=N(this,"VAR");b.text=this.uj.replace("%1",c);c=u("field",null,c);c.setAttribute("name","VAR");c=u("block",null,c);c.setAttribute("type",this.vj);b.Ua=nk.rf(this,c);a.push(b)}};
H.variables_set={g:function(){this.p=U.ar;this.k(330);this.ta(U.dr+" %1 "+U.cr+" %2",["VAR",new Hi(U.br)],["VALUE",null,1],1);K(this,!0);L(this,!0);this.i(U.er);this.uj=U.Pg;this.vj="variables_get"},Zb:function(){return[N(this,"VAR")]},Hb:function(a,b){uf(a,N(this,"VAR"))&&Lc(this,b,"VAR")},ub:H.variables_get.ub};/*
...
H.colour_blend={g:function(){this.p=U.ml;this.k(20);M(M(Ue(O(this,"COLOUR1").s("Colour"),1),U.ol),U.kl);M(Ue(O(this,"COLOUR2").s("Colour"),1),U.ll);M(Ue(O(this,"RATIO").s("Number"),1),U.nl);I(this,!0,"Colour");this.i(U.pl)}};/*
 ...
 limitations under the License.
*/
H.ns={};H.controls_repeat={g:function(){this.p=U.yi;this.k(120);M(M(M(P(this),U.cm),new gl("10",ll),"TIMES"),U.dm);M(df(this,3,"DO"),U.vd);K(this,!0);L(this,!0);this.i(U.zi)}};H.controls_repeat_ext={g:function(){this.p=U.yi;this.k(120);this.ta(U.bm,["TIMES","Number",1],1);M(df(this,3,"DO"),U.vd);K(this,!0);L(this,!0);A(this,!0);this.i(U.zi)}};
H.controls_whileUntil={g:function(){var a=[[U.hm,"WHILE"],[U.gm,"UNTIL"]];this.p=U.em;this.k(120);M(O(this,"BOOL").s("Boolean"),new T(a),"MODE");M(df(this,3,"DO"),U.fm);K(this,!0);L(this,!0);var b=this;this.i(function(){var a=N(b,"MODE");return{WHILE:U.jm,UNTIL:U.im}[a]})}};
H.controls_for={g:function(){this.p=U.Ml;this.k(120);M(M(P(this),U.Pl),new Hi(null),"VAR");this.ta(U.Ol,["FROM","Number",1],["TO","Number",1],["BY","Number",1],1);M(df(this,3,"DO"),U.Nl);K(this,!0);L(this,!0);A(this,!0);var a=this;this.i(function(){return U.Ql.replace("%1",N(a,"VAR"))})},Zb:function(){return[N(this,"VAR")]},Hb:function(a,b){uf(a,N(this,"VAR"))&&Lc(this,b,"VAR")},ub:function(a){if(!this.isCollapsed()){var b={enabled:!0},c=N(this,"VAR");b.text=U.Pg.replace("%1",c);c=u("field",null,
c);c.setAttribute("name","VAR");c=u("block",null,c);c.setAttribute("type","variables_get");b.Ua=nk.rf(this,c);a.push(b)}}};H.controls_forEach={g:function(){this.p=U.Hl;this.k(120);M(M(M(O(this,"LIST").s("Array"),U.Kl),new Hi(null),"VAR"),U.Jl);U.xi&&(M(P(this),U.xi),A(this,!0));M(df(this,3,"DO"),U.Il);K(this,!0);L(this,!0);var a=this;this.i(function(){return U.Ll.replace("%1",N(a,"VAR"))})},Zb:function(){return[N(this,"VAR")]},Hb:function(a,b){uf(a,N(this,"VAR"))&&Lc(this,b,"VAR")},ub:H.controls_for.ub};
H.controls_flow_statements={g:function(){var a=[[U.Cl,"BREAK"],[U.Dl,"CONTINUE"]];this.p=U.Bl;this.k(120);M(P(this),new T(a),"FLOW");K(this,!0);var b=this;this.i(function(){var a=N(b,"FLOW");return{BREAK:U.El,CONTINUE:U.Fl}[a]})},onchange:function(){if(this.u){var a=!1,b=this;do{if("controls_repeat"==b.type||"controls_repeat_ext"==b.type||"controls_forEach"==b.type||"controls_for"==b.type||"controls_whileUntil"==b.type){a=!0;break}b=$e(b)}while(b);a?this.qd(null):this.qd(U.Gl)}}};/*
 ...
 limitations under the License.
*/
R.os={};R.math_number=function(a){return[parseFloat(N(a,"NUM")),R.qb]};R.math_arithmetic=function(a){var b={ADD:[" + ",R.Ng],MINUS:[" - ",R.vp],MULTIPLY:[" * ",R.tp],DIVIDE:[" / ",R.kf],POWER:[null,R.qa]}[N(a,"OP")],c=b[0],b=b[1],d=S(a,"A",b)||"0";a=S(a,"B",b)||"0";return c?[d+c+a,b]:["Math.pow("+d+", "+a+")",R.Q]};
...
R.math_constant=function(a){return{PI:["Math.PI",R.W],E:["Math.E",R.W],GOLDEN_RATIO:["(1 + Math.sqrt(5)) / 2",R.kf],SQRT2:["Math.SQRT2",R.W],SQRT1_2:["Math.SQRT1_2",R.W],INFINITY:["Infinity",R.qb]}[N(a,"CONSTANT")]};
...
a&&M(b,U.Fq)}}};H.text_create_join_container={g:function(){this.k(160);M(P(this),U.rq);df(this,3,"STACK");this.i(U.sq);this.contextMenu=!1}};H.text_create_join_item={g:function(){this.k(160);M(P(this),U.pq);K(this,!0);L(this,!0);this.i(U.qq);this.contextMenu=!1}};
H.text_append={g:function(){this.p=U.Zp;this.k(160);M(M(M(O(this,"TEXT"),U.$p),new Hi(U.bq),"VAR"),U.Yp);K(this,!0);L(this,!0);var a=this;this.i(function(){return U.aq.replace("%1",N(a,"VAR"))})},Zb:function(){return[N(this,"VAR")]},Hb:function(a,b){uf(a,N(this,"VAR"))&&Lc(this,b,"VAR")}};H.text_length={g:function(){this.p=U.Hq;this.k(160);this.ta(U.Iq,["VALUE",["String","Array"],1],1);I(this,!0,"Number");this.i(U.Jq)}};
...
"NAME"),this.A,!0]},Zb:H.procedures_defnoreturn.Zb,Hb:H.procedures_defnoreturn.Hb,ub:H.procedures_defnoreturn.ub,kj:"procedures_callreturn"};H.procedures_mutatorcontainer={g:function(){this.k(290);M(P(this),U.Op);df(this,3,"STACK");M(M(P(this,"STATEMENT_INPUT"),U.wp),new Gk("TRUE"),"STATEMENTS");this.i(U.Pp);this.contextMenu=!1}};
H.procedures_mutatorarg={g:function(){this.k(290);M(M(P(this),U.Mp),new gl("x",this.bt),"NAME");K(this,!0);L(this,!0);this.i(U.Np);this.contextMenu=!1},bt:function(a){return(a=a.replace(/[\s\xa0]+/g," ").replace(/^ | $/g,""))||null}};
H.procedures_callnoreturn={g:function(){this.p=U.yp;this.k(290);M(M(M(P(this),U.Mi),"","NAME"),U.Pi,"WITH");K(this,!0);L(this,!0);this.A=[];this.Hc=this.jd=null},Jd:function(){return N(this,"NAME")},Yh:function(a,b){uf(a,this.Jd())&&(Lc(this,b,"NAME"),this.i((this.H?U.Oi:U.Ni).replace("%1",b)))},ae:function(a,b){if(b){if(b.length!=a.length)throw"Error: paramNames and paramIds must be the same length.";this.Hc||(this.jd={},this.Hc=a.join("\n")==this.A.join("\n")?b:[]);var c=this.B;this.B=!1;for(var d=
...
{enabled:!0};b.text=U.Jp;var c=this.Jd(),d=this.u;b.Ua=function(){var a=Df(c,d);a&&a.select()};a.push(b)}};H.procedures_callreturn={g:function(){this.p=U.Ap;this.k(290);M(M(M(P(this),U.zp),"","NAME"),U.Pi,"WITH");I(this,!0);this.A=[];this.Hc=this.jd=null},Jd:H.procedures_callnoreturn.Jd,Yh:H.procedures_callnoreturn.Yh,ae:H.procedures_callnoreturn.ae,Ja:H.procedures_callnoreturn.Ja,Oa:H.procedures_callnoreturn.Oa,Hb:H.procedures_callnoreturn.Hb,ub:H.procedures_callnoreturn.ub};
H.procedures_ifreturn={g:function(){this.p="http://c2.com/cgi/wiki?GuardClause";this.k(290);M(O(this,"CONDITION").s("Boolean"),U.Ig);M(O(this,"VALUE"),U.ke);A(this,!0);K(this,!0);L(this,!0);this.i(U.Kp);this.Bc=!0},Ja:function(){var a=document.createElement("mutation");a.setAttribute("value",Number(this.Bc));return a},Oa:function(a){this.Bc=1==a.getAttribute("value");this.Bc||(Q(this,"VALUE"),M(P(this,"VALUE"),U.ke))},onchange:function(){if(this.u){var a=!1,b=this;do{if("procedures_defnoreturn"==
...
R.logic_operation=function(a){var b="AND"==N(a,"OP")?"&&":"||",c="&&"==b?R.rp:R.sp,d=S(a,"A",c);a=S(a,"B",c);if(d||a){var e="&&"==b?"true":"false";d||(d=e);a||(a=e)}else a=d="false";return[d+" "+b+" "+a,c]};R.logic_negate=function(a){var b=R.lf;return["!"+(S(a,"BOOL",b)||"true"),b]};R.logic_boolean=function(a){return["TRUE"==N(a,"BOOL")?"true":"false",R.qb]};R.logic_null=function(){return["null",R.qb]};
...
*/
H.ms={};
H.controls_if={g:function(){this.p=U.Vl;this.k(210);M(O(this,"IF0").s("Boolean"),U.Ig);M(df(this,3,"DO0"),U.Jg);K(this,!0);L(this,!0);this.Zd(new Rd(["controls_if_elseif","controls_if_else"]));var a=this;this.i(function(){if(a.Xa||a.vb){if(!a.Xa&&a.vb)return U.Zl;if(a.Xa&&!a.vb)return U.$l;if(a.Xa&&a.vb)return U.am}else return U.Yl;return""});this.vb=this.Xa=0},Ja:function(){if(!this.Xa&&!this.vb)return null;var a=document.createElement("mutation");this.Xa&&a.setAttribute("elseif",this.Xa);this.vb&&
...
Ja:function(){var a=document.createElement("mutation");a.setAttribute("statement",!this.H);a.setAttribute("at",1==B(this,"AT").type);return a},Oa:function(a){var b="true"==a.getAttribute("statement");this.al(b);a="false"!=a.getAttribute("at");this.ea(a)},al:function(a){a!=!this.H&&(Ye(this,!0,!0),a?(I(this,!1),K(this,!0),L(this,!0)):(K(this,!1),L(this,!1),I(this,!0)))},ea:function(a){Q(this,"AT");Q(this,"ORDINAL",!0);a?(O(this,"AT").s("Number"),U.Tb&&M(P(this,"ORDINAL"),U.Tb)):P(this,"AT");var b=
...
this.fc(a)},fc:function(a){var b=B(this,"DIVISOR");a?b||O(this,"DIVISOR").s("Number"):b&&Q(this,"DIVISOR")}};H.math_change={g:function(){this.p=U.Pn;this.k(230);this.ta(U.Rn+" %1 "+U.Qn+" %2",["VAR",new Hi(U.Sn)],["DELTA","Number",1],1);K(this,!0);L(this,!0);var a=this;this.i(function(){return U.Tn.replace("%1",N(a,"VAR"))})},Zb:function(){return[N(this,"VAR")]},Hb:function(a,b){uf(a,N(this,"VAR"))&&Lc(this,b,"VAR")}};
...
H.math_random_float={g:function(){this.p=U.Ho;this.k(230);I(this,!0,"Number");M(P(this),U.Io);this.i(U.Jo)}};var Bm,X;H.shirt={g:function(){this.k(160);M(M(P(this),"Shirt"),new Gl("https://www.gstatic.com/codesite/ph/images/star_on.gif",15,15,"*"));M(O(this,"X").s("Number"),"x");M(O(this,"Y").s("Number"),"y");this.i("");K(this,!0)}};R.shirt=function(a){S(a,"X",R.qb);S(a,"Y",R.qb);return"shirt();\n"};H.movie_circle={g:function(){this.k(160);M(M(Ue(O(this,"X").s("Number"),1),W("Movie_circleDraw")),W("Movie_x"));M(Ue(O(this,"Y").s("Number"),1),W("Movie_y"));K(this,!0);L(this,!0);this.i(W("Movie_circleTooltip"))}};
R.movie_circle=function(a){var b=S(a,"X",R.D)||"0";a=S(a,"Y",R.D)||"0";return"circle("+b+", "+a+", 5);\n"};H.movie_rect={g:function(){this.k(160);M(M(Ue(O(this,"X").s("Number"),1),W("Movie_rectDraw")),W("Movie_x"));M(Ue(O(this,"Y").s("Number"),1),W("Movie_y"));M(Ue(O(this,"WIDTH").s("Number"),1),W("Movie_width"));M(Ue(O(this,"HEIGHT").s("Number"),1),W("Movie_height"));K(this,!0);L(this,!0);this.i(W("Movie_rectTooltip"))}};
R.movie_rect=function(a){var b=S(a,"X",R.D)||"0",c=S(a,"Y",R.D)||"0",d=S(a,"WIDTH",R.D)||"0";a=S(a,"HEIGHT",R.D)||"0";return"rect("+b+", "+c+", "+d+", "+a+");\n"};H.movie_line={g:function(){this.k(160);M(M(Ue(O(this,"X1").s("Number"),1),W("Movie_lineDraw")),W("Movie_x1"));M(Ue(O(this,"Y1").s("Number"),1),W("Movie_y1"));M(Ue(O(this,"X2").s("Number"),1),W("Movie_x2"));M(Ue(O(this,"Y2").s("Number"),1),W("Movie_y2"));M(Ue(O(this,"WIDTH").s("Number"),1),W("Movie_width"));K(this,!0);L(this,!0);this.i(W("Movie_rectTooltip"))}};
R.movie_line=function(a){var b=S(a,"X1",R.D)||"0",c=S(a,"Y1",R.D)||"0",d=S(a,"X2",R.D)||"0",e=S(a,"Y2",R.D)||"0";a=S(a,"WIDTH",R.D)||"0";return"line("+b+", "+c+", "+d+", "+e+", "+a+");\n"};H.movie_time={g:function(){this.k(330);M(P(this),"time (0\u2192100)");I(this,!0,"Number");this.i(W("Movie_timeTooltip"))}};R.movie_time=function(){return["time()",R.qb]};H.movie_colour={g:function(){this.k(20);M(O(this,"COLOUR").s("Colour"),W("Movie_setColour"));K(this,!0);L(this,!0);this.i(W("Movie_colourTooltip"))}};
R.movie_colour=function(a){return"penColour("+(S(a,"COLOUR",R.D)||"'#000000'")+");\n"};function Cm(a){switch(V){case 1:Dm("#ff0000");Em(50,80,10);Dm("#3333ff");Fm(50,40,20,60);Dm("#000000");Gm(20,70,50,50,5);Gm(50,50,80,70,5);break;case 2:Dm("#ff0000");Em(a,50,10);break;case 3:Dm("#ff0000");Em(100-a,50,10);break;case 4:Dm("#009900");Em(a,50,20);Em(100-a,50,20);Em(50,100-a,20);Em(50,a,20);break;case 5:Em(30,a+20,10);Em(50,a,20);Em(70,a+20,10);break;case 6:Gm(100-a,100,a,a,1);Gm(a,a,100-a,0,1);break;case 7:Dm("#009900");Em(a,100-Math.pow((a-50)/5,2),10);break;case 8:50>a?(Dm("#ff0000"),
Em(a,a,10),Dm("#3333ff"),Em(100-a,100-a,10)):(Dm("#009900"),Em(50,50,10));break;case 9:Dm("#999999"),Gm(0,40,20,40,1),Gm(20,40,20,80,1),Gm(20,80,80,20,1),Dm("#009900"),20>a?Em(a,40,10):40>a?Em(20,2*a,10):Em(a-20,120-a,10)}}function Hm(){if(10==V)return 1<G.cb().length;for(var a=0;a<=Im;a++){if(void 0===Jm[a])return!1;if(100<Jm[a])return console.log("Pixel errors (frame "+a+"): "+Jm[a]),!1}return!0};U.wu={};U.el="Add Comment";U.fl="Please authorize this app to enable your work to be saved and to allow it to be shared by you.";U.gl="Change value:";U.hl="Chat with your collaborator by typing in this box!";U.il="Collapse Blocks";U.jl="Collapse Block";U.kl="colour 1";U.ll="colour 2";U.ml="http://meyerweb.com/eric/tools/color-blend/";U.nl="ratio";U.ol="blend";U.pl="Blends two colours together with a given ratio (0.0 - 1.0).";U.ql="https://en.wikipedia.org/wiki/Color";U.rl="Choose a colour from the palette.";
...
bj:function(a){if(13==a.keyCode||27==a.keyCode||32==a.keyCode)Z.lc(!0),a.stopPropagation(),a.preventDefault(),27!=a.keyCode&&Y.Rf()}};window.BlocklyDialogs=Z;Z.hideDialog=Z.lc;function Km(a,b){this.Lb=42;this.he=328;this.Bi=11.5;this.Ub=12;this.wa=0;this.mj=b;this.Wg=[];this.zk=[];var c=document.createElementNS(Lm,"text");c.setAttribute("style","font-size: 10pt");c.setAttribute("x",this.he+9);c.setAttribute("y",16);a.appendChild(c);this.da=c;for(var c="#ff3333 #f72f2f #ef2a2a #e72727 #df2222 #d71f1f #cf1a1a".split(" "),d=0;d<c.length;d++){var e=document.createElementNS(Lm,"rect");e.setAttribute("style","fill: "+c[d]);e.setAttribute("x",this.Lb);e.setAttribute("y",8+d);
e.setAttribute("height",1);a.appendChild(e);this.zk[d]=e}e=document.createElementNS(Lm,"rect");e.setAttribute("style","opacity: 0");e.setAttribute("x",this.Lb-this.Ub);e.setAttribute("y",this.Bi-this.Ub);e.setAttribute("width",this.he-this.Lb+2*this.Ub);e.setAttribute("height",2*this.Ub);e.setAttribute("rx",this.Ub);e.setAttribute("ry",this.Ub);a.appendChild(e);c=e;e=document.createElementNS(Lm,"clipPath");e.setAttribute("id","knobClipPath");a.appendChild(e);d=document.createElementNS(Lm,"rect");
d.setAttribute("width","16");d.setAttribute("height","16");d.setAttribute("y","3");e.appendChild(d);this.gs=d;e=document.createElementNS(Lm,"image");e.setAttributeNS("http://www.w3.org/1999/xlink","xlink:href","movie/icons.png");e.setAttribute("clip-path","url(#knobClipPath)");e.setAttribute("width","63");e.setAttribute("height","42");e.setAttribute("y","3");a.appendChild(e);this.jk=e;e=document.createElementNS(Lm,"rect");e.setAttribute("style","opacity: 0");e.setAttribute("width",2*this.Ub);e.setAttribute("height",
2*this.Ub);e.setAttribute("y",this.Bi-this.Ub);a.appendChild(e);this.Gh=e;this.aa(0);e=document.createElementNS(Lm,"clipPath");e.setAttribute("id","playClipPath");a.appendChild(e);d=document.createElementNS(Lm,"rect");d.setAttribute("width","21");d.setAttribute("height","21");d.setAttribute("x","4");d.setAttribute("y","1");e.appendChild(d);e=document.createElementNS(Lm,"image");e.setAttributeNS("http://www.w3.org/1999/xlink","xlink:href","movie/icons.png");e.setAttribute("clip-path","url(#playClipPath)");
e.setAttribute("width","63");e.setAttribute("height","42");e.setAttribute("x",-17);e.setAttribute("y","-20");a.appendChild(e);for(this.ig=e;a&&"svg"!=a.nodeName.toLowerCase();)a=a.parentNode;this.yd=a;Mm(this.Gh,"mousedown",this,this.ik);Mm(this.Gh,"touchstart",this,this.ik);Mm(c,"mousedown",this,this.Js);Mm(this.yd,"mouseup",null,Nm);Mm(this.yd,"touchend",null,Nm);Mm(this.yd,"mousemove",null,Om);Mm(this.yd,"touchmove",null,Om);Mm(this.ig,"click",this,this.Oe);Mm(this.ig,"touchend",this,this.Oe)}
var Lm="http://www.w3.org/2000/svg",Pm=null,Qm=0,Rm=0;f=Km.prototype;f.ik=function(a){this.Wd&&this.Oe();if("touchstart"==a.type){if(1!=a.changedTouches.length)return;Sm(a)}Pm=this;Qm=Tm(this,a).x;Rm=Number(this.jk.getAttribute("x"))+this.Lb+8;a.preventDefault()};function Nm(){Pm=null}function Om(a){var b=Pm;if(b){if("touchmove"==a.type){if(1!=a.changedTouches.length)return;Sm(a)}a=Tm(b,a).x-Qm+Rm;b.aa((a-b.Lb)/(b.he-b.Lb))}}
f.Js=function(a){this.Wd&&this.Oe();if("touchstart"==a.type){if(1!=a.changedTouches.length)return;Sm(a)}a=Tm(this,a).x;Um(this,(a-this.Lb)/(this.he-this.Lb))};f.Wd=0;f.Oe=function(a){a&&Y.jc(a)||(this.Wd?(this.ig.setAttribute("x",-17),clearTimeout(this.Wd),this.Wd=0,Vm()):(this.ig.setAttribute("x",4),1<=this.Aa()&&this.aa(0),Wm(this)))};f.mk=0;f.lk=0;f.sm=25;
function Wm(a){var b=a.Aa();if(1<=b)a.Oe();else{a.aa(b+.01);var b=Date.now(),c=Math.max(1,1E3/a.sm-(b-a.mk-a.lk));a.Wd=setTimeout(function(){Wm(a)},c);a.mk=b;a.lk=c}}f.Aa=function(){return this.wa};function Um(a,b){function c(c){return function(){a.aa(c*(b-d)/9+d)}}for(;a.Wg.length;)clearTimeout(a.Wg.pop());for(var d=a.Aa(),e=0;10>e;e++)a.Wg.push(setTimeout(c(e),200*e/10))}
...
"")+"</div>"+bn()+"</div>"};var zm="movie";Y.Mh=function(){10>V?window.location=window.location.protocol+"//"+window.location.host+window.location.pathname+"?lang="+rm+"&level="+(V+1):Y.Rf()};var Im=1==V?0:100,Jm=Array(Im),en=!1,fn=0;
function gn(){function a(){c.style.top=Math.max(10,d.offsetTop-window.pageYOffset)+"px";c.style.width=window.innerWidth-440+"px"}document.body.innerHTML=dn();Y.g();var b=-1!=qm.indexOf(rm),c=document.getElementById("blockly"),d=document.getElementById("visualization");window.addEventListener("scroll",function(){a();dd(window,"resize")});window.addEventListener("resize",a);a();10>V&&(dl=3,cl="#ff0000 #ffcc33 #ffff00 #009900 #3333ff #cc33cc #ffffff #999999 #000000".split(" "));var e=document.getElementById("toolbox");
rl(document.getElementById("blockly"),{media:"media/",rtl:b,toolbox:e,trashcan:!0});nf("circle,rect,line,penColour,time");document.getElementById("submitButton")&&Am("submitButton",hn);b="<xml></xml>";9==V&&(b='<xml xmlns="http://www.w3.org/1999/xhtml">  <block type="movie_colour" inline="false" x="51" y="28">    <value name="COLOUR">      <block type="colour_picker">        <field name="COLOUR">#999999</field>      </block>    </value>    <next>      <block type="movie_line" inline="false">        <value name="X1">          <block type="math_number">            <field name="NUM">0</field>          </block>        </value>        <value name="Y1">          <block type="math_number">            <field name="NUM">40</field>          </block>        </value>        <value name="X2">          <block type="math_number">            <field name="NUM">20</field>          </block>        </value>        <value name="Y2">          <block type="math_number">            <field name="NUM">40</field>          </block>        </value>        <value name="WIDTH">          <block type="math_number">            <field name="NUM">1</field>          </block>        </value>        <next>          <block type="movie_line" inline="false">            <value name="X1">              <block type="math_number">                <field name="NUM">20</field>              </block>            </value>            <value name="Y1">              <block type="math_number">                <field name="NUM">40</field>              </block>            </value>            <value name="X2">              <block type="math_number">                <field name="NUM">20</field>              </block>            </value>            <value name="Y2">              <block type="math_number">                <field name="NUM">80</field>              </block>            </value>            <value name="WIDTH">              <block type="math_number">                <field name="NUM">1</field>              </block>            </value>            <next>              <block type="movie_line" inline="false">                <value name="X1">                  <block type="math_number">                    <field name="NUM">20</field>                  </block>                </value>                <value name="Y1">                  <block type="math_number">                    <field name="NUM">80</field>                  </block>                </value>                <value name="X2">                  <block type="math_number">                    <field name="NUM">80</field>                  </block>                </value>                <value name="Y2">                  <block type="math_number">                    <field name="NUM">20</field>                  </block>                </value>                <value name="WIDTH">                  <block type="math_number">                    <field name="NUM">1</field>                  </block>                </value>              </block>            </next>          </block>        </next>      </block>    </next>  </block></xml>');
Y.ls(b,!1);Bm=document.getElementById("display").getContext("2d");Bm.globalCompositeOperation="source-over";X=document.getElementById("scratch").getContext("2d");jn();kn(0);setTimeout(function(){for(var a=1;a<=Im;a++)kn(a)},1);ln();mn();yl(mn);b=document.getElementById("scrubber");new Km(b,mn);1==V&&(b.style.display="none");Dl(["movie/win.mp3","movie/win.ogg"],"win");setTimeout(Y.bs,1);Am("helpButton",nn);2>location.hash.length&&!xm(V)&&(setTimeout(nn,1E3),9==V&&setTimeout(Z.cj,3E5))}
window.location.pathname.match(/readonly.html$/)?window.addEventListener("load",function(){Y.cs(cn()+'<div id="blockly"></div>')}):window.addEventListener("load",gn);function nn(){var a=document.getElementById("help"),b=document.getElementById("helpButton");Z.yg(a,b,!0,!0,{width:"50%",left:"25%",top:"5em"},on);Z.Pk()}function on(){Z.Uk()}
function kn(a){var b=document.getElementById("visualization"),c=document.createElement("canvas");c.id="answer"+a;c.width=400;c.height=600;c.style.display="none";b.appendChild(c);var d=c.getContext("2d"),e=new Image;e.onload=function(){d.drawImage(e,-90,0,600,600)};e.src="./movie/superhero.jpg";X.canvas.width=X.canvas.width;Cm(a);d=c.getContext("2d");d.globalCompositeOperation="copy";d.drawImage(X.canvas,0,0)}
function jn(){var a=document.getElementById("hatching").getContext("2d");a.strokeStyle="#fff";a.lineWidth=1;for(var b=-600;600>b;b+=4)a.beginPath(),a.moveTo(b,-b),a.lineTo(b+600,-b+400),a.stroke()}
function ln(){var a=document.getElementById("axies").getContext("2d");a.lineWidth=1;a.strokeStyle="#bba";a.fillStyle="#bba";a.font="normal 14px sans-serif";for(var b=1,c=.1;.9>c;c+=.1)a.beginPath(),a.moveTo(400*c,600),a.lineTo(400*c,600-9*b),a.stroke(),a.beginPath(),a.moveTo(0,600*c),a.lineTo(9*b,600*c),a.stroke(),2==b&&(a.fillText(Math.round(100*c),400*c+2,596),a.fillText(Math.round(100-100*c),3,600*c-2)),b=1==b?2:1}
...
function mn(a){"number"==typeof a?fn=a:a=fn;Bm.beginPath();Bm.rect(0,0,Bm.canvas.width,Bm.canvas.height);Bm.fillStyle="#ffffff";Bm.fill();if(a=document.getElementById("answer"+a))Bm.globalAlpha=.2,Bm.drawImage(a,0,0),Bm.globalAlpha=1;a=document.getElementById("hatching");Bm.drawImage(a,0,0);a=hf();a=new Interpreter(a,qn);pn(a);Bm.drawImage(X.canvas,0,0);Bm.drawImage(document.getElementById("axies"),0,0);a=X.getImageData(0,0,400,600);var b=document.getElementById("answer"+fn);if(b){for(var b=b.getContext("2d").getImageData(0,
0,400,600),c=Math.min(a.data.length,b.data.length),d=0,e=3;e<c;e+=4)64<Math.abs(a.data[e]-b.data[e])&&d++;Jm[fn]=d}1==V&&setTimeout(Vm,1E3)}
function qn(a,b){var c;a.setProperty(b,"shirt",a.createNativeFunction(function(){rn()}));c=function(a,b,c){Em(a.valueOf(),b.valueOf(),c.valueOf())};a.setProperty(b,"circle",a.createNativeFunction(c));c=function(a,b,c,k){Fm(a.valueOf(),b.valueOf(),c.valueOf(),k.valueOf())};a.setProperty(b,"rect",a.createNativeFunction(c));c=function(a,b,c,k,m){Gm(a.valueOf(),b.valueOf(),c.valueOf(),k.valueOf(),m.valueOf())};a.setProperty(b,"line",a.createNativeFunction(c));c=function(a){Dm(a.toString())};a.setProperty(b,
"penColour",a.createNativeFunction(c));a.setProperty(b,"time",a.createNativeFunction(function(){return a.createPrimitive(fn)}))}function rn(){var a=new Image;a.onload=function(){X.drawImage(a,50,50,600,600)};a.src="./movie/shirt.svg"}function Em(a,b,c){a*=4;b=4*(100-b);c=Math.max(4*c,0);X.beginPath();X.arc(a,b,c,0,2*Math.PI,!1);X.fill()}function Fm(a,b,c,d){a*=4;b=4*(100-b);c=Math.max(4*c,0);d=Math.max(4*d,0);X.beginPath();X.rect(a-c/2,b-d/2,c,d);X.fill()}
function Gm(a,b,c,d,e){a*=4;b=4*(100-b);c*=4;d=4*(100-d);e*=4;X.beginPath();X.moveTo(a,b);X.lineTo(c,d);X.lineWidth=Math.max(e,0);X.stroke()}function Dm(a){X.strokeStyle=a;X.fillStyle=a}function Vm(){1<V&&fn!=Im||!Hm()||en||(en=!0,Y.Os(),10>V&&(uk("win",.5),Z.rr()))}
function hn(){var a=G.cb().length,b=hf();if(5>a||-1==b.indexOf("time()"))alert(W("Movie_submitDisabled"));else{b=hf();a=new Interpreter(b,qn);b=fn;try{fn=Math.round(Im/2),pn(a)}finally{fn=b}a=document.getElementById("thumbnail");b=a.getContext("2d");b.globalCompositeOperation="copy";b.drawImage(X.canvas,0,0,100,100);a=a.toDataURL("image/png");document.getElementById("t2r_thumb").value=a;a=Ac(G);a=Dc(a);document.getElementById("t2r_xml").value=a;document.getElementById("t2r_form").submit()}};
