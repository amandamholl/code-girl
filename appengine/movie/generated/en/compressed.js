...
function Eb(a){var b;if(!(b=Db[a])){b=0;for(var c=va(String(Cb)).split("."),d=va(String(a)).split("."),e=Math.max(c.length,d.length),h=0;0==b&&h<e;h++){var k=c[h]||"",m=d[h]||"",p=/(\d*)(\D*)/g,x=/(\d*)(\D*)/g;do{var w=p.exec(k)||["","",""],F=x.exec(m)||["","",""];if(0==w[0].length&&0==F[0].length)break;b=Ia(0==w[1].length?0:parseInt(w[1],10),0==F[1].length?0:parseInt(F[1],10))||Ia(0==w[2].length,0==F[2].length)||Ia(w[2],F[2])}while(0==b)}b=Db[a]=0<=b}return b}
...
Ma("addTemplate() can only handle value inputs.")});d.push(1);a.ds&&this.Nu(a.ds);qe.prototype.ta.apply(this,d)}};b.Ja=a.Ou?function(){var b=a.qs?a.Du():document.createElement("mutation");b.setAttribute("is_statement",this.isStatement||!1);return b}:a.qs;H[a.pu]=b}};/*
 ...
 limitations under the License.
*/
function re(a){re.j.constructor.call(this,a);this.Sc()}n(re,Kd);f=re.prototype;f.da="";f.S=160;f.Ha=80;f.Sc=function(){Kd.prototype.Sc.call(this);E("circle",{"class":"blocklyIconShield",r:8,cx:8,cy:8},this.Ia);this.Nd=E("text",{"class":"blocklyIconMark",x:8,y:13},this.Ia);this.Nd.appendChild(document.createTextNode("?"))};
...
f.Jc=function(a,b){this.pb?this.la.Jc(a,b):(this.S=a,this.Ha=b)};f.fb=function(){return this.pb?this.pb.value:this.da};f.ka=function(a){this.pb?this.pb.value=a:this.da=a};f.m=function(){this.J.ca=null;Kd.prototype.m.call(this)};/*
 ...
 limitations under the License.
*/
var te=!1,ue=0,ve=0,we={x:0,y:0},xe=null,ye=null,ze=null,Ae=null,Be=null,Ce=null;function De(){var a=E("g",{"class":"blocklyHidden"},null);ze=a;Ce=E("rect",{"class":"blocklyTooltipShadow",x:2,y:2},a);Be=E("rect",{"class":"blocklyTooltipBackground"},a);Ae=E("text",{"class":"blocklyTooltipText"},a);return a}function Ee(a){C(a,"mouseover",null,Fe);C(a,"mouseout",null,Ge);C(a,"mousemove",null,He)}function Fe(a){for(a=a.target;!l(a.kb)&&!ha(a.kb);)a=a.kb;xe!=a&&(Ie(),ye=null,xe=a);clearTimeout(ue)}
...
function Qe(a){if(a.Ka){var b=a.da;Le(a.Ka);b=b.replace(/\s/g,"\u00a0");t&&b&&(b+="\u200f");b||(b="\u00a0");a.Ka.appendChild(document.createTextNode(b));a.Ca.width=0}}f.Aa=function(){return this.fb()};f.aa=function(a){this.ka(a)};f.Ph=function(a){if(!zb&&!Ab||0===a.layerX||0===a.layerY)Yc(a)||2!=Fd&&this.h.wc&&!y&&this.zg()};f.i=function(){};/*
 ...
 limitations under the License.
*/
function Re(a){this.h=null;this.Ca=new fd(0,25);this.ka(a)}n(Re,Pe);f=Re.prototype;f.clone=function(){return new Re(this.fb())};f.wd=!1;f.g=function(a){this.h||(this.h=a,this.Ka=E("text",{"class":"blocklyText"},null),a.V().appendChild(this.Ka),this.Ka.kb=this.h,Ee(this.Ka),Qe(this))};f.m=function(){ed(this.Ka);this.Ka=null};f.V=function(){return this.Ka};f.i=function(a){this.Ka.kb=a};/*
...
function Ue(a,b){a.align=b;a.h.B&&a.h.G();return a}f.g=function(){for(var a=0;a<this.Pa.length;a++)this.Pa[a].g(this.h)};f.m=function(){for(var a=0,b;b=this.Pa[a];a++)b.m();this.t&&this.t.m();this.h=null};/*
 ...
 limitations under the License.
*/
function se(a){se.j.constructor.call(this,a);this.Sc()}n(se,Kd);f=se.prototype;f.da="";f.Sc=function(){Kd.prototype.Sc.call(this);E("path",{"class":"blocklyIconShield",d:"M 2,15 Q -1,15 0.5,12 L 6.5,1.7 Q 8,-1 9.5,1.7 L 15.5,12 Q 17,15 14,15 z"},this.Ia);this.Nd=E("text",{"class":"blocklyIconMark",x:8,y:13},this.Ia);this.Nd.appendChild(document.createTextNode("!"))};
...
f.Sa=function(a){ri.j.Sa.call(this,a);if(a=dh(this,a)){var b=a.n();a=this.n();var c=Gg(b),d=Gg(a),e=Sg(a),h=c.x-d.x-e.left,c=c.y-d.y-e.top,d=a.clientHeight-b.offsetHeight,e=a.scrollLeft,k=a.scrollTop,e=e+Math.min(h,Math.max(h-(a.clientWidth-b.offsetWidth),0)),k=k+Math.min(c,Math.max(c-d,0)),b=new gc(e,k);a.scrollLeft=b.x;a.scrollTop=b.y}};/*
 ...
 limitations under the License.
*/
function T(a,b){this.Sd=a;this.ha=b;ti(this);var c=ui(this)[0];this.wa=c[1];this.of=E("tspan",{},null);this.of.appendChild(document.createTextNode(t?vi+" ":" "+vi));T.j.constructor.call(this,c[0])}n(T,Pe);var vi=yb?"\u25bc":"\u25be";f=T.prototype;f.clone=function(){return new T(this.Sd,this.ha)};f.ef="default";
...
a);a+=e.height+k[m];e=E("rect",{"fill-opacity":0},null);this.v.ba.insertBefore(e,d.V());d.ve=e;this.$g[m]=e;this.pe?this.bc.push(C(p,"mousedown",null,rj(this,d))):this.bc.push(C(p,"mousedown",null,sj(this,d)));this.bc.push(C(p,"mouseover",d,d.Qg));this.bc.push(C(p,"mouseout",d,d.pg));this.bc.push(C(e,"mousedown",null,rj(this,d)));this.bc.push(C(e,"mouseover",d,d.Qg));this.bc.push(C(e,"mouseout",d,d.pg))}this.bc.push(C(this.Jb,"mouseover",this,function(){for(var a=xc(this.v,!1),b=0,c;c=a[b];b++)c.pg()}));
...
1);nk.uf=null}else nk.kc()},kc:function(){xi(nk);nk.uf=null},rf:function(a,b){return function(){var c=Gc(a.u,b),d=a.ia();d.x=t?d.x-he:d.x+he;d.y+=2*he;c.moveBy(d.x,d.y);c.select()}}};/*
 ...
 limitations under the License.
*/
function We(){this.o=E("g",{},null);this.Vk=E("path",{"class":"blocklyPathDark",transform:"translate(1, 1)"},this.o);this.ec=E("path",{"class":"blocklyPath"},this.o);this.ri=E("path",{"class":"blocklyPathLight"},this.o);this.ec.kb=this;Ee(this.ec);af(this)}n(We,qe);f=We.prototype;f.height=0;f.width=0;
...
Ak:"m 1,1"),m.push("A 2,2 0 0,1 2,0"),a.push("A 1,1 0 0,1 2,1"));this.L&&(m.push("H",15),a.push("H",15),m.push("l 6,4 3,0 6,-4"),a.push("l 6.5,4 2,0 6.5,-4"),this.L.moveTo(k.x+(t?-30:30),k.y));m.push("H",z);a.push("H",z+(t?-1:0));this.width=z;for(K=z=0;e=b[K];K++){w=10;0==K&&(w+=t?-d:d);a.push("M",b.ua-1+","+(z+1));if(this.isCollapsed())h=e[0],F=z+18,Ek(h.Pa,w,F),m.push("l 8,0 0,4 8,4 -16,8 8,4"),t?a.push("l 8,0 0,3.8 7,3.2 m -14.5,9 l 8,4"):a.push("h 8"),h=e.height-20,m.push("v",h),t&&a.push("v",
h-2),this.width+=15;else if(-1==e.type){for(x=0;h=e[x];x++)F=z+18,e.Xk&&(F+=10),w=Ek(h.Pa,w,F),5!=h.type&&(w+=h.Qa+10),1==h.type&&(p.push("M",w-10+","+(z+10)),p.push("h",6-h.Qa),p.push("v 5 c 0,10 -8,-8 -8,7.5 s 8,-2.5 8,7.5"),p.push("v",h.ld+1-20),p.push("h",h.Qa+2-8),p.push("z"),t?(c.push("M",w-10-3+8-h.Qa+","+(z+10+1)),c.push("v 6.5 m -7.84,2.5 q -0.4,10 2.16,10 m 5.68,-2.5 v 1.5"),c.push("v",h.ld-20+3),c.push("h",h.Qa-8+1)):(c.push("M",w-10+1+","+(z+10+1)),c.push("v",h.ld+1),c.push("h",6-h.Qa),
c.push("M",w-h.Qa-10+1.8+","+(z+10+20-.4)),c.push("l","3.04,-1.8")),F=t?k.x-w-8+10+h.Qa+1:k.x+w+8-10-h.Qa-1,cb=k.y+z+10+1,h.t.moveTo(F,cb),h.t.w&&je(h.t));w=Math.max(w,b.ua);this.width=Math.max(this.width,w);m.push("H",w);a.push("H",w+(t?-1:0));m.push("v",e.height);t&&a.push("v",e.height-2)}else 1==e.type?(h=e[0],F=z+18,-1!=h.align&&(x=b.ua-h.Pb-8-20,1==h.align?w+=x:0==h.align&&(w+=(x+w)/2)),Ek(h.Pa,w,F),m.push("v 5 c 0,10 -8,-8 -8,7.5 s 8,-2.5 8,7.5"),x=e.height-20,m.push("v",x),t?(a.push("v 6.5 m -7.84,2.5 q -0.4,10 2.16,10 m 5.68,-2.5 v 1.5"),
a.push("v",x)):(a.push("M",b.ua-4.2+","+(z+20-.4)),a.push("l","3.04,-1.8")),F=k.x+(t?-b.ua-1:b.ua+1),cb=k.y+z,h.t.moveTo(F,cb),h.t.w&&(je(h.t),this.width=Math.max(this.width,b.ua+Vd(v(h.t)).width-8+1))):5==e.type?(h=e[0],F=z+18,-1!=h.align&&(x=b.ua-h.Pb-20,b.Zr&&(x-=8),1==h.align?w+=x:0==h.align&&(w+=(x+w)/2)),Ek(h.Pa,w,F),m.push("v",e.height),t&&a.push("v",e.height-2)):3==e.type&&(h=e[0],0==K&&(m.push("v",10),t&&a.push("v",9),z+=10),F=z+18,-1!=h.align&&(x=b.Bg-h.Pb-20,1==h.align?w+=x:0==h.align&&
(w+=(x+w)/2)),Ek(h.Pa,w,F),w=b.Bg+30,m.push("H",w),m.push("l -6,4 -3,0 -6,-4 h -13 a 2,2 0 0,0 -2,2"),m.push("v",e.height-4),m.push("a 2,2 0 0,0 2,2"),m.push("H",b.ua),t?(a.push("M",w-30+zk+","+(z+zk)),a.push(Bk),a.push("v",e.height-4),a.push("a 3,3 0 0,0 3,3"),a.push("H",b.ua-1)):(a.push("M",w-30+zk+","+(z+e.height-zk)),a.push(Ck),a.push("H",b.ua)),F=k.x+(t?-w:w),cb=k.y+z+1,h.t.moveTo(F,cb),h.t.w&&(je(h.t),this.width=Math.max(this.width,b.Bg+Vd(v(h.t)).width)),K==b.length-1||3==b[K+1].type)&&(m.push("v",
...
function ul(a){var b=!!a.readOnly;if(b)var c=!1,d=!1,e=!1,h=!1,k=!1,m=null;else(c=a.toolbox)?("string"!=typeof c&&"undefined"==typeof XSLTProcessor&&(c=c.outerHTML),"string"==typeof c&&(c=Ec(c))):c=null,m=c,c=Boolean(m&&m.getElementsByTagName("category").length),d=a.trashcan,void 0===d&&(d=c),e=a.collapse,void 0===e&&(e=c),h=a.comments,void 0===h&&(h=c),k=a.disable,void 0===k&&(k=c);var p=a.scrollbars;void 0===p&&(p=c);var x=a.sounds;void 0===x&&(x=!0);var w=!!a.realtime,F=w?a.realtimeOptions:void 0;
t=!!a.rtl;mc=e;lc=h;nc=k;y=b;qc=a.maxBlocks||Infinity;a.media?ld=a.media:a.path&&(ld=a.path+"media/");rc=c;sc=p;ic=d;tc=x;kc=m;oc=w;pc=F}
...
b)||a.ic+a.Dd>(t?a.xa:a.xa+b))for(var d=xc(G,!1),e=0,w;w=d[e];e++){var F=w.ia(),z=Vd(w),K=c+25-z.height-F.y;0<K&&w.moveBy(0,K);K=c+a.Ta-25-F.y;0>K&&w.moveBy(0,K);K=25+b-F.x-(t?0:z.width);0<K&&w.moveBy(K,0);K=b+a.xa-25-F.x+(t?z.width:0);0>K&&w.moveBy(K,0)}}}));b.appendChild(De());a.appendChild(b);jc=b;sk();zi=u("div","blocklyWidgetDiv");zi.style.direction=t?"rtl":"ltr";document.body.appendChild(zi)}
...
var zi=null,Je=null,Fl=null;function wi(a,b){fl();Je=a;Fl=b;zi.style.display="block"}function fl(){Je&&(zi.style.display="none",Fl&&Fl(),Fl=Je=null,Le(zi))}function xi(a){Je==a&&fl()}function Ai(a,b,c,d){b<d.y&&(b=d.y);t?a>c.width+d.x&&(a=c.width+d.x):a<d.x&&(a=d.x);zi.style.left=a+"px";zi.style.top=b+"px"};/*
 ...
 limitations under the License.
*/
function Gl(a,b,c,d){this.h=null;this.Ha=Number(c);this.S=Number(b);this.Ca={height:this.Ha+10,width:this.S};this.da=d||"";this.ma=E("g",{},null);this.Qf=E("image",{height:this.Ha+"px",width:this.S+"px",y:-12},this.ma);this.aa(a);tb&&(this.lg=E("rect",{height:this.Ha+"px",width:this.S+"px",y:-12,"fill-opacity":0},this.ma))}n(Gl,Pe);f=Gl.prototype;f.clone=function(){return new Gl(this.xu(),this.S,this.Ha,this.fb())};f.lg=null;f.wd=!1;
...
H.variables_set={g:function(){this.p=U.ar;this.k(330);this.ta(U.dr+" %1 "+U.cr+" %2",["VAR",new Hi(U.br)],["VALUE",null,1],1);J(this,!0);L(this,!0);this.i(U.er);this.uj=U.Pg;this.vj="variables_get"},Zb:function(){return[N(this,"VAR")]},Hb:function(a,b){uf(a,N(this,"VAR"))&&Lc(this,b,"VAR")},ub:H.variables_get.ub};/*
...
H.controls_for={g:function(){this.p=U.Ml;this.k(120);M(M(P(this),U.Pl),new Hi(null),"VAR");this.ta(U.Ol,["FROM","Number",1],["TO","Number",1],["BY","Number",1],1);M(df(this,3,"DO"),U.Nl);J(this,!0);L(this,!0);A(this,!0);var a=this;this.i(function(){return U.Ql.replace("%1",N(a,"VAR"))})},Zb:function(){return[N(this,"VAR")]},Hb:function(a,b){uf(a,N(this,"VAR"))&&Lc(this,b,"VAR")},ub:function(a){if(!this.isCollapsed()){var b={enabled:!0},c=N(this,"VAR");b.text=U.Pg.replace("%1",c);c=u("field",null,
c);c.setAttribute("name","VAR");c=u("block",null,c);c.setAttribute("type","variables_get");b.Ua=nk.rf(this,c);a.push(b)}}};H.controls_forEach={g:function(){this.p=U.Hl;this.k(120);M(M(M(O(this,"LIST").s("Array"),U.Kl),new Hi(null),"VAR"),U.Jl);U.xi&&(M(P(this),U.xi),A(this,!0));M(df(this,3,"DO"),U.Il);J(this,!0);L(this,!0);var a=this;this.i(function(){return U.Ll.replace("%1",N(a,"VAR"))})},Zb:function(){return[N(this,"VAR")]},Hb:function(a,b){uf(a,N(this,"VAR"))&&Lc(this,b,"VAR")},ub:H.controls_for.ub};
...
H.text_append={g:function(){this.p=U.Zp;this.k(160);M(M(M(O(this,"TEXT"),U.$p),new Hi(U.bq),"VAR"),U.Yp);J(this,!0);L(this,!0);var a=this;this.i(function(){return U.aq.replace("%1",N(a,"VAR"))})},Zb:function(){return[N(this,"VAR")]},Hb:function(a,b){uf(a,N(this,"VAR"))&&Lc(this,b,"VAR")}};H.text_length={g:function(){this.p=U.Hq;this.k(160);this.ta(U.Iq,["VALUE",["String","Array"],1],1);I(this,!0,"Number");this.i(U.Jq)}};
...
*/
H.ms={};
H.controls_if={g:function(){this.p=U.Vl;this.k(210);M(O(this,"IF0").s("Boolean"),U.Ig);M(df(this,3,"DO0"),U.Jg);J(this,!0);L(this,!0);this.Zd(new Rd(["controls_if_elseif","controls_if_else"]));var a=this;this.i(function(){if(a.Xa||a.vb){if(!a.Xa&&a.vb)return U.Zl;if(a.Xa&&!a.vb)return U.$l;if(a.Xa&&a.vb)return U.am}else return U.Yl;return""});this.vb=this.Xa=0},Ja:function(){if(!this.Xa&&!this.vb)return null;var a=document.createElement("mutation");this.Xa&&a.setAttribute("elseif",this.Xa);this.vb&&
...
this.fc(a)},fc:function(a){var b=B(this,"DIVISOR");a?b||O(this,"DIVISOR").s("Number"):b&&Q(this,"DIVISOR")}};H.math_change={g:function(){this.p=U.Pn;this.k(230);this.ta(U.Rn+" %1 "+U.Qn+" %2",["VAR",new Hi(U.Sn)],["DELTA","Number",1],1);J(this,!0);L(this,!0);var a=this;this.i(function(){return U.Tn.replace("%1",N(a,"VAR"))})},Zb:function(){return[N(this,"VAR")]},Hb:function(a,b){uf(a,N(this,"VAR"))&&Lc(this,b,"VAR")}};
...
H.math_random_float={g:function(){this.p=U.Ho;this.k(230);I(this,!0,"Number");M(P(this),U.Io);this.i(U.Jo)}};var Bm,X;H.shirt={g:function(){this.k(160);M(M(P(this),"Shirt"),new Gl("./movie/shirt.svg",50,50,"Shirt"));this.i("");J(this,!0)}};R.shirt=function(a){S(a,"X",R.qb);S(a,"Y",R.qb);return"shirt();\n"};H.movie_circle={g:function(){this.k(160);M(M(Ue(O(this,"X").s("Number"),1),W("Movie_circleDraw")),W("Movie_x"));M(Ue(O(this,"Y").s("Number"),1),W("Movie_y"));J(this,!0);L(this,!0);this.i(W("Movie_circleTooltip"))}};
...
R.movie_line=function(a){var b=S(a,"X1",R.D)||"0",c=S(a,"Y1",R.D)||"0",d=S(a,"X2",R.D)||"0",e=S(a,"Y2",R.D)||"0";a=S(a,"WIDTH",R.D)||"0";return"line("+b+", "+c+", "+d+", "+e+", "+a+");\n"};H.movie_time={g:function(){this.k(330);M(P(this),"time (0\u2192100)");I(this,!0,"Number");this.i(W("Movie_timeTooltip"))}};R.movie_time=function(){return["time()",R.qb]};H.movie_colour={g:function(){this.k(20);M(O(this,"COLOUR").s("Colour"),"Color");J(this,!0);L(this,!0);this.i(W("Movie_colourTooltip"))}};
...
X.stroke()}));c=function(a,b,c){Em(a.valueOf(),b.valueOf(),c.valueOf())};a.setProperty(b,"circle",a.createNativeFunction(c));c=function(a,b,c,k){Fm(a.valueOf(),b.valueOf(),c.valueOf(),k.valueOf())};a.setProperty(b,"rect",a.createNativeFunction(c));c=function(a,b,c,k,m){Gm(a.valueOf(),b.valueOf(),c.valueOf(),k.valueOf(),m.valueOf())};a.setProperty(b,"line",a.createNativeFunction(c));c=function(a){Dm(a.toString())};a.setProperty(b,"penColour",a.createNativeFunction(c));a.setProperty(b,"time",a.createNativeFunction(function(){return a.createPrimitive(fn)}))}
function Em(a,b,c){a*=4;b=4*(100-b);c=Math.max(4*c,0);X.beginPath();X.arc(a,b,c,0,2*Math.PI,!1);X.fill()}function Fm(a,b,c,d){a*=4;b=4*(100-b);c=Math.max(4*c,0);d=Math.max(4*d,0);X.beginPath();X.rect(a-c/2,b-d/2,c,d);X.fill()}function Gm(a,b,c,d,e){a*=4;b=4*(100-b);c*=4;d=4*(100-d);e*=4;X.beginPath();X.moveTo(a,b);X.lineTo(c,d);X.lineWidth=Math.max(e,0);X.stroke()}function Dm(a){X.strokeStyle=a;X.fillStyle=a}function Vm(){1<V&&fn!=Im||!Hm()||en||(en=!0,Y.Os(),10>V&&(uk("win",.5),Z.rr()))}
