 ...
 * c) The CSS content may be made dynamic deding on init options.
 */
Blockly.Css.inject = function() {
  ...
  Blockly.Css.setCursor(Blockly.Css.Cursor.O);
};
...
Blockly.Css.setCursor = function(cursor) {
  ...
  */
  if (cursor == Blockly.Css.Cursor.O) {
    var xy = '8 5';
  } else {
    var xy = '7 3';
  }
...
Blockly.Css.CONTENT = [
  ...
  */
  ...
  '.blocklyTreeSelected>.blocklyTreeIconO {',
  ...
  '.blocklyTreeSelected  {',
  '  background-color: #dd3858 !important;',
  '}',
  ...
  */
  ...
  '  padding: 4px 0;',
  '  position: absolute;',
  '  z-index: 20000;',  /* Arbitrary, but some apps ded on it... */
  '}',
