...
var G={};/*
 ...
 limitations under the License.
*/
function $f(a){a=a||A;var b;if(a.Nb)b=a.Nb();else if(a.hb)b=a.hb();else throw"Not Block or Workspace: "+a;a=Object.create(null);for(var c=0;c<b.length;c++){var d=b[c].hc;if(d)for(var d=d.call(b[c]),e=0;e<d.length;e++){var h=d[e];h&&(a[h.toLowerCase()]=h)}}b=[];for(var k in a)b.push(a[k]);return b}function ag(a,b){for(var c=A.hb(),d=0;d<c.length;d++){var e=c[d].Qb;e&&e.call(c[d],a,b)}}
...
f.m=function(){this.B=!1;Ch.k.m.call(this);this.o&&(Vb(this.o),this.o=null);this.pe=this.aa=null;this.V&&(this.V.m(),this.V=null);this.Jb&&(this.Jb.m(),this.Jb=null)};function Eh(){var a=A;if(sa&&!z){a.Jb=new mh(a);var b=a.Jb.H();a.o.insertBefore(b,a.aa);a.Jb.g()}}f.Be=function(a){Ch.k.Be.call(this,a);Fh&&this==A&&-1==Gh.indexOf(a)&&Gh.push(a)};f.Dg=function(a){Ch.k.Dg.call(this,a);Fh&&this==A&&Gh.zv(a)};f.clear=function(){gg();Ch.k.clear.call(this)};f.Xf=function(){return this.Ic().Ea};
f.F=function(){for(var a=this.hb(),b=0,c;c=a[b];b++)c.md().length||c.F()};function Hh(a,b){a.Ri=b;a.Si&&(y(a.Si),a.Si=null);b&&(a.Si=v(a.aa,"blocklySelectChange",a,function(){this.Ri=!1}))}function Ih(a){var b=A;b.Ri&&0!=ac&&Hh(b,!1);if(b.Ri){var c=null;if(a&&(c=La(b,a),!c))return;Hh(b,!1);c?c.select():Jh&&Kh();setTimeout(function(){Hh(b,!0)},1)}}f.Fb=function(){if(this.B){this.Hh&&clearTimeout(this.Hh);var a=this.aa;a&&(this.Hh=setTimeout(function(){lh(a,"blocklyWorkspaceChange")},0))}};
...
f.g=function(){this.Tg.cleardotPath=ph+"1x1.gif";this.Tg.cssCollapsedFolderIcon="blocklyTreeIconClosed"+(q?"Rtl":"Ltr");var a=new Yj(this,this.Tg);this.mf=a;Vj(a);Rj(a);Uj(a);a.Rb(null);this.$c.style.display="block";this.V.g(A);Zj(this);a.F(this.$c);var b=this;Zd(window,"resize",function(){b.Qc()});this.Qc()};
...
f.F=function(){this.B=!0;var a=10;q&&(a=-a);for(var b=Pi(this),c=0;c<b.length;c++){var d=b[c];d.I.isCollapsed()?d.Pa.setAttribute("display","none"):(d.Pa.setAttribute("display","block"),q&&(a-=16),d.Pa.setAttribute("transform","translate("+a+", 5)"),Oh(d),a=q?a-10:a+26)}var e=a+=q?10:-10,h=this.T,b=[];b.Ba=e+20;if(this.K||this.C)b.Ba=Math.max(b.Ba,40);for(var d=c=0,k=!1,m=!1,p=!1,x=void 0,w=this.Xe&&!this.isCollapsed(),E=0,B;B=h[E];E++)if(B.J()){var J;w&&x&&3!=x&&3!=B.type?J=b[b.length-1]:(x=B.type,
J=[],J.type=w&&3!=B.type?-1:B.type,J.height=0,b.push(J));J.push(B);B.yd=25;B.Ya=w&&1==B.type?20.5:0;if(B.s&&B.s.w){var jb=Uh(H(B.s));B.yd=Math.max(B.yd,jb.height);B.Ya=Math.max(B.Ya,jb.width)}E==h.length-1&&B.yd--;J.height=Math.max(J.height,B.yd);B.Xb=0;1==b.length&&(B.Xb+=q?-e:e);for(var jb=!1,Vg=0,Yb;Yb=B.Xa[Vg];Vg++){0!=Vg&&(B.Xb+=10);var Sj=Yb.Xd();Yb.Ya=Sj.width;Yb.Eg=jb&&Yb.Id?10:0;B.Xb+=Yb.Ya+Yb.Eg;J.height=Math.max(J.height,Sj.height);jb=Yb.Id}-1!=J.type&&(3==J.type?(m=!0,d=Math.max(d,B.Xb)):
(1==J.type?k=!0:5==J.type&&(p=!0),c=Math.max(c,B.Xb)))}for(e=0;J=b[e];e++)if(J.vl=!1,-1==J.type)for(h=0;B=J[h];h++)if(1==B.type){J.height+=10;J.vl=!0;break}b.Ng=20+d;m&&(b.Ba=Math.max(b.Ba,b.Ng+30));k?b.Ba=Math.max(b.Ba,c+20+8):p&&(b.Ba=Math.max(b.Ba,c+20));b.Ks=k;b.rv=m;b.qv=p;d=a;this.G?this.Ii=this.Mg=!0:(this.Ii=this.Mg=!1,this.K&&(a=H(this.K))&&Mg(a)==this&&(this.Mg=!0),Mg(this)&&(this.Ii=!0));k=this.na();m=[];p=[];a=[];c=[];B=b.Ba;this.Mg?(m.push("m 0,0"),a.push("m 1,1")):(m.push("m 0,8"),a.push(q?
rk:"m 1,7"),m.push("A 8,8 0 0,1 8,0"),a.push("A 7,7 0 0,1 8,1"));this.K&&(m.push("H",15),a.push("H",15),m.push("l 6,4 3,0 6,-4"),a.push("l 6.5,4 2,0 6.5,-4"),this.K.moveTo(k.x+(q?-30:30),k.y));m.push("H",B);a.push("H",B+(q?-1:0));this.width=B;for(J=B=0;e=b[J];J++){w=10;0==J&&(w+=q?-d:d);a.push("M",b.Ba-1+","+(B+1));if(this.isCollapsed())h=e[0],E=B+18,vk(h.Xa,w,E),m.push("l 8,0 0,4 8,4 -16,8 8,4"),q?a.push("l 8,0 0,3.8 7,3.2 m -14.5,9 l 8,4"):a.push("h 8"),h=e.height-20,m.push("v",h),q&&a.push("v",
h-2),this.width+=15;else if(-1==e.type){for(x=0;h=e[x];x++)E=B+18,e.vl&&(E+=5),w=vk(h.Xa,w,E),5!=h.type&&(w+=h.Ya+10),1==h.type&&(p.push("M",w-10+","+(B+5)),p.push("h",6-h.Ya),p.push("v 5 c 0,10 -8,-8 -8,7.5 s 8,-2.5 8,7.5"),p.push("v",h.yd+1-20),p.push("h",h.Ya+2-8),p.push("z"),q?(c.push("M",w-10-3+8-h.Ya+","+(B+5+1)),c.push("v 6.5 m -7.84,2.5 q -0.4,10 2.16,10 m 5.68,-2.5 v 1.5"),c.push("v",h.yd-20+3),c.push("h",h.Ya-8+1)):(c.push("M",w-10+1+","+(B+5+1)),c.push("v",h.yd+1),c.push("h",6-h.Ya),c.push("M",
w-h.Ya-10+1.8+","+(B+5+20-.4)),c.push("l","3.04,-1.8")),E=q?k.x-w-8+10+h.Ya+1:k.x+w+8-10-h.Ya-1,jb=k.y+B+5+1,h.s.moveTo(E,jb),h.s.w&&ii(h.s));w=Math.max(w,b.Ba);this.width=Math.max(this.width,w);m.push("H",w);a.push("H",w+(q?-1:0));m.push("v",e.height);q&&a.push("v",e.height-2)}else 1==e.type?(h=e[0],E=B+18,-1!=h.align&&(x=b.Ba-h.Xb-8-20,1==h.align?w+=x:0==h.align&&(w+=(x+w)/2)),vk(h.Xa,w,E),m.push("v 5 c 0,10 -8,-8 -8,7.5 s 8,-2.5 8,7.5"),x=e.height-20,m.push("v",x),q?(a.push("v 6.5 m -7.84,2.5 q -0.4,10 2.16,10 m 5.68,-2.5 v 1.5"),
a.push("v",x)):(a.push("M",b.Ba-4.2+","+(B+20-.4)),a.push("l","3.04,-1.8")),E=k.x+(q?-b.Ba-1:b.Ba+1),jb=k.y+B,h.s.moveTo(E,jb),h.s.w&&(ii(h.s),this.width=Math.max(this.width,b.Ba+Uh(H(h.s)).width-8+1))):5==e.type?(h=e[0],E=B+18,-1!=h.align&&(x=b.Ba-h.Xb-20,b.Ks&&(x-=8),1==h.align?w+=x:0==h.align&&(w+=(x+w)/2)),vk(h.Xa,w,E),m.push("v",e.height),q&&a.push("v",e.height-2)):3==e.type&&(h=e[0],0==J&&(m.push("v",10),q&&a.push("v",9),B+=10),E=B+18,-1!=h.align&&(x=b.Ng-h.Xb-20,1==h.align?w+=x:0==h.align&&
(w+=(x+w)/2)),vk(h.Xa,w,E),w=b.Ng+30,m.push("H",w),m.push("l -6,4 -3,0 -6,-4 h -7 a 8,8 0 0,0 -8,8"),m.push("v",e.height-16),m.push("a 8,8 0 0,0 8,8"),m.push("H",b.Ba),q?(a.push("M",w-30+qk+","+(B+qk)),a.push(sk),a.push("v",e.height-16),a.push("a 9,9 0 0,0 9,9"),a.push("H",b.Ba-1)):(a.push("M",w-30+qk+","+(B+e.height-qk)),a.push(tk),a.push("H",b.Ba)),E=k.x+(q?-w:w),jb=k.y+B+1,h.s.moveTo(E,jb),h.s.w&&(ii(h.s),this.width=Math.max(this.width,b.Ng+Uh(H(h.s)).width)),J==b.length-1||3==b[J+1].type)&&(m.push("v",
...
function al(a){return function(){var b=$k,c=b.value;a.h&&a.ma&&(c=a.ma(c),null===c&&(c=b.defaultValue));a.qa(c);a.h.B&&a.h.F();y(b.gt);y(b.ft);y(b.ot);$k=null;Tf.style.width="auto"}}function cl(a){if(null===a)return null;a=a.replace(/O/ig,"0");a=a.replace(/,/g,"");a=parseFloat(a||0);return isNaN(a)?null:String(a)}function dl(a){(a=cl(a))&&(a=String(Math.max(0,Math.floor(a))));return a};/*
 ...
 limitations under the License.
*/
function el(a){this.pg=a;this.fh="";this.Qm=new RegExp(this.Ka,"g")}el.prototype.tf=null;el.prototype.Kd=null;function fl(){var a=S,b=A,c=[];a.g(b);for(var b=Ka(b,!0),d=0,e;e=b[d];d++){var h=gl(a,e);ea(h)&&(h=h[0]);h&&(e.G&&a.hl&&(h=a.hl(h)),c.push(h))}c=c.join("\n");c=a.finish(c);c=c.replace(/^\s+\n/,"");c=c.replace(/\n\s+$/,"\n");return c=c.replace(/[ \t]+\n/g,"\n")}function hl(a,b){return b+a.replace(/\n(.)/g,"\n"+b+"$1")}
...
d);d=u("filter",{id:"blocklyShadowFilter"},c);u("feGaussianBlur",{stdDeviation:2},d);c=u("pattern",{id:"blocklyDisabledPattern",patternUnits:"userSpaceOnUse",width:10,height:10},c);u("rect",{width:10,height:10,fill:"#aaa"},c);u("path",{d:"M 0 0 L 10 10 M 10 0 L 0 10",stroke:"#cc0"},c);A=new Ch(wl,xl);b.appendChild(A.H());A.ci=Aa;z||(Ba?A.ab=new Xj(b,a):(A.V=new Sh,c=A.V,d=c.H(),c.Ce=!1,bd(d)),Ca||yl(function(){if(0==ac){var a=A.Ic(),b=a.Kb+a.Ab,c=a.Xc+a.Bb;if(a.Wb<c||a.Wb+a.Cb>a.bb+c||a.uc<(q?a.Kb:
b)||a.uc+a.Pd>(q?a.Ea:a.Ea+b))for(var d=Ka(A,!1),e=0,w;w=d[e];e++){var E=w.na(),B=Uh(w),J=c+25-B.height-E.y;0<J&&w.moveBy(0,J);J=c+a.bb-25-E.y;0>J&&w.moveBy(0,J);J=25+b-E.x-(q?0:B.width);0<J&&w.moveBy(J,0);J=b+a.Ea-25-E.x+(q?B.width:0);0>J&&w.moveBy(J,0)}}}));b.appendChild(Ci());a.appendChild(b);ta=b;jk();Tf=D("div","blocklyWidgetDiv");Tf.style.direction=q?"rtl":"ltr";document.body.appendChild(Tf)}
function tl(){v(ta,"mousedown",null,zl);v(ta,"contextmenu",null,Al);v(Tf,"contextmenu",null,Al);Ea||(v(window,"resize",document,jk),v(document,"keydown",null,Bl),document.addEventListener("mouseup",Cl,!1),Lb&&v(window,"orientationchange",document,function(){lh(window,"resize")}),Ea=!0);if(ua)if(A.ab)A.ab.g();else if(A.V){A.V.g(A);A.V.show(ua.childNodes);A.scrollX=A.V.R;q&&(A.scrollX*=-1);var a="translate("+A.scrollX+", 0)";A.aa.setAttribute("transform",a);A.pe.setAttribute("transform",a)}Ca&&(A.Tc=
new th(A),A.Tc.resize());Eh();if(Da){Dl([ph+"click.mp3",ph+"click.wav",ph+"click.ogg"],"click");Dl([ph+"delete.mp3",ph+"delete.ogg",ph+"delete.wav"],"delete");var b=[],a=function(){for(;b.length;)y(b.pop());for(var a in El){var d=El[a];d.volume=.01;d.play();d.pause();if(Lb||Kb)break}};b.push(v(document,"mousemove",null,a));b.push(v(document,"touchstart",null,a))}};/*
...
function Yl(a,b){Xl(function(){var c=Og(a.Ui).firstChild;if(c=Qg(A,c,!0))b&&c.t.Be(c),(b||xb(Gh,c))&&Zl(c)})}function Zl(a){if(!isNaN(a.zg)&&!isNaN(a.Ag)){var b=Mi().width,c=a.na(),d=a.zg-c.x;a.moveBy(q?b-d:d,a.Ag-c.y)}}function am(a){Xl(function(){a.m(!0,!0,!0)})}function hk(a){if(a.t==A&&Fh&&!Vi){a=fi(a);var b=a.na(),c=!1,d=Lg(a);d.setAttribute("id",a.id);var e=D("xml");e.appendChild(d);d=Ng(e);d!=a.Ui&&(c=!0,a.Ui=d);if(a.zg!=b.x||a.Ag!=b.y)a.zg=b.x,a.Ag=b.y,c=!0;c&&Ti.set(a.id.toString(),a)}}
...
/*
 ...
 limitations under the License.
*/
var ph="https://blockly-demo.appspot.com/static/media/",nh=64,oh=92,qh="sprites.png",$h=[,2,1,4,3],El=Object.create(null),Jh=null,z=!1,Xh=null,Yh=null,oj=5,gi=20,ci=250,ik=30,A=null,im=null,ac=0,jm=null;function Mi(){return{width:ta.Gj,height:ta.Fj}}function jk(){var a=ta,b=a.parentNode,c=b.offsetWidth,b=b.offsetHeight;a.Gj!=c&&(a.setAttribute("width",c+"px"),a.Gj=c);a.Fj!=b&&(a.setAttribute("height",b+"px"),a.Fj=b);A.Tc&&A.Tc.resize()}
function zl(a){jk();lj();gg();var b=a.target&&a.target.nodeName&&"svg"==a.target.nodeName.toLowerCase();!z&&Jh&&b&&Kh();a.target==ta&&$b(a)?km(a):(z||b)&&A.Tc&&(A.Fh=!0,A.Li=a.clientX,A.Mi=a.clientY,A.Gt=A.Ic(),A.It=A.scrollX,A.Jt=A.scrollY,"mouseup"in wk&&(jm=v(document,"mouseup",null,Cl)),Fa=v(document,"mousemove",null,lm))}function Cl(){ih(nk.OPEN);A.Fh=!1;jm&&(y(jm),jm=null);Fa&&(y(Fa),Fa=null)}
function lm(a){if(A.Fh){Bh();var b=A.Gt,c=A.It+(a.clientX-A.Li),d=A.Jt+(a.clientY-A.Mi),c=Math.min(c,-b.uc),d=Math.min(d,-b.Wb),c=Math.max(c,b.Ea-b.uc-b.Pd),d=Math.max(d,b.bb-b.Wb-b.Cb);A.Tc.set(-c-b.uc,-d-b.Wb);a.stopPropagation()}}
function Bl(a){if(!hh(a))if(27==a.keyCode)gg();else if(8==a.keyCode||46==a.keyCode)try{Jh&&Jh.Sd&&!z&&(gg(),Jh.m(!0,!0))}finally{a.preventDefault()}else if(a.altKey||a.ctrlKey||a.metaKey)if(Jh&&Jh.Sd&&!z&&Jh.mc&&!z&&Jh.t==A&&(gg(),67==a.keyCode?mm():88==a.keyCode&&(mm(),Jh.m(!0,!0))),86==a.keyCode&&im){a=A;var b=im;if(!(b.getElementsByTagName("block").length>=Ma(a))){var c=Qg(a,b),d=parseInt(b.getAttribute("x"),10),b=parseInt(b.getAttribute("y"),10);if(!isNaN(d)&&!isNaN(b)){q&&(d=-d);do for(var e=
...
function km(a){if(!z){var b=[];if(wa){for(var c=!1,d=!1,e=Ka(A,!1),h=0;h<e.length;h++)for(var k=e[h];k;)k.isCollapsed()?c=!0:d=!0,k=Mg(k);d={enabled:d};d.text=G.Hl;d.cb=function(){for(var a=0,b=0;b<e.length;b++)for(var c=e[b];c;)setTimeout(c.Ad.bind(c,!0),a),c=Mg(c),a+=10};b.push(d);c={enabled:c};c.text=G.Nm;c.cb=function(){for(var a=0,b=0;b<e.length;b++)for(var c=e[b];c;)setTimeout(c.Ad.bind(c,!1),a),c=Mg(c),a+=10};b.push(c)}ek.show(a,b)}}function Al(a){hh(a)||a.preventDefault()}
function gg(a){Hi();Yk();!a&&A.ab&&A.ab.V&&A.ab.V.Ce&&A.ab.mf.Rb(null)}function Bh(){if(window.getSelection){var a=window.getSelection();a&&a.removeAllRanges&&(a.removeAllRanges(),setTimeout(function(){try{window.getSelection().removeAllRanges()}catch(a){}},0))}}function hh(a){return"textarea"==a.target.type||"text"==a.target.type}
...
function wl(){var a=Mi();A.ab&&(a.width-=A.ab.width);var b=a.width-kh,c=a.height-kh;try{var d=A.aa.getBBox()}catch(e){return null}if(A.Tc)var h=Math.min(d.x-b/2,d.x+d.width-b),b=Math.max(d.x+d.width+b/2,d.x+b),k=Math.min(d.y-c/2,d.y+d.height-c),c=Math.max(d.y+d.height+c/2,d.y+c);else h=d.x,b=h+d.width,k=d.y,c=k+d.height;d=0;!q&&A.ab&&(d=A.ab.width);return{bb:a.height,Ea:a.width,Cb:c-k,Pd:b-h,Xc:-A.scrollY,Kb:-A.scrollX,Wb:k,uc:h,Bb:0,Ab:d}}
function xl(a){if(!A.Tc)throw"Attempt to set main workspace scroll without scrollbars.";var b=wl();ga(a.x)&&(A.scrollX=-b.Pd*a.x-b.uc);ga(a.y)&&(A.scrollY=-b.Cb*a.y-b.Wb);a="translate("+(A.scrollX+b.Ab)+","+(A.scrollY+b.Bb)+")";A.aa.setAttribute("transform",a);A.pe.setAttribute("transform",a)}function kk(a){a()}function yl(a){return v(A.aa,"blocklyWorkspaceChange",null,a)}g.Blockly||(g.Blockly={});g.Blockly.getMainWorkspace=function(){return A};g.Blockly.addChangeListener=yl;
...
-1):(a=Og(a),Pg(A,a))},Bt:function(){if(void 0!=typeof ra&&window.localStorage){var a=Am+vm;if(V.Td)var b=V.Td.getValue();else b=Kg(A),b=Ng(b);window.localStorage[a]=b}},dg:function(){window.location=(tm?"index.html":"./")+"?lang="+rm},Wr:function(){if(window.sessionStorage){if(V.Td)var a=V.Td.getValue();else a=Kg(A),a=Ng(a);window.sessionStorage.Lk=a}var a=document.getElementById("languageMenu"),a=encodeURIComponent(a.options[a.selectedIndex].value),b=window.location.search,b=1>=b.length?"?lang="+
...
!0);W.oe(a,null,!1,!0,{width:"40%",left:"30%",top:"3em"},function(){document.body.removeEventListener("keydown",W.yj,!0)});document.body.addEventListener("keydown",W.yj,!0)}},Yr:function(){var a=document.getElementById("dialogDone");if(A){var b=document.getElementById("dialogLinesText");b.textContent="";var c=fl(),c=V.Lt(c),c=c.split("\n").length;document.getElementById("containerCode").innerHTML="<p>Five new shirts unlocked!</p><img src='./turtle/shirt.png' width='80px' border=0/><img src='./turtle/shirt.png' width='80px' border=0/><img src='./turtle/shirt.png' width='80px' border=0/><img src='./turtle/shirt.png' width='80px' border=0/><img src='./turtle/shirt.png' width='80px' border=0/>";
...
function un(){if(!vn&&!W.Mc){var a=document.getElementById("helpToolbox"),b=document.getElementById(":0");W.oe(a,b,!0,!1,{width:"25%",left:"525px",top:"3.3em"},null)}}var vn=!1;function tn(){A.ab.V.J()&&(vn=!0,W.ic(!1));vn||setTimeout(tn,100)}function on(){Fm=Em=200;Gm=0;kn=Hm=!0;Y.canvas.width=Y.canvas.width;Y.strokeStyle="#ec8fa1";Y.fillStyle="#ffffff";Y.lineWidth=5;Y.lineCap="round";Y.font="normal 18pt Arial";wn();for(var a=0;a<gn.length;a++)window.clearTimeout(gn[a]);gn.length=0;jn=null}
function wn(){X.beginPath();X.rect(0,0,X.canvas.width,X.canvas.height);X.fillStyle="#444444";X.fill();X.globalCompositeOperation="source-over";X.globalAlpha=.2;X.drawImage(Dm.canvas,0,0);X.globalAlpha=1;X.globalCompositeOperation="source-over";X.drawImage(Y.canvas,0,0);if(kn){X.strokeStyle=Y.strokeStyle;X.fillStyle=Y.fillStyle;var a=Y.lineWidth/2+10;X.beginPath();X.arc(Em,Fm,a,0,2*Math.PI,!1);X.lineWidth=3;X.stroke();var b=2*Math.PI*Gm/360,c=Em+(a+10)*Math.sin(b),d=Fm-(a+10)*Math.cos(b),b=b-.3,e=
Em+(a+4)*Math.sin(b),h=Fm-(a+4)*Math.cos(b),b=b+.15,k=Em+(a+6)*Math.sin(b),m=Fm-(a+6)*Math.cos(b),b=b+.3,p=Em+(a+6)*Math.sin(b),x=Fm-(a+6)*Math.cos(b),b=b+.15,w=Em+(a+4)*Math.sin(b),a=Fm-(a+4)*Math.cos(b);X.beginPath();X.moveTo(c,d);X.lineTo(e,h);X.bezierCurveTo(k,m,p,x,w,a);X.closePath();X.fill()}}
function pn(a){if(!V.ec(a)){a=document.getElementById("runButton");var b=document.getElementById("resetButton");b.style.minWidth||(b.style.minWidth=a.offsetWidth+"px");a.style.display="none";b.style.display="inline";document.getElementById("spinner").style.visibility="visible";Hh(A,!0);xn()}}
function qn(a){V.ec(a)||(document.getElementById("runButton").style.display="inline",document.getElementById("resetButton").style.display="none",document.getElementById("spinner").style.visibility="hidden",Hh(A,!1),on(),ln=!1)}
