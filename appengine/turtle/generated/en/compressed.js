...
function Ub(a){if(a.Ja){var b=a.Ka;Yb(a.Ja);b=b.replace(/\s/g,"\u00a0");q&&b&&(b+="\u200f");b||(b="\u00a0");a.Ja.appendChild(document.createTextNode(b));a.Aa.width=0}}f.Fa=function(){return this.fb()};f.ja=function(a){this.ia(a)};f.Rh=function(a){if(!Kb&&!Lb||0===a.layerX||0===a.layerY)$b(a)||2!=ac&&this.h.uc&&!z&&this.wg()};f.i=function(){};/*
...
f.g=function(a,b){this.bb=a;var c=this.type=a.type;this.target=a.target||a.srcElement;this.currentTarget=b;var d=a.relatedTarget;if(d){if(Eb){var e;a:{try{Td(d.nodeName);e=!0;break a}catch(h){}e=!1}e||(d=null)}}else"mouseover"==c?d=a.fromElement:"mouseout"==c&&(d=a.toElement);this.relatedTarget=d;Object.defineProperties?Object.defineProperties(this,{offsetX:{configurable:!0,enumerable:!0,get:this.$j,set:this.Os},offsetY:{configurable:!0,enumerable:!0,get:this.ak,set:this.Ps}}):(this.offsetX=this.$j(),
...
f.$j=function(){return t||void 0!==this.bb.offsetX?this.bb.offsetX:this.bb.layerX};f.Os=function(a){Object.defineProperties(this,{offsetX:{writable:!0,enumerable:!0,configurable:!0,value:a}})};f.ak=function(){return t||void 0!==this.bb.offsetY?this.bb.offsetY:this.bb.layerY};f.Ps=function(a){Object.defineProperties(this,{offsetY:{writable:!0,enumerable:!0,configurable:!0,value:a}})};var Xd="closure_lm_"+(1E6*Math.random()|0),Yd={},Zd=0;function $d(a,b,c,d,e){if(ea(b)){for(var h=0;h<b.length;h++)$d(a,b[h],c,d,e);return null}c=ae(c);if(a&&a[Dd])a=a.N(b,c,d,e);else{if(!b)throw Error("Invalid event type");var h=!!d,k=be(a);k||(a[Xd]=k=new Hd(a));c=k.add(b,c,!1,d,e);c.ig||(d=ce(),c.ig=d,d.src=a,d.fd=c,a.addEventListener?a.addEventListener(b.toString(),d,h):a.attachEvent(de(b.toString()),d),Zd++);a=c}return a}
...
f.Z=function(){this.Q&&this.Db();this.xc&&(this.xc.m(),delete this.xc);ve(this,function(a){a.m()});!this.ct&&this.D&&Vb(this.D);this.$a=this.$f=this.D=this.rc=this.qa=null;pe.k.Z.call(this)};f.oe=function(a,b){this.Bd(a,we(this),b)};
...
function Ue(a,b,c){Pe||(Pe={1:"disabled",8:"selected",16:"checked",64:"expanded"});b=Pe[b];var d=a.getAttribute("role")||null;d&&(d=Qe[d]||b,b="checked"==b||"selected"==b?d:b);b&&Le(a,b,c)}f.qd=function(a,b){var c=this.xb(a);if(c&&(Yb(c),b))if(l(b))dd(c,b);else{var d=function(a){if(a){var b=Uc(c);c.appendChild(l(a)?b.createTextNode(a):a)}};ea(b)?tb(b,d):!fa(b)||"nodeType"in b?d(b):tb(zb(b),d)}};f.Ea=function(a){return a.n()};f.U=function(){return"goog-control"};
...
f.Pr=function(a){t&&(17==this.yb&&!a.ctrlKey||18==this.yb&&!a.altKey||Gb&&91==this.yb&&!a.metaKey)&&(this.Bc=this.yb=-1);-1==this.yb&&(a.ctrlKey&&17!=a.keyCode?this.yb=17:a.altKey&&18!=a.keyCode?this.yb=18:a.metaKey&&91!=a.keyCode&&(this.yb=91));cf&&!Ve(a.keyCode,this.yb,a.shiftKey,a.ctrlKey,a.altKey)?this.handleEvent(a):(this.Bc=Xe(a.keyCode),df&&(this.Tg=a.altKey))};f.Qr=function(a){this.Bc=this.yb=-1;this.Tg=a.altKey};
...
f.n=function(){return this.D};function $e(a,b,c){a.Vf&&a.detach();a.D=b;a.Uf=$d(a.D,"keypress",a,c);a.Gh=$d(a.D,"keydown",a.Pr,c,a);a.Vf=$d(a.D,"keyup",a.Qr,c,a)}f.detach=function(){this.Uf&&(ge(this.Uf),ge(this.Gh),ge(this.Vf),this.Vf=this.Gh=this.Uf=null);this.D=null;this.Bc=this.yb=-1};f.Z=function(){Ze.k.Z.call(this);this.detach()};function ef(a,b,c,d){Ud.call(this,d);this.type="key";this.keyCode=a;this.charCode=b;this.repeat=c}n(ef,Ud);function ff(a,b,c){pe.call(this,c);if(!b){b=this.constructor;for(var d;b;){d=ja(b);if(d=Ie[d])break;b=b.k?b.k.constructor:null}b=d?ha(d.Yb)?d.Yb():new d:null}this.L=b;this.tg(void 0!==a?a:null)}n(ff,pe);f=ff.prototype;f.Xa=null;f.$=0;f.ua=39;f.Zg=255;f.ud=0;f.oa=!0;f.Xb=null;f.He=!0;f.Sg=!1;f.Es=null;f.Ea=function(){return this.L.Ea(this)};f.Gf=function(){return this.Za||(this.Za=new Ze)};
f.ue=function(a,b){b?a&&(this.Xb?xb(this.Xb,a)||this.Xb.push(a):this.Xb=[a],this.L.ue(this,a,!0)):a&&this.Xb&&yb(this.Xb,a)&&(0==this.Xb.length&&(this.Xb=null),this.L.ue(this,a,!1))};f.H=function(){var a=this.L.H(this);this.D=a;Se(this.L,a,this.If());this.Sg||this.L.fi(a,!1);this.J()||this.L.O(a,!1)};f.If=function(){return this.Es};f.xb=function(){return this.L.xb(this.n())};
...
f.Or=function(a){var b=Ae(this,a.target);if(-1<b&&b!=this.M){var c=xe(this,this.M);c&&c.ob(!1);this.M=b;c=xe(this,this.M);this.Wd&&c.setActive(!0);this.Cs&&this.za&&c!=this.za&&(c.ua&64?kf(c,!0):kf(this.za,!1))}b=this.n();null!=a.target.n()&&Le(b,"activedescendant",a.target.n().id)};f.Ur=function(a){a.target==xe(this,this.M)&&(this.M=-1);a=this.n();Me(a)};f.Rr=function(a){(a=a.target)&&a!=this.za&&a.getParent()==this&&(this.za&&kf(this.za,!1),this.za=a)};
f.Lr=function(a){a.target==this.za&&(this.za=null)};f.yc=function(a){this.Xc&&(this.Wd=!0);var b=this.Ea();b&&gd(b)&&hd(b)?b.focus():a.preventDefault()};f.Mr=function(){this.Wd=!1};f.Kr=function(a){var b=Ef(this,a.target);if(b)switch(a.type){case "mousedown":b.yc(a);break;case "mouseup":b.Je(a);break;case "mouseover":b.Ie(a);break;case "mouseout":b.yh(a);break;case "contextmenu":b.Ge(a)}};
...
f.wh=function(a){this.Rg&&this.Ea().focus();return Mf.k.wh.call(this,a)};f.oj=function(a){return(this.cr||a.isEnabled())&&a.J()&&!!(a.ua&2)};f.cd=function(a){var b=Mf.k.cd.call(this,a);b||ve(this,function(c){!b&&c.Ir&&c.pk==a.keyCode&&(this.isEnabled()&&this.ob(c),b=c.Fb(a))},this);return b};
...
function qg(a,b,c){c=Math.min(Math.max(c,0),1);Math.round(c*a[0]+(1-c)*b[0]);Math.round(c*a[1]+(1-c)*b[1]);Math.round(c*a[2]+(1-c)*b[2])};function rg(a,b){null!=a&&this.append.apply(this,arguments)}f=rg.prototype;f.xa="";f.set=function(a){this.xa=""+a};f.append=function(a,b,c){this.xa+=a;if(null!=b)for(var d=1;d<arguments.length;d++)this.xa+=arguments[d];return this};f.clear=function(){this.xa=""};f.toString=function(){return this.xa};function sg(a,b,c){if(ha(a))c&&(a=oa(a,c));else if(a&&"function"==typeof a.handleEvent)a=oa(a.handleEvent,a);else throw Error("Invalid listener argument");return 2147483647<b?-1:g.setTimeout(a,b||0)};function tg(a,b,c){pe.call(this,c);this.Na=b||ug;this.Bh=a instanceof Dc?a:Hc(a,null)}n(tg,pe);var vg={};f=tg.prototype;f.di=!1;f.ve=!1;f.Ys=null;f.ar=Nc;f.Me=!0;f.vf=-1;f.Z=function(){tg.k.Z.call(this);this.wd&&(this.wd.removeNode(this),this.wd=null);this.D=null};
...
function Fg(a){var b={};b["padding-"+(ye(a)?"right":"left")]=Bg(a)+"px";var b={"class":a.Ce(),style:b},c=a.sh(),d=Lc("span",{style:{display:"inline-block"},"class":a.Af()}),e=Lc("span",{"class":a.Na.Jj,title:a.Ys||null},a.Bh);a=Mc(e,Lc("span",{},a.ar));return Lc("div",b,[c,d,a])}f.Ce=function(){return this.Na.hh+(this.Tf()?" "+this.Na.Lj:"")};f.sh=function(){return Lc("span",{type:"expand",style:{display:"inline-block"},"class":Gg(this)})};
function Gg(a){var b=a.gb(),c=!b.Xe||b==a.getParent()&&!b.li,d=a.Na,e=new rg;e.append(d.Wc," ",d.pr," ");if(ze(a)){var h=0;b.ki&&a.Me&&(h=a.lb()?2:1);c||(h=a.Pb?h+8:h+4);switch(h){case 1:e.append(d.tr);break;case 2:e.append(d.sr);break;case 4:e.append(d.Ej);break;case 5:e.append(d.rr);break;case 6:e.append(d.qr);break;case 8:e.append(d.Fj);break;case 9:e.append(d.vr);break;case 10:e.append(d.ur);break;default:e.append(d.Dj)}}else c?e.append(d.Dj):a.Pb?e.append(d.Fj):e.append(d.Ej);return e.toString()}
...
null;this.Mb.appendChild(a);return this.Mb};f.hr=function(a){hh(this);gh();$b(a)||ih(a)||(jh(kh),this.Uj=q?this.md+a.clientX:this.md-a.clientX,this.Br=this.Pe-a.clientY,eh=v(document,"mouseup",this,gh),fh=v(document,"mousemove",this,this.ir),hg(),a.stopPropagation())};f.ir=function(a){this.Yg=!1;this.md=q?this.Uj-a.clientX:this.Uj+a.clientX;this.Pe=this.Br+a.clientY;ch(this);dh(this)};
f.Ls=function(a){hh(this);gh();$b(a)||(jh(kh),this.Ks=q?this.R+a.clientX:this.R-a.clientX,this.Js=this.Ga-a.clientY,eh=v(document,"mouseup",this,gh),fh=v(document,"mousemove",this,this.Ms),hg(),a.stopPropagation())};f.Ms=function(a){this.Yg=!1;var b=this.Ks,c=this.Js+a.clientY,b=q?b-a.clientX:b+a.clientX;this.Ic(b,c);q&&ch(this)};function hh(a){a.Mb.parentNode.appendChild(a.Mb)}function ah(a,b,c){a.Lb=b;a.Ug=c;a.ai&&ch(a)}
...
this.ma=a}};uh.prototype.set=function(a,b){this.Ee.set(a);this.cf.set(b)};function vh(a,b,c){this.u=a;this.gg=c||!1;this.hb=b;this.dh();b?(this.Jb.setAttribute("height",lh),this.Ba.setAttribute("height",lh-6),this.Ba.setAttribute("y",3)):(this.Jb.setAttribute("width",lh),this.Ba.setAttribute("width",lh-6),this.Ba.setAttribute("x",3));this.uk=v(this.Jb,"mousedown",this,this.vs);this.vk=v(this.Ba,"mousedown",this,this.ws)}var xh,yh,lh=15;aa("document.documentElement.ontouchstart")&&(lh=25);f=vh.prototype;
...
f.vs=function(a){this.eg();if(!$b(a)){var b=Bh(a),b=this.hb?b.x:b.y,c=th(this.Ba),c=this.hb?c.x:c.y,d=parseFloat(this.Ba.getAttribute(this.hb?"width":"height")),e=parseFloat(this.Ba.getAttribute(this.hb?"x":"y")),h=.95*d;b<=c?e-=h:b>=c+d&&(e+=h);this.Ba.setAttribute(this.hb?"x":"y",zh(this,e));Ah(this)}a.stopPropagation()};
f.ws=function(a){this.eg();$b(a)||(this.Rs=parseFloat(this.Ba.getAttribute(this.hb?"x":"y")),this.Ts=this.hb?a.clientX:a.clientY,xh=v(document,"mouseup",this,this.eg),yh=v(document,"mousemove",this,this.ys));a.stopPropagation()};f.ys=function(a){this.Ba.setAttribute(this.hb?"x":"y",zh(this,this.Rs+((this.hb?a.clientX:a.clientY)-this.Ts)));Ah(this)};f.eg=function(){Ch();hg(!0);xh&&(w(xh),xh=null);yh&&(w(yh),yh=null)};
...
function wh(a,b){var c=b.nextSibling,d=b.parentNode;if(!d)throw"Reference node has no parent.";c?d.insertBefore(a,c):d.appendChild(a)};/*
 ...
 limitations under the License.
*/
function Dh(a,b){Dh.k.constructor.call(this);this.wc=a;this.Kk=b;var c=[];c[1]=new Eh;c[2]=new Eh;c[3]=new Eh;c[4]=new Eh;this.or=c}n(Dh,Ja);f=Dh.prototype;f.B=!0;f.ik=!1;f.nh=!1;f.scrollX=0;f.scrollY=0;f.Ab=null;f.ph=null;f.Hc=null;f.H=function(){this.o=u("g",{},null);this.aa=u("g",{},this.o);this.de=u("g",{},this.o);this.wb();return this.o};
f.m=function(){this.B=!1;Dh.k.m.call(this);this.o&&(Vb(this.o),this.o=null);this.de=this.aa=null;this.V&&(this.V.m(),this.V=null);this.Ab&&(this.Ab.m(),this.Ab=null)};function Fh(){var a=A;if(sa&&!z){a.Ab=new nh(a);var b=a.Ab.H();a.o.insertBefore(b,a.aa);a.Ab.g()}}f.pe=function(a){Dh.k.pe.call(this,a);Gh&&this==A&&-1==Hh.indexOf(a)&&Hh.push(a)};f.og=function(a){Dh.k.og.call(this,a);Gh&&this==A&&Hh.Iu(a)};f.clear=function(){hg();Dh.k.clear.call(this)};f.Kf=function(){return this.wc().wa};
...
ac)for(var a=Ka(b.u,!1),c=0,d;d=a[c];c++){var m=d.ga(),p=Vh(d);20>m.y+p.height&&d.moveBy(0,20-p.height-m.y)}b.nc.t==b.u&&(a=b.I.B,b.I.B=!1,b.I.Dd(b.nc),b.I.B=a,b.I.ra(),b.I.B&&b.I.F(),b.qg(),b.I.t.wb())});this.Lc()}else this.vd=null,this.u.m(),this.nc=this.u=null,this.ka.m(),this.ka=null,this.df=this.he=0,this.mi&&(w(this.mi),this.mi=null)};f.m=function(){this.I.Gb=null;Oh.prototype.m.call(this)};/*
 ...
 limitations under the License.
*/
function Wh(a,b){this.h=a;this.w=null;this.type=b;this.ea=this.Rb=0;this.$b=!1;this.tc=this.h.t.or}f=Wh.prototype;f.m=function(){if(this.w)throw"Disconnect connection before disposing of it.";this.$b&&Xh(this.tc[this.type],this);this.$b=!1;Yh==this&&(Yh=null);Zh==this&&(Zh=null)};function $h(a){return 1==a.type||3==a.type}
...
function Xh(a,b){if(!b.$b)throw"Connection not in database.";b.$b=!1;for(var c=0,d=a.length-2,e=d;c<e;)a[e].ea<b.ea?c=e:d=e,e=Math.floor((c+d)/2);for(d=c=e;0<=c&&a[c].ea==b.ea;){if(a[c]==b){a.splice(c,1);return}c--}do{if(a[d]==b){a.splice(d,1);return}d++}while(d<a.length&&a[d].ea==b.ea);throw"Unable to find connection in connectionDB.";};/*
 ...
 limitations under the License.
*/
var C={$s:0,Fr:function(){var a=(++C.$s).toString();return Gh?pi(a):a},ku:function(a){var b={g:function(){var b=this;this.j(a.tj);this.p=a.p;"string"==typeof a.kb?this.i(a.kb):"function"==typeof a.kb&&this.i(function(){return a.kb(b)});"undefined"!=a.Ds?L(this,!0,a.Ds):(M(this,"undefined"==typeof a.Fs?!0:a.Fs),N(this,"undefined"==typeof a.rs?!0:a.rs));var d=[];d.push(a.text);a.dr&&a.dr.forEach(function(a){"undefined"==a.type||1==a.type?d.push([a.name,a.check,"undefined"==typeof a.align?1:a.align]):
qb("addTemplate() can only handle value inputs.")});d.push(1);a.as&&this.Nu(a.as);qi.prototype.sa.apply(this,d)}};b.Ia=a.Qu?function(){var b=a.os?a.Eu():document.createElement("mutation");b.setAttribute("is_statement",this.isStatement||!1);return b}:a.os;C[a.ou]=b}};/*
...
f.ia=function(a){this.Ka!=a&&(this.Ka=a,this.J()&&(this.O(!1),this.O(!0)))};f.m=function(){this.I.gc=null;Oh.prototype.m.call(this)};/*
 ...
 limitations under the License.
*/
function qi(){}function hc(a,b){if(Gh)return Si.create(qi,a,b);var c=a.B?new Ti:new qi;c.initialize(a,b);return c}f=qi.prototype;f.initialize=function(a,b){this.id=C.Fr();a.pe(this);this.fill(a,b)};
...
f.ya=function(){Pj.k.ya.call(this);var a=this.n();a.className=this.Na.Kj;a.setAttribute("hideFocus","true");a=this.n();a.tabIndex=0;var b=this.Za=new Ze(a),c=this.qh=new Oj(a);te(this).N(c,"focusout",this.Jr).N(c,"focusin",this.Nr).N(b,"key",this.Fb).N(a,"mousedown",this.xh).N(a,"click",this.xh).N(a,"dblclick",this.xh);this.Rf()};f.Db=function(){Pj.k.Db.call(this);this.Za.m();this.Za=null;this.qh.m();this.qh=null};
...
f.Be=function(){return new oc(q?Ni().width-this.width:-1E7,-1E7,1E7+this.width,2E7)};function Zj(a,b){this.Ta=a;Pj.call(this,Nc,b)}n(Zj,Pj);Zj.prototype.ya=function(){Zj.k.ya.call(this);if(Od){var a=this.n();v(a,"touchstart",this,this.Tr)}};Zj.prototype.Tr=function(a){a.preventDefault();var b=Xj(this,a);b&&"touchstart"===a.type&&setTimeout(function(){b.Ph(a)},1)};Zj.prototype.createNode=function(a){return new dk(this.Ta,a?Gc(a):Nc,this.Na,this.eb())};
...
K=[],K.type=x&&3!=B.type?-1:B.type,K.height=0,b.push(K));K.push(B);B.nd=25;B.Qa=x&&1==B.type?20.5:0;if(B.s&&B.s.w){var jb=Vh(I(B.s));B.nd=Math.max(B.nd,jb.height);B.Qa=Math.max(B.Qa,jb.width)}E==h.length-1&&B.nd--;K.height=Math.max(K.height,B.nd);B.Ob=0;1==b.length&&(B.Ob+=q?-e:e);for(var jb=!1,Wg=0,Zb;Zb=B.Pa[Wg];Wg++){0!=Wg&&(B.Ob+=10);var Rj=Zb.Od();Zb.Qa=Rj.width;Zb.pg=jb&&Zb.xd?10:0;B.Ob+=Zb.Qa+Zb.pg;K.height=Math.max(K.height,Rj.height);jb=Zb.xd}-1!=K.type&&(3==K.type?(m=!0,d=Math.max(d,B.Ob)):
(1==K.type?k=!0:5==K.type&&(p=!0),c=Math.max(c,B.Ob)))}for(e=0;K=b[e];e++)if(K.Tk=!1,-1==K.type)for(h=0;B=K[h];h++)if(1==B.type){K.height+=20;K.Tk=!0;break}b.yg=20+d;m&&(b.ta=Math.max(b.ta,b.yg+30));k?b.ta=Math.max(b.ta,c+20+8):p&&(b.ta=Math.max(b.ta,c+20));b.Vr=k;b.zu=m;b.yu=p;d=a;this.G?this.ni=this.xg=!0:(this.ni=this.xg=!1,this.K&&(a=I(this.K))&&Ng(a)==this&&(this.xg=!0),Ng(this)&&(this.ni=!0));k=this.ga();m=[];p=[];a=[];c=[];B=b.ta;this.xg?(m.push("m 0,0"),a.push("m 1,1")):(m.push("m 0,2"),a.push(q?
...
a.push("v",y)):(a.push("M",b.ta-4.2+","+(B+20-.4)),a.push("l","3.04,-1.8")),E=k.x+(q?-b.ta-1:b.ta+1),jb=k.y+B,h.s.moveTo(E,jb),h.s.w&&(ji(h.s),this.width=Math.max(this.width,b.ta+Vh(I(h.s)).width-8+1))):5==e.type?(h=e[0],E=B+18,-1!=h.align&&(y=b.ta-h.Ob-20,b.Vr&&(y-=8),1==h.align?x+=y:0==h.align&&(x+=(y+x)/2)),wk(h.Pa,x,E),m.push("v",e.height),q&&a.push("v",e.height-2)):3==e.type&&(h=e[0],0==K&&(m.push("v",10),q&&a.push("v",9),B+=10),E=B+18,-1!=h.align&&(y=b.yg-h.Ob-20,1==h.align?x+=y:0==h.align&&
...
Ek.prototype.qd=function(a,b){if(a){var c=Vc(this.U()+"-body",a)[0];if(c){var d=0;tb(c.rows,function(a){tb(a.cells,function(a){Yb(a);if(b){var c=b[d++];c&&a.appendChild(c)}})});if(d<b.length){for(var e=[],h=Sc(a),k=c.rows[0].cells.length;d<b.length;){var m=b[d++];e.push(Hk(this,m,h));e.length==k&&(m=Ik(this,e,h),c.appendChild(m),e.length=0)}if(0<e.length){for(;e.length<k;)e.push(Hk(this,"",h));m=Ik(this,e,h);c.appendChild(m)}}}zd(a,!0,Eb)}};
function Jk(a,b,c){for(b=b.n();c&&1==c.nodeType&&c!=b;){if("TD"==c.tagName&&Ce(c,a.U()+"-cell"))return c.firstChild;c=c.parentNode}return null}Ek.prototype.U=function(){return"goog-palette"};function Kk(a,b,c){ff.call(this,a,b||Ek.Yb(),c);this.Zg&=-89;this.se=new Lk;this.se.ug(this);this.Jh=-1}n(Kk,ff);f=Kk.prototype;f.Aa=null;f.M=-1;f.Ra=null;f.Z=function(){Kk.k.Z.call(this);this.Ra&&(this.Ra.m(),this.Ra=null);this.Aa=null;this.se.m()};f.tg=function(a){Kk.k.tg.call(this,a);Mk(this);this.Ra?(this.Ra.clear(),Bk(this.Ra,a)):(this.Ra=new Ak(a),a=oa(this.Re,this),this.Ra.ei=a,te(this).N(this.Ra,"select",this.Sr));this.M=-1};f.Bf=function(){return""};
...
d&&(d=-c),d<b-c)return this.Sa(d+c),a.preventDefault(),!0}return!1};f.Sr=function(){};f.Od=function(){return this.Aa};f.vg=function(a,b){if(this.n())throw Error("Component already rendered");this.Aa=ga(a)?new Sb(a,b):a;Mk(this)};function Nk(a){var b=a.Xa;return b&&b[a.M]}f.Sa=function(a){a!=this.M&&(Ok(this,this.M,!1),this.Jh=this.M,this.M=a,Ok(this,a,!0),this.dispatchEvent("a"))};f.De=function(){return this.Ra?this.Ra.De():-1};f.bd=function(){return this.Ra?this.Ra.bd():null};
...
7;Uk.prototype.wg=function(){Rf(this,Yk);var a=new Sk;a.vg(this.mr||Xk);a.sg(this.lr||Wk);var b=Yc(),c=od(),d=Tf(this.Cb),e=this.Cb.getBBox();a.F(Uf);a.ji(this.Fa());var h=td(a.n());d.y=d.y+h.height+e.height>=b.height+c.y?d.y-(h.height-1):d.y+(e.height-1);q?(d.x+=e.width,d.x-=h.width,d.x<c.x&&(d.x=c.x)):d.x>b.width+c.x-h.width&&(d.x=b.width+c.x-h.width);Vf(d.x,d.y,b,c);var k=this;Vk=$d(a,"change",function(a){a=a.target.uh()||"#000000";Zk();if(k.h&&k.fa){var b=k.fa(a);void 0!==b&&(a=b)}null!==a&&k.ja(a)})};
...
function bl(a){return function(){var b=al,c=b.value;a.h&&a.fa&&(c=a.fa(c),null===c&&(c=b.defaultValue));a.ia(c);a.h.B&&a.h.F();w(b.us);w(b.ts);w(b.As);al=null;Uf.style.width="auto"}}function dl(a){if(null===a)return null;a=a.replace(/O/ig,"0");a=a.replace(/,/g,"");a=parseFloat(a||0);return isNaN(a)?null:String(a)}function el(a){(a=dl(a))&&(a=String(Math.max(0,Math.floor(a))));return a};/*
...
new uh(A),A.Hc.resize());Fh();if(Da){Dl([qh+"click.mp3",qh+"click.wav",qh+"click.ogg"],"click");Dl([qh+"delete.mp3",qh+"delete.ogg",qh+"delete.wav"],"delete");var b=[],a=function(){for(;b.length;)w(b.pop());for(var a in El){var d=El[a];d.volume=.01;d.play();d.pause();if(Lb||Kb)break}};b.push(v(document,"mousemove",null,a));b.push(v(document,"touchstart",null,a))}};/*
 ...
 limitations under the License.
*/
var Uf=null,Ji=null,Fl=null;function Rf(a,b){Zk();Ji=a;Fl=b;Uf.style.display="block"}function Zk(){Ji&&(Uf.style.display="none",Fl&&Fl(),Fl=Ji=null,Yb(Uf))}function Sf(a){Ji==a&&Zk()}function Vf(a,b,c,d){b<d.y&&(b=d.y);q?a>c.width+d.x&&(a=c.width+d.x):a<d.x&&(a=d.x);Uf.style.left=a+"px";Uf.style.top=b+"px"};/*
 ...
 limitations under the License.
*/
function Gl(a,b,c,d){this.h=null;this.Ga=Number(c);this.R=Number(b);this.Aa={height:this.Ga+10,width:this.R};this.Ka=d||"";this.la=u("g",{},null);this.Qf=u("image",{height:this.Ga+"px",width:this.R+"px",y:-12},this.la);this.ja(a);Eb&&(this.jg=u("rect",{height:this.Ga+"px",width:this.R+"px",y:-12,"fill-opacity":0},this.la))}n(Gl,Tb);f=Gl.prototype;f.clone=function(){return new Gl(this.xu(),this.R,this.Ga,this.fb())};f.jg=null;f.xd=!1;
f.g=function(a){this.h||(this.h=a,a.W().appendChild(this.la),a=this.jg||this.Qf,a.kb=this.h,Ei(a))};f.m=function(){Vb(this.la);this.jg=this.Qf=this.la=null};f.i=function(a){(this.jg||this.Qf).kb=a};f.Fa=function(){return this.Qs};f.ja=function(a){null!==a&&(this.Qs=a,this.Qf.setAttributeNS("http://www.w3.org/1999/xlink","xlink:href",l(a)?a:""))};f.ia=function(a){null!==a&&(this.Ka=a)};f.$d=function(){};/*
...
function Ll(a,b,c,d){function e(c){gapi.sc.Da.files.Sf({resource:{mimeType:b,title:a,parents:[{id:c}]}}).Yc(d)}function h(){function a(b){gapi.sc.Da.Hs.Sf({fileId:"appdata",resource:{key:"folderId",value:b}}).Yc(function(){e(b)})}function b(){gapi.sc.Da.files.Sf({resource:{mimeType:"application/vnd.google-apps.folder",title:c}}).Yc(function(b){a(b.id)})}gapi.sc.Da.Hs.get({fileId:"appdata",propertyKey:"folderId"}).Yc(function(d){if(d.error)c?b():a("root");else{var h=d.result.value;gapi.sc.Da.files.get({fileId:h}).Yc(function(a){a.error||
a.labels.Ru?b():e(h)})}})}gapi.sc.load("drive","v2",function(){h()})}function Ml(a){this.sk=Jl(a,"onFileLoaded");this.ps=Jl(a,"newFileMimeType","application/vnd.google-apps.drive-sdk");this.fk=Jl(a,"initializeModel");this.Dk=Jl(a,"registerTypes",function(){});this.gj=Jl(a,"afterAuth",function(){});this.fr=Jl(a,"autoCreate",!1);this.xr=Jl(a,"defaultTitle","New Realtime File");this.wr=Jl(a,"defaultFolderTitle","");this.hj=Jl(a,"afterCreate",function(){});this.Xg=new Kl(a)}
...
Ml.prototype.ck=function(a){a.type!=gapi.Da.dc.Ei.iu&&(a.type==gapi.Da.dc.Ei.dt?(alert("An Error happened: "+a.message),window.location.href="/"):a.type==gapi.Da.dc.Ei.Mt&&(alert("The file was not found. It does not exist or you do not have read access to the file."),window.location.href="/"))};
Ml.prototype.load=function(){var a=Il.fileIds;a&&(a=a.split(","));var b=this.Xg.zi,b=Il.state;if(a)for(var c in a)gapi.Da.dc.load(a[c],this.sk,this.fk,this.ck);else{if(b){var d;try{d=JSON.parse(b)}catch(e){d=null}if("open"==d.action){a=d.Au;b=d.zi;Nl(this,a,b);return}}this.fr&&Ol(this)}};function Ol(a){Ll(a.xr,a.ps,a.wr,function(b){b.id?(a.hj&&a.hj(b.id),Nl(a,[b.id],a.Xg.zi)):(console.error("Error creating file."),console.error(b))})};/*
 ...
 limitations under the License.
*/
var Hh,Pl,Gh=!1,Ql=null,Si=null,Rl=null,Sl=null,Ui=null,Wi=!1,Tl=null,Ul=null,Vl=null;function Wl(a){var b=a.Cr;a=a.Cr.length;for(var c=0;c<a;c++){var d=b[c];if(!d.cs){var e=d.target;"value_changed"==d.type&&("xmlDom"==d.yk?Xl(function(){Yl(e,!1);Zl(e)}):"relativeX"!=d.yk&&"relativeY"!=d.yk||Xl(function(){e.Sk||Yl(e,!1);Zl(e)}))}}}function $l(a){if(!a.cs){var b=a.newValue;b?Yl(b,!a.oldValue):(b=a.oldValue,am(b))}}function Xl(a){if(Wi)a();else try{Wi=!0,a()}finally{Wi=!1}}
...
function bm(a,b){gapi.sc.Da.xk.list({fileId:a}).Yc(function(a){for(var d=0;d<a.items.length;d++){var e=a.items[d];if("owner"==e.Ju){b(e.domain);break}}})}
var fm={clientId:null,authButtonElementId:"authorizeButton",authDivElementId:"authButtonDiv",initializeModel:function(a){Si=a;var b=a.qu();a.Nd().set("blocks",b);b=a.pu();a.Nd().set("topBlocks",b);Ul&&a.Nd().set(Ul,a.ru(Vl))},autoCreate:!0,defaultTitle:"Realtime Blockly File",defaultFolderTitle:"Realtime Blockly Folder",newFileMimeType:null,onFileLoaded:function(a){Ql=a;a:{for(var b=a.Hr(),c=0;c<b.length;c++){var d=b[c];if(d.ds){Rl=d.Lu;break a}}Rl=void 0}Si=a.$f;Ui=Si.Nd().get("blocks");Hh=Si.Nd().get("topBlocks");
Si.Nd().addEventListener(gapi.Da.dc.Jg.Nt,Wl);Ui.addEventListener(gapi.Da.dc.Jg.ju,$l);Sl();a.addEventListener(gapi.Da.dc.Jg.et,cm);a.addEventListener(gapi.Da.dc.Jg.ft,dm);em();a=Hh;for(b=0;b<a.length;b++)c=a.get(b),Yl(c,!0)},registerTypes:function(){var a=gapi.Da.dc.su;a.Hu(qi,"Block");qi.prototype.id=a.ah("id");qi.prototype.Ai=a.ah("xmlDom");qi.prototype.kg=a.ah("relativeX");qi.prototype.lg=a.ah("relativeY");a.Mu(qi,qi.prototype.initialize)},afterAuth:function(){setTimeout(function(){},18E5)},afterCreate:function(a){var b=
...
function vl(a,b){gm();Gh=!0;hm(b);Sl=function(){a();if(Ul){var b=Si.Nd().get(Ul),d=document.getElementById(Ul);gapi.Da.dc.tu.nu(b,d);d.disabled=!1}};Tl=new Ml(fm);Tl.start()}
function hm(a){a.style.background="url("+qh+"progress.gif) no-repeat center center";var b=wd(a),c=D("div");c.id=fm.authDivElementId;var d=D("p",null,G.bl);c.appendChild(d);d=D("button",null,"Authorize");d.id=fm.lu;c.appendChild(d);a.appendChild(c);c.style.display="none";c.style.position="relative";c.style.textAlign="center";c.style.border="1px solid";c.style.backgroundColor="#f6f9ff";c.style.borderRadius="15px";c.style.boxShadow="10px 10px 5px #888";c.style.width=b.width/3+"px";a=wd(c);c.style.left=
(b.width-a.width)/3+"px";c.style.top=(b.height-a.height)/4+"px"}function em(){if(Pl){var a;a=Pl;a=l(a)?document.getElementById(a):a;Yb(a);for(var b=Ql.Hr(),c=0;c<b.length;c++){var d=b[c],e=D("img",{src:d.Gu||qh+"anon.jpeg",alt:d.displayName,title:d.displayName+(d.ds?" ("+G.jp+")":"")});e.style.backgroundColor=d.color;a.appendChild(e)}}}function cm(){em()}function dm(){em()}function pi(a){var b=Rl+"-"+a;return Ui.has(b)?pi("-"+a):b};/*
...
function zl(a){kk();mj();hg();var b=a.target&&a.target.nodeName&&"svg"==a.target.nodeName.toLowerCase();!z&&Kh&&b&&Lh();a.target==ta&&$b(a)?km(a):(z||b)&&A.Hc&&(A.nh=!0,A.qi=a.clientX,A.ri=a.clientY,A.Ss=A.wc(),A.Us=A.scrollX,A.Vs=A.scrollY,"mouseup"in xk&&(jm=v(document,"mouseup",null,Cl)),Fa=v(document,"mousemove",null,lm))}function Cl(){jh(ok.OPEN);A.nh=!1;jm&&(w(jm),jm=null);Fa&&(w(Fa),Fa=null)}
function lm(a){if(A.nh){Ch();var b=A.Ss,c=A.Us+(a.clientX-A.qi),d=A.Vs+(a.clientY-A.ri),c=Math.min(c,-b.ic),d=Math.min(d,-b.Nb),c=Math.max(c,b.wa-b.ic-b.Fd),d=Math.max(d,b.Ua-b.Nb-b.tb);A.Hc.set(-c-b.ic,-d-b.Nb);a.stopPropagation()}}
...
G.xm="Add an item to the list.";G.ym="Create a list with any number of items.";G.Gi="first";G.Hi="# from end";G.Ii="#";G.zm="get";G.Am="get and remove";G.Ji="last";G.Ki="random";G.Dm="remove";G.Lg="";G.gt="Returns the first item in a list.";G.ht="Returns the item at the specified position in a list. #1 is the last item.";G.it="Returns the item at the specified position in a list. #1 is the first item.";G.jt="Returns the last item in a list.";G.kt="Returns a random item in a list.";G.lt="Removes and returns the first item in a list.";
G.mt="Removes and returns the item at the specified position in a list. #1 is the last item.";G.nt="Removes and returns the item at the specified position in a list. #1 is the first item.";G.ot="Removes and returns the last item in a list.";G.pt="Removes and returns a random item in a list.";G.qt="Removes the first item in a list.";G.rt="Removes the item at the specified position in a list. #1 is the last item.";G.st="Removes the item at the specified position in a list. #1 is the first item.";
G.tt="Removes the last item in a list.";G.ut="Removes a random item in a list.";G.vt="to # from end";G.wt="to #";G.xt="to last";G.Em="https://github.com/google/blockly/wiki/Lists#getting-a-sublist";G.yt="get sub-list from first";G.zt="get sub-list from # from end";G.At="get sub-list from #";G.Mg="";G.Gm="Creates a copy of the specified portion of a list.";G.Hm="find first occurrence of item";G.Li="https://github.com/google/blockly/wiki/Lists#getting-items-from-a-list";G.Jm="find last occurrence of item";
...
G.Tm="https://github.com/google/blockly/wiki/Lists#in-list--set";G.Vm="as";G.Wm="insert at";G.Xm="set";G.Ct="Inserts the item at the start of a list.";G.Dt="Inserts the item at the specified position in a list. #1 is the last item.";G.Et="Inserts the item at the specified position in a list. #1 is the first item.";G.Ft="Append the item to the end of a list.";G.Gt="Inserts the item randomly in a list.";G.Ht="Sets the first item in a list.";G.It="Sets the item at the specified position in a list. #1 is the last item.";
G.Jt="Sets the item at the specified position in a list. #1 is the first item.";G.Kt="Sets the last item in a list.";G.Lt="Sets a random item in a list.";G.Ym="Returns true if the list is empty.";G.Zm="false";G.$m="https://github.com/google/blockly/wiki/Logic#values";G.an="Returns either true or false.";G.bn="true";G.cn="https://en.wikipedia.org/wiki/Inequality_(mathematics)";G.dn="Return true if both inputs equal each other.";G.fn="Return true if the first input is greater than the second input.";
...
G.fq="in text";G.gq="get last letter";G.hq="get random letter";G.Xi="";G.iq="Returns the letter at the specified position.";G.kq="Add an item to the text.";G.lq="join";G.mq="Add, remove, or reorder sections to reconfigure this text block.";G.cu="to letter # from end";G.du="to letter #";G.eu="to last letter";G.nq="https://github.com/google/blockly/wiki/Text#extracting-a-region-of-text";G.oq="in text";G.fu="get substring from first letter";G.gu="get substring from letter # from end";G.hu="get substring from letter #";
...
d.style.opacity=0;c?(X.Yf(a,!1,.8),X.Yf(c,!0,.2),setTimeout(b,175)):b();a.style.visibility="hidden";a.style.zIndex=-1;for((c=document.getElementById("dialogHeader"))&&c.parentNode.removeChild(c);a.firstChild;)c=a.firstChild,c.className+=" dialogHiddenContent",document.body.appendChild(c)}},Yf:function(a,b,c){function d(){e.style.width=h.width+"px";e.style.height=h.height+"px";e.style.left=h.x+"px";e.style.top=h.y+"px";e.style.opacity=c}if(a){var e=document.getElementById("dialogBorder"),h=X.Gr(a);
b?(e.className="dialogAnimate",setTimeout(d,1)):(e.className="",d());e.style.visibility="visible"}},Gr:function(a){if(a.getBBox){var b=a.getBBox(),c=b.height,b=b.width;a=Tf(a);var d=a.x,e=a.y}else{c=a.offsetHeight;b=a.offsetWidth;e=d=0;do d+=a.offsetLeft,e+=a.offsetTop,a=a.offsetParent;while(a)}return{height:c,width:b,x:d,y:e}},Ws:function(a){var b=document.getElementById("containerStorage");b.textContent="";a=a.split("\n");for(var c=0;c<a.length;c++){var d=document.createElement("p");d.appendChild(document.createTextNode(a[c]));
b.appendChild(d)}b=document.getElementById("dialogStorage");a=document.getElementById("linkButton");X.Kc(b,a,!0,!0,{width:"50%",left:"25%",top:"5em"},X.si);X.pi()},fj:function(){if(!xm(H))if(X.Ac||0!=qi.vu)setTimeout(X.fj,15E3);else{var a=document.getElementById("dialogAbort"),b=document.getElementById("abortCancel");b.addEventListener("click",X.mb,!0);b.addEventListener("touchend",X.mb,!0);b=document.getElementById("abortOk");b.addEventListener("click",W.Fh,!0);b.addEventListener("touchend",W.Fh,
!0);X.Kc(a,null,!1,!0,{width:"40%",left:"30%"},function(){document.body.removeEventListener("keydown",X.ej,!0)});document.body.addEventListener("keydown",X.ej,!0)}},Cu:function(){var a=document.getElementById("dialogDone");A&&(document.getElementById("dialogLinesText").textContent="Play a challenge to unlock new features.");var b=document.getElementById("containerCode");a.removeChild(b);10>H?V("Games_nextLevel").replace("%1",H+1):V("Games_finalLevel");b=document.getElementById("doneCancel");b.addEventListener("click",
X.mb,!0);b.addEventListener("touchend",X.mb,!0);b=document.getElementById("doneOk");1==H&&(b.addEventListener("click",function(){window.open("/turtle","_self")},!0),b.addEventListener("touchend",function(){window.open("/turtle","_self")},!0));2==H&&(b.addEventListener("click",function(){window.open("/turtle?lang=en?level=2","_self")},!0),b.addEventListener("touchend",function(){window.open("/turtle?lang=en?level=2","_self")},!0));3==H&&(b.addEventListener("click",function(){window.open("/bird?lang=en?level=3",
"_self")},!0),b.addEventListener("touchend",function(){window.open("/bird?lang=en?level=3","_self")},!0));4==H&&(b.addEventListener("click",function(){window.open("/maze?lang=en?level=5","_self")},!0),b.addEventListener("touchend",function(){window.open("/maze?lang=en?level=5","_self")},!0));5==H&&(b.addEventListener("click",function(){window.open("/maze?lang=en?level=6","_self")},!0),b.addEventListener("touchend",function(){window.open("/maze?lang=en?level=6","_self")},!0));6==H&&(b.addEventListener("click",
function(){window.open("/maze?lang=en?level=10","_self")},!0),b.addEventListener("touchend",function(){window.open("/maze?lang=en?level=10","_self")},!0));X.Kc(a,null,!1,!0,{width:"40%",left:"30%"},function(){document.body.removeEventListener("keydown",X.Ed,!0)});document.body.addEventListener("keydown",X.Ed,!0)}};
window.Jd=function(a){if(/(iP)/g.test(navigator.userAgent))return alert("Your device does not support files downloading. Please try again in desktop browser."),!1;if(window.Jd.bs||window.Jd.es){var b=document.createElement("a");b.href=a;void 0!==b.Ar&&(b.Ar="CodeGirl");if(document.createEvent)return a=document.createEvent("MouseEvents"),a.initEvent("click",!0,!0),b.dispatchEvent(a),!0}-1===a.indexOf("?")&&(a+="?download");window.open(a,"_self");return!0};window.Jd.bs=-1<navigator.userAgent.toLowerCase().indexOf("chrome");
window.Jd.es=-1<navigator.userAgent.toLowerCase().indexOf("safari");
X.uu=function(){var a=document.getElementById("dialogDone");A&&(document.getElementById("dialogLinesText").textContent='You have finished creating your avatar! Click "OK" to save a picture of your avatar or "Cancel" continue dressing up your avatar.');var b=document.getElementById("containerCode");a.removeChild(b);b=document.getElementById("doneCancel");b.addEventListener("click",X.mb,!0);b.addEventListener("touchend",X.mb,!0);b=document.getElementById("doneOk");document.getElementById("doneOk").innerHTML=
"OK";b.addEventListener("click",function(){html2canvas([document.getElementById("visualization")],{Bs:function(a){a=a.toDataURL("image/png");window.Jd(a)}})},!0);b.addEventListener("touchend",function(){html2canvas([document.getElementById("visualization")],{Bs:function(a){a=a.toDataURL("image/png");window.Jd(a)}})},!0);X.Kc(a,null,!1,!0,{width:"40%",left:"30%"},function(){document.body.removeEventListener("keydown",X.Ed,!0)});document.body.addEventListener("keydown",X.Ed,!0)};
X.Du=function(){alert("login");document.getElementById("login")};
X.nr=function(){var a=document.getElementById("dialogDone");if(A){document.getElementById("dialogLinesText").textContent="";var b=10>H?V("Games_nextLevel").replace("%1",H+1):V("Games_finalLevel"),c=document.getElementById("containerCode");"puzzle"==zm?(c.innerHTML="<p>Grace is a superhero. <br/>Dress her up for her first mission.</p>",c=document.getElementById("Games_nextLevel"),c.parentElement.removeChild(c)):"turtle"==zm&&1==H?c.innerHTML="<p>New features unlocked!</p><img class='featureUnlocked' src='./movie/shorts.svg' width='80px' border=0 /><img class='featureUnlocked' src='./movie/skirt.svg' width='80px' border=0/><img class='featureUnlocked' src='./movie/pants.svg' height='75px' border=0/><img class='featureUnlocked' src='./movie/long_skirt.svg' height='75px' border=0/>":
"turtle"==zm&&2==H?c.innerHTML="<p>New features unlocked!</p><img class='featureUnlocked' src='./movie/boots.svg' width='80px' border=0 /><img class='featureUnlocked' src='./movie/cowboyboot.svg' width='80px' border=0/><img class='featureUnlocked' src='./movie/shoe.svg' width='80px' border=0/><img class='featureUnlocked' src='./movie/hightop.svg' width='80px' border=0/>":"bird"==zm&&3==H?c.innerHTML="<p>New features unlocked!</p><img class='featureUnlocked' src='./movie/bow.svg' width='80px' border=0/><img class='featureUnlocked' src='./movie/baseball.svg' width='80px' border=0/><img class='featureUnlocked' src='./movie/retro_glasses.svg' width='80px' border=0/><img class='featureUnlocked' src='./movie/necklace.svg' width='80px' border=0/>":
"maze"==zm&&5==H?c.innerHTML="<p>New features unlocked!</p><img class='featureUnlocked' src='./movie/briefcase.svg' width='80px' border=0 /><img class='featureUnlocked' src='./movie/purse.svg' width='80px' border=0/><img class='featureUnlocked' src='./movie/backpack.svg' width='80px' border=0/><img class='featureUnlocked' src='./movie/fancy_purse.svg' width='80px' border=0/>":"maze"==zm&&6==H?c.innerHTML="<p>New features unlocked!</p><img class='featureUnlocked' src='./movie/dress.svg' width='80px' height='71px' border=0 /><img class='featureUnlocked' src='./movie/crown.svg' width='80px' border=0/><img class='featureUnlocked' src='./movie/wand.svg' width='80px' border=0/>":
"maze"==zm&&10==H&&(c.innerHTML="<p>New features unlocked!</p><img class='featureUnlocked' src='./movie/cape.svg' width='80px' height='71px' border=0 /><img class='featureUnlocked' src='./movie/shield.svg' width='80px' border=0/><img class='featureUnlocked' src='./movie/mask.svg' width='80px' border=0/><img class='featureUnlocked' src='./movie/mask2.svg' width='80px' border=0/><img class='featureUnlocked' src='./movie/gloves.svg' width='80px' border=0/><img class='featureUnlocked' src='./movie/logo.svg' width='80px' border=0/><img class='featureUnlocked' src='./movie/belt.svg' width='80px' border=0/><img class='featureUnlocked' src='./movie/word.svg' width='80px' border=0/>")}c=
document.getElementById("doneCancel");c.addEventListener("click",X.mb,!0);c.addEventListener("touchend",X.mb,!0);c=document.getElementById("doneOk");c.addEventListener("click",W.Oh,!0);c.addEventListener("touchend",W.Oh,!0);X.Kc(a,null,!1,!0,{width:"40%",left:"30%"},function(){document.body.removeEventListener("keydown",X.Ed,!0)});document.body.addEventListener("keydown",X.Ed,!0);a=document.getElementById("dialogDoneText");a.innerHTML=b;"turtle"==zm&&1==H&&(a.innerHTML+="<p><em>You can use loops to repeat actions. Next time, try using a loop to help the robot draw a square with fewer blocks! </em></p>")};
X.Pj=function(a){!X.Ac||13!=a.keyCode&&27!=a.keyCode&&32!=a.keyCode||(X.mb(!0),a.stopPropagation(),a.preventDefault())};X.pi=function(){document.body.addEventListener("keydown",X.Pj,!0)};X.si=function(){document.body.removeEventListener("keydown",X.Pj,!0)};X.Ed=function(a){if(13==a.keyCode||27==a.keyCode||32==a.keyCode)X.mb(!0),a.stopPropagation(),a.preventDefault(),27!=a.keyCode&&W.Oh()};
X.ej=function(a){if(13==a.keyCode||27==a.keyCode||32==a.keyCode)X.mb(!0),a.stopPropagation(),a.preventDefault(),27!=a.keyCode&&W.Fh()};window.BlocklyDialogs=X;X.hideDialog=X.mb;var Bm={},Cm,Dm,Em,Y,Fm,Gm,Hm,Im;
...
U.ci=function(a,b){var c="";if(!a.G||!a.G.w){var d=a.Df();d&&(c+=gl(d,"// ")+"\n");for(var e=0;e<a.T.length;e++)if(1==a.T[e].type){var h=I(a.T[e].s);if(h){for(var d=[],h=h.Eb(),k=0;k<h.length;k++){var m=h[k].Df();m&&d.push(m)}d.length&&d.push("");(d=d.join("\n"))&&(c+=gl(d,"// "))}}}e=hl(U,a.C&&I(a.C));return c+b+e};/*
 ...
 limitations under the License.
*/
U.hs={};U.lists_create_empty=function(){return["[]",U.Sb]};U.lists_create_with=function(a){for(var b=Array(a.ha),c=0;c<a.ha;c++)b[c]=T(a,"ADD"+c,U.pa)||"null";b="["+b.join(", ")+"]";return[b,U.Sb]};U.lists_repeat=function(a){var b=ll("lists_repeat",["function "+U.Ca+"(value, n) {","  var array = [];","  for (var i = 0; i < n; i++) {","    array[i] = value;","  }","  return array;","}"]),c=T(a,"ITEM",U.pa)||"null";a=T(a,"NUM",U.pa)||"0";return[b+"("+c+", "+a+")",U.P]};
...
"      throw 'Unhandled option (lists_getSublist).';","    }","    return at;","  }","  at1 = getAt(where1, at1);","  at2 = getAt(where2, at2) + 1;","  return list.slice(at1, at2);","}"])+"("+b+", '"+c+"', "+e+", '"+d+"', "+a+")",U.P]};/*
 ...
 limitations under the License.
*/
U.bt={};U.variables_get=function(a){return[U.da.getName(P(a,"VAR"),"VARIABLE"),U.Sb]};U.variables_set=function(a){var b=T(a,"VALUE",U.Qc)||"0";return U.da.getName(P(a,"VAR"),"VARIABLE")+" = "+b+";\n"};/*
...
C.colour_blend={g:function(){this.p=G.il;this.j(20);O(O(Ri(Q(this,"COLOUR1").v("Colour"),1),G.kl),G.gl);O(Ri(Q(this,"COLOUR2").v("Colour"),1),G.hl);O(Ri(Q(this,"RATIO").v("Number"),1),G.jl);L(this,!0,"Colour");this.i(G.ll)}};/*
 ...
 limitations under the License.
*/
C.ls={};C.controls_repeat={g:function(){this.p=G.Hg;this.j(120);O(O(O(R(this),G.Ci),new $k("10",el),"TIMES"),G.Di);O(aj(this,3,"DO"),G.Oc);M(this,!0);N(this,!0);this.i(G.Ig)}};C.controls_repeat_ext={g:function(){this.p=G.Hg;this.j(120);this.sa(G.Yl,["TIMES","Number",1],1);O(aj(this,3,"DO"),G.Oc);M(this,!0);N(this,!0);Tg(this,!0);this.i(G.Ig)}};
...
C.controls_flow_statements={g:function(){var a=[[G.yl,"BREAK"],[G.zl,"CONTINUE"]];this.p=G.xl;this.j(120);O(R(this),new F(a),"FLOW");M(this,!0);var b=this;this.i(function(){var a=P(b,"FLOW");return{BREAK:G.Al,CONTINUE:G.Bl}[a]})},onchange:function(){if(this.t){var a=!1,b=this;do{if("controls_repeat"==b.type||"controls_repeat_ext"==b.type||"controls_forEach"==b.type||"controls_for"==b.type||"controls_whileUntil"==b.type){a=!0;break}b=Xi(b)}while(b);a?this.sd(null):this.sd(G.Cl)}}};/*
 ...
 limitations under the License.
*/
U.ms={};U.math_number=function(a){return[parseFloat(P(a,"NUM")),U.Sb]};U.math_arithmetic=function(a){var b={ADD:[" + ",U.Ng],MINUS:[" - ",U.pp],MULTIPLY:[" * ",U.np],DIVIDE:[" / ",U.kf],POWER:[null,U.pa]}[P(a,"OP")],c=b[0],b=b[1],d=T(a,"A",b)||"0";a=T(a,"B",b)||"0";return c?[d+c+a,b]:["Math.pow("+d+", "+a+")",U.P]};
...
C.procedures_mutatorarg={g:function(){this.j(290);O(O(R(this),G.Gp),new $k("x",this.at),"NAME");M(this,!0);N(this,!0);this.i(G.Hp);this.contextMenu=!1},at:function(a){return(a=a.replace(/[\s\xa0]+/g," ").replace(/^ | $/g,""))||null}};
...
U.logic_ternary=function(a){var b=T(a,"IF",U.jf)||"false",c=T(a,"THEN",U.jf)||"null";a=T(a,"ELSE",U.jf)||"null";return[b+" ? "+c+" : "+a,U.jf]};/*
 ...
 limitations under the License.
*/
U.Gs={};U.procedures_defreturn=function(a){var b=U.da.getName(P(a,"NAME"),"PROCEDURE"),c=il(a,"STACK");U.zd&&(c=gl(U.zd.replace(/%1/g,"'"+a.id+"'"),U.ie)+c);U.ff&&(c=U.ff.replace(/%1/g,"'"+a.id+"'")+c);var d=T(a,"RETURN",U.S)||"";d&&(d="  return "+d+";\n");for(var e=[],h=0;h<a.A.length;h++)e[h]=U.da.getName(a.A[h],"VARIABLE");c="function "+b+"("+e.join(", ")+") {\n"+c+d+"}";c=U.ci(a,c);U.Hd[b]=c;return null};U.procedures_defnoreturn=U.procedures_defreturn;
...
C.logic_boolean={g:function(){var a=[[G.bn,"TRUE"],[G.Zm,"FALSE"]];this.p=G.$m;this.j(210);L(this,!0,"Boolean");O(R(this),new F(a),"BOOL");this.i(G.an)}};C.logic_null={g:function(){this.p=G.pn;this.j(210);L(this,!0);O(R(this),G.on);this.i(G.qn)}};C.logic_ternary={g:function(){this.p=G.xn;this.j(210);O(Q(this,"IF").v("Boolean"),G.wn);O(Q(this,"THEN"),G.zn);O(Q(this,"ELSE"),G.yn);L(this,!0);this.i(G.An)}};/*
 ...
 limitations under the License.
*/
C.hs={};C.lists_create_empty={g:function(){this.p=G.rm;this.j(260);L(this,!0,"Array");O(R(this),G.Fi);this.i(G.sm)}};
