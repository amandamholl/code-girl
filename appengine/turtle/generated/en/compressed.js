...
function Ub(a){if(a.Ja){var b=a.Ka;Zb(a.Ja);b=b.replace(/\s/g,"\u00a0");q&&b&&(b+="\u200f");b||(b="\u00a0");a.Ja.appendChild(document.createTextNode(b));a.Aa.width=0}}f.Fa=function(){return this.fb()};f.ja=function(a){this.ia(a)};f.Qh=function(a){if(!Kb&&!Lb||0===a.layerX||0===a.layerY)$b(a)||2!=ac&&this.h.uc&&!z&&this.vg()};f.i=function(){};/*
...
f.g=function(a,b){this.cb=a;var c=this.type=a.type;this.target=a.target||a.srcElement;this.currentTarget=b;var d=a.relatedTarget;if(d){if(Eb){var e;a:{try{Sd(d.nodeName);e=!0;break a}catch(h){}e=!1}e||(d=null)}}else"mouseover"==c?d=a.fromElement:"mouseout"==c&&(d=a.toElement);this.relatedTarget=d;Object.defineProperties?Object.defineProperties(this,{offsetX:{configurable:!0,enumerable:!0,get:this.Zj,set:this.Hs},offsetY:{configurable:!0,enumerable:!0,get:this.$j,set:this.Is}}):(this.offsetX=this.Zj(),
...
f.Z=function(){this.Q&&this.Db();this.xc&&(this.xc.m(),delete this.xc);ue(this,function(a){a.m()});!this.Ws&&this.D&&Vb(this.D);this.ab=this.Zf=this.D=this.rc=this.qa=null;oe.k.Z.call(this)};f.ne=function(a,b){this.Bd(a,ve(this),b)};
...
function Te(a,b,c){Oe||(Oe={1:"disabled",8:"selected",16:"checked",64:"expanded"});b=Oe[b];var d=a.getAttribute("role")||null;d&&(d=Pe[d]||b,b="checked"==b||"selected"==b?d:b);b&&Ke(a,b,c)}f.qd=function(a,b){var c=this.xb(a);if(c&&(Zb(c),b))if(l(b))dd(c,b);else{var d=function(a){if(a){var b=Uc(c);c.appendChild(l(a)?b.createTextNode(a):a)}};ea(b)?tb(b,d):!fa(b)||"nodeType"in b?d(b):tb(zb(b),d)}};f.Ea=function(a){return a.n()};f.U=function(){return"goog-control"};
...
f.Lr=function(a){t&&(17==this.yb&&!a.ctrlKey||18==this.yb&&!a.altKey||Gb&&91==this.yb&&!a.metaKey)&&(this.Bc=this.yb=-1);-1==this.yb&&(a.ctrlKey&&17!=a.keyCode?this.yb=17:a.altKey&&18!=a.keyCode?this.yb=18:a.metaKey&&91!=a.keyCode&&(this.yb=91));bf&&!Ue(a.keyCode,this.yb,a.shiftKey,a.ctrlKey,a.altKey)?this.handleEvent(a):(this.Bc=We(a.keyCode),cf&&(this.Sg=a.altKey))};f.Mr=function(a){this.Bc=this.yb=-1;this.Sg=a.altKey};
...
f.n=function(){return this.D};function Ze(a,b,c){a.Uf&&a.detach();a.D=b;a.Tf=Zd(a.D,"keypress",a,c);a.Fh=Zd(a.D,"keydown",a.Lr,c,a);a.Uf=Zd(a.D,"keyup",a.Mr,c,a)}f.detach=function(){this.Tf&&(fe(this.Tf),fe(this.Fh),fe(this.Uf),this.Uf=this.Fh=this.Tf=null);this.D=null;this.Bc=this.yb=-1};f.Z=function(){Ye.k.Z.call(this);this.detach()};function df(a,b,c,d){Td.call(this,d);this.type="key";this.keyCode=a;this.charCode=b;this.repeat=c}n(df,Td);function ef(a,b,c){oe.call(this,c);if(!b){b=this.constructor;for(var d;b;){d=ja(b);if(d=He[d])break;b=b.k?b.k.constructor:null}b=d?ha(d.Yb)?d.Yb():new d:null}this.L=b;this.sg(void 0!==a?a:null)}n(ef,oe);f=ef.prototype;f.Xa=null;f.$=0;f.ua=39;f.Yg=255;f.ud=0;f.oa=!0;f.Xb=null;f.Ge=!0;f.Rg=!1;f.xs=null;f.Ea=function(){return this.L.Ea(this)};f.Ff=function(){return this.$a||(this.$a=new Ye)};
f.te=function(a,b){b?a&&(this.Xb?xb(this.Xb,a)||this.Xb.push(a):this.Xb=[a],this.L.te(this,a,!0)):a&&this.Xb&&yb(this.Xb,a)&&(0==this.Xb.length&&(this.Xb=null),this.L.te(this,a,!1))};f.H=function(){var a=this.L.H(this);this.D=a;Re(this.L,a,this.Hf());this.Rg||this.L.ei(a,!1);this.J()||this.L.O(a,!1)};f.Hf=function(){return this.xs};f.xb=function(){return this.L.xb(this.n())};
...
f.Kr=function(a){var b=ze(this,a.target);if(-1<b&&b!=this.M){var c=we(this,this.M);c&&c.ob(!1);this.M=b;c=we(this,this.M);this.Vd&&c.setActive(!0);this.vs&&this.za&&c!=this.za&&(c.ua&64?jf(c,!0):jf(this.za,!1))}b=this.n();null!=a.target.n()&&Ke(b,"activedescendant",a.target.n().id)};f.Qr=function(a){a.target==we(this,this.M)&&(this.M=-1);a=this.n();Le(a)};f.Nr=function(a){(a=a.target)&&a!=this.za&&a.getParent()==this&&(this.za&&jf(this.za,!1),this.za=a)};
f.Hr=function(a){a.target==this.za&&(this.za=null)};f.yc=function(a){this.Xc&&(this.Vd=!0);var b=this.Ea();b&&gd(b)&&hd(b)?b.focus():a.preventDefault()};f.Ir=function(){this.Vd=!1};f.Gr=function(a){var b=Df(this,a.target);if(b)switch(a.type){case "mousedown":b.yc(a);break;case "mouseup":b.Ie(a);break;case "mouseover":b.He(a);break;case "mouseout":b.xh(a);break;case "contextmenu":b.Fe(a)}};
...
f.vh=function(a){this.Qg&&this.Ea().focus();return Lf.k.vh.call(this,a)};f.nj=function(a){return(this.br||a.isEnabled())&&a.J()&&!!(a.ua&2)};f.cd=function(a){var b=Lf.k.cd.call(this,a);b||ue(this,function(c){!b&&c.Er&&c.ok==a.keyCode&&(this.isEnabled()&&this.ob(c),b=c.Fb(a))},this);return b};
...
function Eg(a){var b={};b["padding-"+(xe(a)?"right":"left")]=Ag(a)+"px";var b={"class":a.Be(),style:b},c=a.rh(),d=Lc("span",{style:{display:"inline-block"},"class":a.zf()}),e=Lc("span",{"class":a.Na.Ij,title:a.Rs||null},a.Ah);a=Mc(e,Lc("span",{},a.$q));return Lc("div",b,[c,d,a])}f.Be=function(){return this.Na.gh+(this.Sf()?" "+this.Na.Kj:"")};f.rh=function(){return Lc("span",{type:"expand",style:{display:"inline-block"},"class":Fg(this)})};
function Fg(a){var b=a.gb(),c=!b.We||b==a.getParent()&&!b.ki,d=a.Na,e=new qg;e.append(d.Wc," ",d.mr," ");if(ye(a)){var h=0;b.ji&&a.Le&&(h=a.lb()?2:1);c||(h=a.Pb?h+8:h+4);switch(h){case 1:e.append(d.qr);break;case 2:e.append(d.pr);break;case 4:e.append(d.Dj);break;case 5:e.append(d.or);break;case 6:e.append(d.nr);break;case 8:e.append(d.Ej);break;case 9:e.append(d.sr);break;case 10:e.append(d.rr);break;default:e.append(d.Cj)}}else c?e.append(d.Cj):a.Pb?e.append(d.Ej):e.append(d.Dj);return e.toString()}
...
var tg={Dh:19,Jj:"goog-tree-root goog-tree-item",Gj:"goog-tree-hide-root",Hj:"goog-tree-item",yj:"goog-tree-children",zj:"goog-tree-children-nolines",gh:"goog-tree-row",Ij:"goog-tree-item-label",Wc:"goog-tree-icon",mr:"goog-tree-expand-icon",qr:"goog-tree-expand-icon-plus",pr:"goog-tree-expand-icon-minus",sr:"goog-tree-expand-icon-tplus",rr:"goog-tree-expand-icon-tminus",or:"goog-tree-expand-icon-lplus",nr:"goog-tree-expand-icon-lminus",Ej:"goog-tree-expand-icon-t",Dj:"goog-tree-expand-icon-l",Cj:"goog-tree-expand-icon-blank",
eh:"goog-tree-expanded-folder-icon",Aj:"goog-tree-collapsed-folder-icon",fh:"goog-tree-file-icon",Fj:"goog-tree-expanded-folder-icon",Bj:"goog-tree-collapsed-folder-icon",Kj:"selected"};function Jg(a,b,c){sg.call(this,a,b,c)}n(Jg,sg);Jg.prototype.gb=function(){if(this.wd)return this.wd;var a=this.getParent();return a&&(a=a.gb())?(xg(this,a),a):null};Jg.prototype.zf=function(){var a=this.lb(),b=this.zr;if(a&&b)return b;b=this.Sr;if(!a&&b)return b;b=this.Na;if(ye(this)){if(a&&b.eh)return b.Wc+" "+b.eh;if(!a&&b.Aj)return b.Wc+" "+b.Aj}else if(b.fh)return b.Wc+" "+b.fh;return""};/*
...
null;this.Mb.appendChild(a);return this.Mb};f.gr=function(a){gh(this);fh();$b(a)||hh(a)||(ih(jh),this.Tj=q?this.md+a.clientX:this.md-a.clientX,this.xr=this.Oe-a.clientY,dh=v(document,"mouseup",this,fh),eh=v(document,"mousemove",this,this.hr),gg(),a.stopPropagation())};f.hr=function(a){this.Xg=!1;this.md=q?this.Tj-a.clientX:this.Tj+a.clientX;this.Oe=this.xr+a.clientY;bh(this);ch(this)};
f.Es=function(a){gh(this);fh();$b(a)||(ih(jh),this.Ds=q?this.R+a.clientX:this.R-a.clientX,this.Cs=this.Ga-a.clientY,dh=v(document,"mouseup",this,fh),eh=v(document,"mousemove",this,this.Fs),gg(),a.stopPropagation())};f.Fs=function(a){this.Xg=!1;var b=this.Ds,c=this.Cs+a.clientY,b=q?b-a.clientX:b+a.clientX;this.Ic(b,c);q&&bh(this)};function gh(a){a.Mb.parentNode.appendChild(a.Mb)}function $g(a,b,c){a.Lb=b;a.Tg=c;a.$h&&bh(a)}
...
this.ma=a}};th.prototype.set=function(a,b){this.De.set(a);this.bf.set(b)};function uh(a,b,c){this.u=a;this.fg=c||!1;this.hb=b;this.bh();b?(this.Jb.setAttribute("height",kh),this.Ba.setAttribute("height",kh-6),this.Ba.setAttribute("y",3)):(this.Jb.setAttribute("width",kh),this.Ba.setAttribute("width",kh-6),this.Ba.setAttribute("x",3));this.tk=v(this.Jb,"mousedown",this,this.ps);this.uk=v(this.Ba,"mousedown",this,this.qs)}var wh,xh,kh=15;aa("document.documentElement.ontouchstart")&&(kh=25);f=uh.prototype;
...
f.ps=function(a){this.dg();if(!$b(a)){var b=Ah(a),b=this.hb?b.x:b.y,c=sh(this.Ba),c=this.hb?c.x:c.y,d=parseFloat(this.Ba.getAttribute(this.hb?"width":"height")),e=parseFloat(this.Ba.getAttribute(this.hb?"x":"y")),h=.95*d;b<=c?e-=h:b>=c+d&&(e+=h);this.Ba.setAttribute(this.hb?"x":"y",yh(this,e));zh(this)}a.stopPropagation()};
f.qs=function(a){this.dg();$b(a)||(this.Ks=parseFloat(this.Ba.getAttribute(this.hb?"x":"y")),this.Ms=this.hb?a.clientX:a.clientY,wh=v(document,"mouseup",this,this.dg),xh=v(document,"mousemove",this,this.ss));a.stopPropagation()};f.ss=function(a){this.Ba.setAttribute(this.hb?"x":"y",yh(this,this.Ks+((this.hb?a.clientX:a.clientY)-this.Ms)));zh(this)};f.dg=function(){Bh();gg(!0);wh&&(w(wh),wh=null);xh&&(w(xh),xh=null)};
...
f.m=function(){this.B=!1;Ch.k.m.call(this);this.o&&(Vb(this.o),this.o=null);this.ce=this.aa=null;this.V&&(this.V.m(),this.V=null);this.Ab&&(this.Ab.m(),this.Ab=null)};function Eh(){var a=B;if(sa&&!z){a.Ab=new mh(a);var b=a.Ab.H();a.o.insertBefore(b,a.aa);a.Ab.g()}}f.oe=function(a){Ch.k.oe.call(this,a);Fh&&this==B&&-1==Gh.indexOf(a)&&Gh.push(a)};f.ng=function(a){Ch.k.ng.call(this,a);Fh&&this==B&&Gh.Au(a)};f.clear=function(){gg();Ch.k.clear.call(this)};f.Jf=function(){return this.wc().wa};
...
function Wh(a,b){if(!b.$b)throw"Connection not in database.";b.$b=!1;for(var c=0,d=a.length-2,e=d;c<e;)a[e].ea<b.ea?c=e:d=e,e=Math.floor((c+d)/2);for(d=c=e;0<=c&&a[c].ea==b.ea;){if(a[c]==b){a.splice(c,1);return}c--}do{if(a[d]==b){a.splice(d,1);return}d++}while(d<a.length&&a[d].ea==b.ea);throw"Unable to find connection in connectionDB.";};/*
 ...
 limitations under the License.
*/
var C={Ts:0,Br:function(){var a=(++C.Ts).toString();return Fh?oi(a):a},du:function(a){var b={g:function(){var b=this;this.j(a.sj);this.p=a.p;"string"==typeof a.kb?this.i(a.kb):"function"==typeof a.kb&&this.i(function(){return a.kb(b)});"undefined"!=a.ws?K(this,!0,a.ws):(L(this,"undefined"==typeof a.ys?!0:a.ys),M(this,"undefined"==typeof a.ls?!0:a.ls));var d=[];d.push(a.text);a.cr&&a.cr.forEach(function(a){"undefined"==a.type||1==a.type?d.push([a.name,a.check,"undefined"==typeof a.align?1:a.align]):
qb("addTemplate() can only handle value inputs.")});d.push(1);a.Xr&&this.Fu(a.Xr);pi.prototype.sa.apply(this,d)}};b.Ia=a.Iu?function(){var b=a.hs?a.wu():document.createElement("mutation");b.setAttribute("is_statement",this.isStatement||!1);return b}:a.hs;C[a.hu]=b}};/*
...
f.ia=function(a){this.Ka!=a&&(this.Ka=a,this.J()&&(this.O(!1),this.O(!0)))};f.m=function(){this.I.gc=null;Nh.prototype.m.call(this)};/*
 ...
 limitations under the License.
*/
function pi(){}function hc(a,b){if(Fh)return Ri.create(pi,a,b);var c=a.B?new Si:new pi;c.initialize(a,b);return c}f=pi.prototype;f.initialize=function(a,b){this.id=C.Br();a.oe(this);this.fill(a,b)};
...
f.g=function(){this.Bg.cleardotPath=ph+"1x1.gif";this.Bg.cssCollapsedFolderIcon="blocklyTreeIconClosed"+(q?"Rtl":"Ltr");var a=new Yj(this,this.Bg);this.Ye=a;Vj(a);Sj(a);Uj(a);a.Ib(null);this.Pc.style.display="block";this.V.g(B);Zj(this);a.F(this.Pc);var b=this;Zd(window,"resize",function(){b.Ec()});this.Ec()};
...
f.Ae=function(){return new oc(q?Mi().width-this.width:-1E7,-1E7,1E7+this.width,2E7)};function Yj(a,b){this.Ta=a;Oj.call(this,Nc,b)}n(Yj,Oj);Yj.prototype.ya=function(){Yj.k.ya.call(this);if(Nd){var a=this.n();v(a,"touchstart",this,this.Pr)}};Yj.prototype.Pr=function(a){a.preventDefault();var b=Wj(this,a);b&&"touchstart"===a.type&&setTimeout(function(){b.Oh(a)},1)};Yj.prototype.createNode=function(a){return new ck(this.Ta,a?Gc(a):Nc,this.Na,this.eb())};
...
J=[],J.type=x&&3!=A.type?-1:A.type,J.height=0,b.push(J));J.push(A);A.nd=25;A.Qa=x&&1==A.type?20.5:0;if(A.s&&A.s.w){var jb=Uh(H(A.s));A.nd=Math.max(A.nd,jb.height);A.Qa=Math.max(A.Qa,jb.width)}E==h.length-1&&A.nd--;J.height=Math.max(J.height,A.nd);A.Ob=0;1==b.length&&(A.Ob+=q?-e:e);for(var jb=!1,Vg=0,Yb;Yb=A.Pa[Vg];Vg++){0!=Vg&&(A.Ob+=10);var Rj=Yb.Nd();Yb.Qa=Rj.width;Yb.og=jb&&Yb.xd?10:0;A.Ob+=Yb.Qa+Yb.og;J.height=Math.max(J.height,Rj.height);jb=Yb.xd}-1!=J.type&&(3==J.type?(m=!0,d=Math.max(d,A.Ob)):
(1==J.type?k=!0:5==J.type&&(p=!0),c=Math.max(c,A.Ob)))}for(e=0;J=b[e];e++)if(J.Sk=!1,-1==J.type)for(h=0;A=J[h];h++)if(1==A.type){J.height+=20;J.Sk=!0;break}b.xg=20+d;m&&(b.ta=Math.max(b.ta,b.xg+30));k?b.ta=Math.max(b.ta,c+20+8):p&&(b.ta=Math.max(b.ta,c+20));b.Rr=k;b.su=m;b.ru=p;d=a;this.G?this.mi=this.wg=!0:(this.mi=this.wg=!1,this.K&&(a=H(this.K))&&Mg(a)==this&&(this.wg=!0),Mg(this)&&(this.mi=!0));k=this.ga();m=[];p=[];a=[];c=[];A=b.ta;this.wg?(m.push("m 0,0"),a.push("m 1,1")):(m.push("m 0,2"),a.push(q?
...
a.push("v",y)):(a.push("M",b.ta-4.2+","+(A+20-.4)),a.push("l","3.04,-1.8")),E=k.x+(q?-b.ta-1:b.ta+1),jb=k.y+A,h.s.moveTo(E,jb),h.s.w&&(ii(h.s),this.width=Math.max(this.width,b.ta+Uh(H(h.s)).width-8+1))):5==e.type?(h=e[0],E=A+18,-1!=h.align&&(y=b.ta-h.Ob-20,b.Rr&&(y-=8),1==h.align?x+=y:0==h.align&&(x+=(y+x)/2)),vk(h.Pa,x,E),m.push("v",e.height),q&&a.push("v",e.height-2)):3==e.type&&(h=e[0],0==J&&(m.push("v",10),q&&a.push("v",9),A+=10),E=A+18,-1!=h.align&&(y=b.xg-h.Ob-20,1==h.align?x+=y:0==h.align&&
...
Dk.prototype.qd=function(a,b){if(a){var c=Vc(this.U()+"-body",a)[0];if(c){var d=0;tb(c.rows,function(a){tb(a.cells,function(a){Zb(a);if(b){var c=b[d++];c&&a.appendChild(c)}})});if(d<b.length){for(var e=[],h=Sc(a),k=c.rows[0].cells.length;d<b.length;){var m=b[d++];e.push(Gk(this,m,h));e.length==k&&(m=Hk(this,e,h),c.appendChild(m),e.length=0)}if(0<e.length){for(;e.length<k;)e.push(Gk(this,"",h));m=Hk(this,e,h);c.appendChild(m)}}}zd(a,!0,Eb)}};
function Ik(a,b,c){for(b=b.n();c&&1==c.nodeType&&c!=b;){if("TD"==c.tagName&&Be(c,a.U()+"-cell"))return c.firstChild;c=c.parentNode}return null}Dk.prototype.U=function(){return"goog-palette"};function Jk(a,b,c){ef.call(this,a,b||Dk.Yb(),c);this.Yg&=-89;this.re=new Kk;this.re.tg(this);this.Ih=-1}n(Jk,ef);f=Jk.prototype;f.Aa=null;f.M=-1;f.Ra=null;f.Z=function(){Jk.k.Z.call(this);this.Ra&&(this.Ra.m(),this.Ra=null);this.Aa=null;this.re.m()};f.sg=function(a){Jk.k.sg.call(this,a);Lk(this);this.Ra?(this.Ra.clear(),Ak(this.Ra,a)):(this.Ra=new zk(a),a=oa(this.Qe,this),this.Ra.di=a,se(this).N(this.Ra,"select",this.Or));this.M=-1};f.Af=function(){return""};
...
d&&(d=-c),d<b-c)return this.Sa(d+c),a.preventDefault(),!0}return!1};f.Or=function(){};f.Nd=function(){return this.Aa};f.ug=function(a,b){if(this.n())throw Error("Component already rendered");this.Aa=ga(a)?new Sb(a,b):a;Lk(this)};function Mk(a){var b=a.Xa;return b&&b[a.M]}f.Sa=function(a){a!=this.M&&(Nk(this,this.M,!1),this.Ih=this.M,this.M=a,Nk(this,a,!0),this.dispatchEvent("a"))};f.Ce=function(){return this.Ra?this.Ra.Ce():-1};f.bd=function(){return this.Ra?this.Ra.bd():null};
...
f.ii=function(a){a=Qk(a);this.ag||(this.ag=vb(this.sf,function(a){return Qk(a)}));this.Ve(a?sb(this.ag,a):-1)};function Pk(a){return vb(a.sf,function(a,c){var d=this.eb().H("div",{"class":this.L.U()+"-colorswatch",style:"background-color:"+a});d.title=this.Wf&&this.Wf[c]?this.Wf[c]:"#"==a.charAt(0)?"RGB ("+ng(a).join(", ")+")":a;return d},a)}function Qk(a){if(a)try{return ig(a).yh}catch(b){}return null};function Rk(a,b){oe.call(this,a);this.Y=b||null;se(this).N(this,"action",this.ms)}n(Rk,oe);f=Rk.prototype;f.Zc=!0;f.rg=function(a){this.Y?this.Y.rg(a):Sk(this,a)};f.ug=function(a){this.Y||Sk(this,[]);this.Y.ug(a)};f.Nd=function(){return this.Y?this.Y.Nd():null};f.Ce=function(){return this.Y?this.Y.Ce():-1};f.Ve=function(a){this.Y&&this.Y.Ve(a)};f.th=function(){return this.Y?this.Y.th():null};f.ii=function(a){this.Y&&this.Y.ii(a)};f.kc=function(){return this.Zc};
f.Jc=function(a){this.Zc=a;this.Y&&this.Y.jb(32,a)};f.ya=function(){Rk.k.ya.call(this);this.Y&&this.Y.F(this.n());this.n().unselectable="on"};f.Z=function(){Rk.k.Z.call(this);this.Y&&(this.Y.m(),this.Y=null)};f.focus=function(){this.Y&&this.Y.n().focus()};f.ms=function(a){a.stopPropagation();this.dispatchEvent("change")};function Sk(a,b){var c=new Ok(b,null,a.eb());c.ug(5);c.jb(32,a.Zc);a.ne(c);a.Y=c;a.Q&&a.Y.F(a.n())};/*
...
function al(a){return function(){var b=$k,c=b.value;a.h&&a.fa&&(c=a.fa(c),null===c&&(c=b.defaultValue));a.ia(c);a.h.B&&a.h.F();w(b.os);w(b.ns);w(b.us);$k=null;Tf.style.width="auto"}}function cl(a){if(null===a)return null;a=a.replace(/O/ig,"0");a=a.replace(/,/g,"");a=parseFloat(a||0);return isNaN(a)?null:String(a)}function dl(a){(a=cl(a))&&(a=String(Math.max(0,Math.floor(a))));return a};/*
...
new th(B),B.Hc.resize());Eh();if(Da){Cl([ph+"click.mp3",ph+"click.wav",ph+"click.ogg"],"click");Cl([ph+"delete.mp3",ph+"delete.ogg",ph+"delete.wav"],"delete");var b=[],a=function(){for(;b.length;)w(b.pop());for(var a in Dl){var d=Dl[a];d.volume=.01;d.play();d.pause();if(Lb||Kb)break}};b.push(v(document,"mousemove",null,a));b.push(v(document,"touchstart",null,a))}};/*
 ...
 limitations under the License.
*/
var Tf=null,Ii=null,El=null;function Qf(a,b){Yk();Ii=a;El=b;Tf.style.display="block"}function Yk(){Ii&&(Tf.style.display="none",El&&El(),El=Ii=null,Zb(Tf))}function Rf(a){Ii==a&&Yk()}function Uf(a,b,c,d){b<d.y&&(b=d.y);q?a>c.width+d.x&&(a=c.width+d.x):a<d.x&&(a=d.x);Tf.style.left=a+"px";Tf.style.top=b+"px"};/*
 ...
 limitations under the License.
*/
function Fl(a,b,c,d){this.h=null;this.Ga=Number(c);this.R=Number(b);this.Aa={height:this.Ga+10,width:this.R};this.Ka=d||"";this.la=u("g",{},null);this.Pf=u("image",{height:this.Ga+"px",width:this.R+"px",y:-12},this.la);this.ja(a);Eb&&(this.ig=u("rect",{height:this.Ga+"px",width:this.R+"px",y:-12,"fill-opacity":0},this.la))}n(Fl,Tb);f=Fl.prototype;f.clone=function(){return new Fl(this.qu(),this.R,this.Ga,this.fb())};f.ig=null;f.xd=!1;
f.g=function(a){this.h||(this.h=a,a.W().appendChild(this.la),a=this.ig||this.Pf,a.kb=this.h,Di(a))};f.m=function(){Vb(this.la);this.ig=this.Pf=this.la=null};f.i=function(a){(this.ig||this.Pf).kb=a};f.Fa=function(){return this.Js};f.ja=function(a){null!==a&&(this.Js=a,this.Pf.setAttributeNS("http://www.w3.org/1999/xlink","xlink:href",l(a)?a:""))};f.ia=function(a){null!==a&&(this.Ka=a)};f.Zd=function(){};/*
...
function Kl(a,b,c,d){function e(c){gapi.sc.Da.files.Rf({resource:{mimeType:b,title:a,parents:[{id:c}]}}).Yc(d)}function h(){function a(b){gapi.sc.Da.As.Rf({fileId:"appdata",resource:{key:"folderId",value:b}}).Yc(function(){e(b)})}function b(){gapi.sc.Da.files.Rf({resource:{mimeType:"application/vnd.google-apps.folder",title:c}}).Yc(function(b){a(b.id)})}gapi.sc.Da.As.get({fileId:"appdata",propertyKey:"folderId"}).Yc(function(d){if(d.error)c?b():a("root");else{var h=d.result.value;gapi.sc.Da.files.get({fileId:h}).Yc(function(a){a.error||
a.labels.Ju?b():e(h)})}})}gapi.sc.load("drive","v2",function(){h()})}function Ll(a){this.rk=Il(a,"onFileLoaded");this.js=Il(a,"newFileMimeType","application/vnd.google-apps.drive-sdk");this.ek=Il(a,"initializeModel");this.Ck=Il(a,"registerTypes",function(){});this.fj=Il(a,"afterAuth",function(){});this.er=Il(a,"autoCreate",!1);this.ur=Il(a,"defaultTitle","New Realtime File");this.tr=Il(a,"defaultFolderTitle","");this.gj=Il(a,"afterCreate",function(){});this.Wg=new Jl(a)}
...
Ll.prototype.bk=function(a){a.type!=gapi.Da.dc.Di.bu&&(a.type==gapi.Da.dc.Di.Xs?(alert("An Error happened: "+a.message),window.location.href="/"):a.type==gapi.Da.dc.Di.Ft&&(alert("The file was not found. It does not exist or you do not have read access to the file."),window.location.href="/"))};
Ll.prototype.load=function(){var a=Hl.fileIds;a&&(a=a.split(","));var b=this.Wg.yi,b=Hl.state;if(a)for(var c in a)gapi.Da.dc.load(a[c],this.rk,this.ek,this.bk);else{if(b){var d;try{d=JSON.parse(b)}catch(e){d=null}if("open"==d.action){a=d.tu;b=d.yi;Ml(this,a,b);return}}this.er&&Nl(this)}};function Nl(a){Kl(a.ur,a.js,a.tr,function(b){b.id?(a.gj&&a.gj(b.id),Ml(a,[b.id],a.Wg.yi)):(console.error("Error creating file."),console.error(b))})};/*
 ...
 limitations under the License.
*/
var Gh,Ol,Fh=!1,Pl=null,Ri=null,Ql=null,Rl=null,Ti=null,Vi=!1,Sl=null,Tl=null,Ul=null;function Vl(a){var b=a.yr;a=a.yr.length;for(var c=0;c<a;c++){var d=b[c];if(!d.Yr){var e=d.target;"value_changed"==d.type&&("xmlDom"==d.xk?Wl(function(){Xl(e,!1);Yl(e)}):"relativeX"!=d.xk&&"relativeY"!=d.xk||Wl(function(){e.Rk||Xl(e,!1);Yl(e)}))}}}function Zl(a){if(!a.Yr){var b=a.newValue;b?Xl(b,!a.oldValue):(b=a.oldValue,$l(b))}}function Wl(a){if(Vi)a();else try{Vi=!0,a()}finally{Vi=!1}}
...
function am(a,b){gapi.sc.Da.wk.list({fileId:a}).Yc(function(a){for(var d=0;d<a.items.length;d++){var e=a.items[d];if("owner"==e.Bu){b(e.domain);break}}})}
var em={clientId:null,authButtonElementId:"authorizeButton",authDivElementId:"authButtonDiv",initializeModel:function(a){Ri=a;var b=a.ju();a.Md().set("blocks",b);b=a.iu();a.Md().set("topBlocks",b);Tl&&a.Md().set(Tl,a.ku(Ul))},autoCreate:!0,defaultTitle:"Realtime Blockly File",defaultFolderTitle:"Realtime Blockly Folder",newFileMimeType:null,onFileLoaded:function(a){Pl=a;a:{for(var b=a.Dr(),c=0;c<b.length;c++){var d=b[c];if(d.Zr){Ql=d.Du;break a}}Ql=void 0}Ri=a.Zf;Ti=Ri.Md().get("blocks");Gh=Ri.Md().get("topBlocks");
Ri.Md().addEventListener(gapi.Da.dc.Ig.Gt,Vl);Ti.addEventListener(gapi.Da.dc.Ig.cu,Zl);Rl();a.addEventListener(gapi.Da.dc.Ig.Ys,bm);a.addEventListener(gapi.Da.dc.Ig.Zs,cm);dm();a=Gh;for(b=0;b<a.length;b++)c=a.get(b),Xl(c,!0)},registerTypes:function(){var a=gapi.Da.dc.lu;a.zu(pi,"Block");pi.prototype.id=a.$g("id");pi.prototype.zi=a.$g("xmlDom");pi.prototype.jg=a.$g("relativeX");pi.prototype.kg=a.$g("relativeY");a.Eu(pi,pi.prototype.initialize)},afterAuth:function(){setTimeout(function(){},18E5)},afterCreate:function(a){var b=
...
function ul(a,b){fm();Fh=!0;gm(b);Rl=function(){a();if(Tl){var b=Ri.Md().get(Tl),d=document.getElementById(Tl);gapi.Da.dc.mu.gu(b,d);d.disabled=!1}};Sl=new Ll(em);Sl.start()}
function gm(a){a.style.background="url("+ph+"progress.gif) no-repeat center center";var b=wd(a),c=D("div");c.id=em.authDivElementId;var d=D("p",null,G.al);c.appendChild(d);d=D("button",null,"Authorize");d.id=em.eu;c.appendChild(d);a.appendChild(c);c.style.display="none";c.style.position="relative";c.style.textAlign="center";c.style.border="1px solid";c.style.backgroundColor="#f6f9ff";c.style.borderRadius="15px";c.style.boxShadow="10px 10px 5px #888";c.style.width=b.width/3+"px";a=wd(c);c.style.left=
(b.width-a.width)/3+"px";c.style.top=(b.height-a.height)/4+"px"}function dm(){if(Ol){var a;a=Ol;a=l(a)?document.getElementById(a):a;Zb(a);for(var b=Pl.Dr(),c=0;c<b.length;c++){var d=b[c],e=D("img",{src:d.yu||ph+"anon.jpeg",alt:d.displayName,title:d.displayName+(d.Zr?" ("+G.ip+")":"")});e.style.backgroundColor=d.color;a.appendChild(e)}}}function bm(){dm()}function cm(){dm()}function oi(a){var b=Ql+"-"+a;return Ti.has(b)?oi("-"+a):b};/*
...
function yl(a){jk();lj();gg();var b=a.target&&a.target.nodeName&&"svg"==a.target.nodeName.toLowerCase();!z&&Jh&&b&&Kh();a.target==ta&&$b(a)?jm(a):(z||b)&&B.Hc&&(B.mh=!0,B.pi=a.clientX,B.qi=a.clientY,B.Ls=B.wc(),B.Ns=B.scrollX,B.Os=B.scrollY,"mouseup"in wk&&(im=v(document,"mouseup",null,Bl)),Fa=v(document,"mousemove",null,km))}function Bl(){ih(nk.OPEN);B.mh=!1;im&&(w(im),im=null);Fa&&(w(Fa),Fa=null)}
function km(a){if(B.mh){Bh();var b=B.Ls,c=B.Ns+(a.clientX-B.pi),d=B.Os+(a.clientY-B.qi),c=Math.min(c,-b.ic),d=Math.min(d,-b.Nb),c=Math.max(c,b.wa-b.ic-b.Fd),d=Math.max(d,b.Ua-b.Nb-b.tb);B.Hc.set(-c-b.ic,-d-b.Nb);a.stopPropagation()}}
...
g.Blockly.removeChangeListener=function(a){w(a)};G.pu={};G.$k="Add Comment";G.al="Please authorize this app to enable your work to be saved and to allow it to be shared by you.";G.bl="Change value:";G.cl="Chat with your collaborator by typing in this box!";G.dl="Collapse Blocks";G.el="Collapse Block";G.fl="colour 1";G.gl="colour 2";G.hl="http://meyerweb.com/eric/tools/color-blend/";G.il="ratio";G.jl="blend";G.kl="Blends two colours together with a given ratio (0.0 - 1.0).";G.ll="https://en.wikipedia.org/wiki/Color";G.ml="Choose a colour from the palette.";
...
G.wm="Add an item to the list.";G.xm="Create a list with any number of items.";G.Fi="first";G.Gi="# from end";G.Hi="#";G.ym="get";G.zm="get and remove";G.Ii="last";G.Ji="random";G.Cm="remove";G.Kg="";G.$s="Returns the first item in a list.";G.at="Returns the item at the specified position in a list. #1 is the last item.";G.bt="Returns the item at the specified position in a list. #1 is the first item.";G.ct="Returns the last item in a list.";G.dt="Returns a random item in a list.";G.et="Removes and returns the first item in a list.";
G.ft="Removes and returns the item at the specified position in a list. #1 is the last item.";G.gt="Removes and returns the item at the specified position in a list. #1 is the first item.";G.ht="Removes and returns the last item in a list.";G.it="Removes and returns a random item in a list.";G.jt="Removes the first item in a list.";G.kt="Removes the item at the specified position in a list. #1 is the last item.";G.lt="Removes the item at the specified position in a list. #1 is the first item.";
G.mt="Removes the last item in a list.";G.nt="Removes a random item in a list.";G.ot="to # from end";G.pt="to #";G.qt="to last";G.Dm="https://github.com/google/blockly/wiki/Lists#getting-a-sublist";G.rt="get sub-list from first";G.st="get sub-list from # from end";G.tt="get sub-list from #";G.Lg="";G.Fm="Creates a copy of the specified portion of a list.";G.Gm="find first occurrence of item";G.Ki="https://github.com/google/blockly/wiki/Lists#getting-items-from-a-list";G.Im="find last occurrence of item";
...
G.Sm="https://github.com/google/blockly/wiki/Lists#in-list--set";G.Um="as";G.Vm="insert at";G.Wm="set";G.vt="Inserts the item at the start of a list.";G.wt="Inserts the item at the specified position in a list. #1 is the last item.";G.xt="Inserts the item at the specified position in a list. #1 is the first item.";G.yt="Append the item to the end of a list.";G.zt="Inserts the item randomly in a list.";G.At="Sets the first item in a list.";G.Bt="Sets the item at the specified position in a list. #1 is the last item.";
G.Ct="Sets the item at the specified position in a list. #1 is the first item.";G.Dt="Sets the last item in a list.";G.Et="Sets a random item in a list.";G.Xm="Returns true if the list is empty.";G.Ym="false";G.Zm="https://github.com/google/blockly/wiki/Logic#values";G.$m="Returns either true or false.";G.an="true";G.bn="https://en.wikipedia.org/wiki/Inequality_(mathematics)";G.cn="Return true if both inputs equal each other.";G.dn="Return true if the first input is greater than the second input.";
...
G.eq="in text";G.fq="get last letter";G.gq="get random letter";G.Wi="";G.hq="Returns the letter at the specified position.";G.jq="Add an item to the text.";G.kq="join";G.lq="Add, remove, or reorder sections to reconfigure this text block.";G.Wt="to letter # from end";G.Xt="to letter #";G.Yt="to last letter";G.mq="https://github.com/google/blockly/wiki/Text#extracting-a-region-of-text";G.nq="in text";G.Zt="get substring from first letter";G.$t="get substring from letter # from end";G.au="get substring from letter #";
...
d.style.opacity=0;c?(X.Xf(a,!1,.8),X.Xf(c,!0,.2),setTimeout(b,175)):b();a.style.visibility="hidden";a.style.zIndex=-1;for((c=document.getElementById("dialogHeader"))&&c.parentNode.removeChild(c);a.firstChild;)c=a.firstChild,c.className+=" dialogHiddenContent",document.body.appendChild(c)}},Xf:function(a,b,c){function d(){e.style.width=h.width+"px";e.style.height=h.height+"px";e.style.left=h.x+"px";e.style.top=h.y+"px";e.style.opacity=c}if(a){var e=document.getElementById("dialogBorder"),h=X.Cr(a);
b?(e.className="dialogAnimate",setTimeout(d,1)):(e.className="",d());e.style.visibility="visible"}},Cr:function(a){if(a.getBBox){var b=a.getBBox(),c=b.height,b=b.width;a=Sf(a);var d=a.x,e=a.y}else{c=a.offsetHeight;b=a.offsetWidth;e=d=0;do d+=a.offsetLeft,e+=a.offsetTop,a=a.offsetParent;while(a)}return{height:c,width:b,x:d,y:e}},Ps:function(a){var b=document.getElementById("containerStorage");b.textContent="";a=a.split("\n");for(var c=0;c<a.length;c++){var d=document.createElement("p");d.appendChild(document.createTextNode(a[c]));
b.appendChild(d)}b=document.getElementById("dialogStorage");a=document.getElementById("linkButton");X.Kc(b,a,!0,!0,{width:"50%",left:"25%",top:"5em"},X.ri);X.oi()},ej:function(){if(!wm(U))if(X.Ac||0!=pi.ou)setTimeout(X.ej,15E3);else{var a=document.getElementById("dialogAbort"),b=document.getElementById("abortCancel");b.addEventListener("click",X.mb,!0);b.addEventListener("touchend",X.mb,!0);b=document.getElementById("abortOk");b.addEventListener("click",W.Eh,!0);b.addEventListener("touchend",W.Eh,
!0);X.Kc(a,null,!1,!0,{width:"40%",left:"30%",top:"3em"},function(){document.body.removeEventListener("keydown",X.dj,!0)});document.body.addEventListener("keydown",X.dj,!0)}},vu:function(){var a=document.getElementById("dialogDone");B&&(document.getElementById("dialogLinesText").textContent="Play a challenge to unlock new features.");var b=document.getElementById("containerCode");a.removeChild(b);10>U?V("Games_nextLevel").replace("%1",U+1):V("Games_finalLevel");b=document.getElementById("doneCancel");
...
"_self")},!0),b.addEventListener("touchend",function(){window.open("/turtle?lang=en?level=2","_self")},!0));X.Kc(a,null,!1,!0,{width:"40%",left:"30%",top:"3em"},function(){document.body.removeEventListener("keydown",X.Ed,!0)});document.body.addEventListener("keydown",X.Ed,!0)},nu:function(){var a=document.getElementById("dialogDone");B&&(document.getElementById("dialogLinesText").textContent='You have finished creating your avatar! Click "OK" Return to the homepage or "Cancel" continue dressing up your avatar.');
...
X.Ed,!0)},kr:function(){var a=document.getElementById("dialogDone");if(B){document.getElementById("dialogLinesText").textContent="";var b=10>U?V("Games_nextLevel").replace("%1",U+1):V("Games_finalLevel"),c=document.getElementById("containerCode");"puzzle"==ym?c.innerHTML="<p>New features unlocked!</p><img class='featureUnlocked' src='./movie/shorts.svg' width='80px' border=0 /><img class='featureUnlocked' src='./movie/skirt.svg' width='80px' border=0/>":"turtle"==ym&&1==U?c.innerHTML="<p>New features unlocked!</p><img class='featureUnlocked' src='./movie/boots.svg' width='80px' border=0 /><img class='featureUnlocked' src='./movie/cowboyboot.svg' width='80px' border=0/>":
"turtle"==ym&&2==U&&(c.innerHTML="<p>New features unlocked!</p><img class='featureUnlocked' src='./movie/earrings.svg' width='80px' border=0 /><img class='featureUnlocked' src='./movie/bow.svg' width='80px' border=0/>")}c=document.getElementById("doneCancel");c.addEventListener("click",X.mb,!0);c.addEventListener("touchend",X.mb,!0);c=document.getElementById("doneOk");c.addEventListener("click",W.Nh,!0);c.addEventListener("touchend",W.Nh,!0);X.Kc(a,null,!1,!0,{width:"40%",left:"30%",top:"3em"},function(){document.body.removeEventListener("keydown",
X.Ed,!0)});document.body.addEventListener("keydown",X.Ed,!0);document.getElementById("dialogDoneText").textContent=b},Oj:function(a){!X.Ac||13!=a.keyCode&&27!=a.keyCode&&32!=a.keyCode||(X.mb(!0),a.stopPropagation(),a.preventDefault())},oi:function(){document.body.addEventListener("keydown",X.Oj,!0)},ri:function(){document.body.removeEventListener("keydown",X.Oj,!0)},Ed:function(a){if(13==a.keyCode||27==a.keyCode||32==a.keyCode)X.mb(!0),a.stopPropagation(),a.preventDefault(),27!=a.keyCode&&W.Nh()},
dj:function(a){if(13==a.keyCode||27==a.keyCode||32==a.keyCode)X.mb(!0),a.stopPropagation(),a.preventDefault(),27!=a.keyCode&&W.Eh()}};window.BlocklyDialogs=X;X.hideDialog=X.mb;var Am={},Bm,Cm,Dm,Y,Em,Fm,Gm,Hm;
function Im(){function a(a){for(var b=0;5>b;b++)Z(a),Jm(144)}switch(U){case 1:Z(100);Jm(90);Z(100);Jm(90);Z(100);Jm(90);Z(100);Jm(90);break;case 2:for(var b=0;4>b;b++)Z(100),Jm(90);break;case 3:for(b=0;5>b;b++)Z(100),Jm(72);break;case 4:Km("#ffff00");a(100);break;case 5:Km("#ffff00");for(b=0;4>b;b++)Lm(!1),Z(150),Jm(90),Lm(!0),a(50);break;case 6:Km("#ffff00");for(b=0;3>b;b++)Lm(!1),Z(150),Jm(120),Lm(!0),a(50);Lm(!1);Jm(-90);Z(100);Lm(!0);Km("#ffffff");Z(50);break;case 7:Km("#ffff00");for(b=0;3>b;b++)Lm(!1),
...
function Mm(a){if(10==U)return 1<B.Za().length;console.log("Pixel errors: "+a);return 100<a?!1:2==U&&3<B.Za().length||3==U&&4<B.Za().length?(a=document.getElementById("helpUseLoop"),X.Kc(a,null,!1,!0,{width:"30%",left:"35%",top:"12em"},X.ri),X.oi(),!1):!0};function Nm(a,b,c,d,e){this.pm=b-12;this.yd=a+8;this.Jg=a+c-8;this.Sc=20;this.va=.5;this.oj=e;this.Vg=[];e=document.createElementNS(Om,"line");e.setAttribute("class","sliderTrack");e.setAttribute("x1",a);e.setAttribute("y1",b);e.setAttribute("x2",a+c);e.setAttribute("y2",b);d.appendChild(e);e=document.createElementNS(Om,"rect");e.setAttribute("style","opacity: 0");e.setAttribute("x",a-this.Sc);e.setAttribute("y",b-this.Sc);e.setAttribute("width",c+2*this.Sc);e.setAttribute("height",2*this.Sc);e.setAttribute("rx",
this.Sc);e.setAttribute("ry",this.Sc);d.appendChild(e);this.Ss=e;a=document.createElementNS(Om,"path");a.setAttribute("class","sliderKnob");a.setAttribute("d","m 0,0 l -8,8 v 12 h 16 v -12 z");d.appendChild(a);this.jk=a;a=document.createElementNS(Om,"circle");a.setAttribute("style","opacity: 0");a.setAttribute("r",this.Sc);a.setAttribute("cy",b);d.appendChild(a);this.Hh=a;for(this.ja(.5);d&&"svg"!=d.nodeName.toLowerCase();)d=d.parentNode;this.Rc=d;Pm(this.Hh,"mousedown",this,this.ik);Pm(this.Hh,"touchstart",
this,this.ik);Pm(this.Ss,"mousedown",this,this.Bs);Pm(this.Rc,"mouseup",null,Qm);Pm(this.Rc,"touchend",null,Qm);Pm(this.Rc,"mousemove",null,Rm);Pm(this.Rc,"touchmove",null,Rm);Pm(document,"mouseover",null,Sm)}var Om="http://www.w3.org/2000/svg",Tm=null,Um=0,Vm=0;Nm.prototype.ik=function(a){if("touchstart"==a.type){if(1!=a.changedTouches.length)return;Wm(a)}Tm=this;Um=Xm(this,a).x;Vm=0;var b=this.jk.getAttribute("transform");b&&(b=b.match(/translate\(\s*([-\d.]+)/))&&(Vm=Number(b[1]));a.preventDefault()};
function Qm(){Tm=null}function Sm(a){if(Tm){a=a.target;do if(a==Tm.Rc)return;while(a=a.parentNode);Tm=null}}function Rm(a){var b=Tm;if(b){if("touchmove"==a.type){if(1!=a.changedTouches.length)return;Wm(a)}a=Xm(b,a).x-Um+Vm;b.ja((a-b.yd)/(b.Jg-b.yd))}}Nm.prototype.Bs=function(a){if("touchstart"==a.type){if(1!=a.changedTouches.length)return;Wm(a)}a=Xm(this,a).x;Ym(this,(a-this.yd)/(this.Jg-this.yd))};Nm.prototype.Fa=function(){return this.va};
function Ym(a,b){function c(c){return function(){a.ja(c*(b-d)/9+d)}}for(;a.Vg.length;)clearTimeout(a.Vg.pop());for(var d=a.Fa(),e=0;10>e;e++)a.Vg.push(setTimeout(c(e),200*e/10))}Nm.prototype.ja=function(a){this.va=Math.min(Math.max(a,0),1);a=this.yd+(this.Jg-this.yd)*this.va;this.jk.setAttribute("transform","translate("+a+","+this.pm+")");this.Hh.setAttribute("cx",a);this.oj&&this.oj(this.va)};
function Xm(a,b){var c=a.Rc.createSVGPoint();c.x=b.clientX;c.y=b.clientY;var d=a.Rc.getScreenCTM().inverse();return c.matrixTransform(d)}function Pm(a,b,c,d){a.addEventListener(b,function(a){d.apply(c,arguments)},!1)}function Wm(a){var b=a.changedTouches[0];a.clientX=b.clientX;a.clientY=b.clientY};/*
...
"      throw 'Unhandled option (lists_getSublist).';","    }","    return at;","  }","  at1 = getAt(where1, at1);","  at2 = getAt(where2, at2) + 1;","  return list.slice(at1, at2);","}"])+"("+b+", '"+c+"', "+e+", '"+d+"', "+a+")",T.P]};/*
 ...
 limitations under the License.
*/
T.Vs={};T.variables_get=function(a){return[T.da.getName(O(a,"VAR"),"VARIABLE"),T.Sb]};T.variables_set=function(a){var b=S(a,"VALUE",T.Qc)||"0";return T.da.getName(O(a,"VAR"),"VARIABLE")+" = "+b+";\n"};/*
...
C.colour_blend={g:function(){this.p=G.hl;this.j(20);N(N(Qi(P(this,"COLOUR1").v("Colour"),1),G.jl),G.fl);N(Qi(P(this,"COLOUR2").v("Colour"),1),G.gl);N(Qi(P(this,"RATIO").v("Number"),1),G.il);K(this,!0,"Colour");this.i(G.kl)}};/*
 ...
 limitations under the License.
*/
C.es={};C.controls_repeat={g:function(){this.p=G.Gg;this.j(120);N(N(N(Q(this),G.Bi),new Zk("10",dl),"TIMES"),G.Ci);N($i(this,3,"DO"),G.Oc);L(this,!0);M(this,!0);this.i(G.Hg)}};C.controls_repeat_ext={g:function(){this.p=G.Gg;this.j(120);this.sa(G.Xl,["TIMES","Number",1],1);N($i(this,3,"DO"),G.Oc);L(this,!0);M(this,!0);Sg(this,!0);this.i(G.Hg)}};
...
C.controls_flow_statements={g:function(){var a=[[G.xl,"BREAK"],[G.yl,"CONTINUE"]];this.p=G.wl;this.j(120);N(Q(this),new F(a),"FLOW");L(this,!0);var b=this;this.i(function(){var a=O(b,"FLOW");return{BREAK:G.zl,CONTINUE:G.Al}[a]})},onchange:function(){if(this.t){var a=!1,b=this;do{if("controls_repeat"==b.type||"controls_repeat_ext"==b.type||"controls_forEach"==b.type||"controls_for"==b.type||"controls_whileUntil"==b.type){a=!0;break}b=Wi(b)}while(b);a?this.sd(null):this.sd(G.Bl)}}};/*
 ...
 limitations under the License.
*/
T.fs={};T.math_number=function(a){return[parseFloat(O(a,"NUM")),T.Sb]};T.math_arithmetic=function(a){var b={ADD:[" + ",T.Mg],MINUS:[" - ",T.op],MULTIPLY:[" * ",T.mp],DIVIDE:[" / ",T.jf],POWER:[null,T.pa]}[O(a,"OP")],c=b[0],b=b[1],d=S(a,"A",b)||"0";a=S(a,"B",b)||"0";return c?[d+c+a,b]:["Math.pow("+d+", "+a+")",T.P]};
...
C.procedures_mutatorarg={g:function(){this.j(290);N(N(Q(this),G.Fp),new Zk("x",this.Us),"NAME");L(this,!0);M(this,!0);this.i(G.Gp);this.contextMenu=!1},Us:function(a){return(a=a.replace(/[\s\xa0]+/g," ").replace(/^ | $/g,""))||null}};
...
T.logic_ternary=function(a){var b=S(a,"IF",T.hf)||"false",c=S(a,"THEN",T.hf)||"null";a=S(a,"ELSE",T.hf)||"null";return[b+" ? "+c+" : "+a,T.hf]};/*
 ...
 limitations under the License.
*/
T.zs={};T.procedures_defreturn=function(a){var b=T.da.getName(O(a,"NAME"),"PROCEDURE"),c=hl(a,"STACK");T.zd&&(c=fl(T.zd.replace(/%1/g,"'"+a.id+"'"),T.he)+c);T.ef&&(c=T.ef.replace(/%1/g,"'"+a.id+"'")+c);var d=S(a,"RETURN",T.S)||"";d&&(d="  return "+d+";\n");for(var e=[],h=0;h<a.A.length;h++)e[h]=T.da.getName(a.A[h],"VARIABLE");c="function "+b+"("+e.join(", ")+") {\n"+c+d+"}";c=T.bi(a,c);T.Hd[b]=c;return null};T.procedures_defnoreturn=T.procedures_defreturn;
...
C.logic_boolean={g:function(){var a=[[G.an,"TRUE"],[G.Ym,"FALSE"]];this.p=G.Zm;this.j(210);K(this,!0,"Boolean");N(Q(this),new F(a),"BOOL");this.i(G.$m)}};C.logic_null={g:function(){this.p=G.on;this.j(210);K(this,!0);N(Q(this),G.nn);this.i(G.pn)}};C.logic_ternary={g:function(){this.p=G.wn;this.j(210);N(P(this,"IF").v("Boolean"),G.vn);N(P(this,"THEN"),G.yn);N(P(this,"ELSE"),G.xn);K(this,!0);this.i(G.zn)}};/*
 ...
 limitations under the License.
*/
C.bs={};C.lists_create_empty={g:function(){this.p=G.qm;this.j(260);K(this,!0,"Array");N(Q(this),G.Ei);this.i(G.rm)}};
...
!0);M(this,!0);this.i(V("Turtle_fontTooltip"))}};T.turtle_font=function(a){return"font('"+O(a,"FONT")+"',"+Number(O(a,"FONTSIZE"))+",'"+O(a,"FONTSTYLE")+"', 'block_id_"+a.id+"');\n"};C.turtle_repeat_internal={g:function(){this.p=G.Gg;this.j(120);N(N(N(Q(this),G.Bi),new F([["3","3"],["4","4"],["5","5"],["360","360"]]),"TIMES"),G.Ci);N($i(this,3,"DO"),G.Oc);L(this,!0);M(this,!0);this.i(G.Hg)}};T.turtle_repeat_internal=T.controls_repeat;r&&Pb(8);function Zm(){return'<div class="farSide" style="padding: 1ex 3ex 0"><button class="secondary" onclick="BlocklyDialogs.hideDialog(true)">OK</button></div>'};function $m(){return'<div style="display: none"><span id="Games_name">Code Girl</span><span id="Games_puzzle">Puzzle</span><span id="Games_maze">Maze</span><span id="Games_bird">Bird</span><span id="Games_turtle">Pen</span><span id="Games_movie">Movie</span><span id="Games_pondBasic">Pond</span><span id="Games_pondAdvanced">JS Pond</span><span id="Games_linesOfCode1">You solved this challenge with 1 line of code!</span><span id="Games_linesOfCode2">You solved this solved this challenge with %1 lines of code!</span><span id="Games_nextLevel">Return to your avatar to use these new features.</span><span id="Games_finalLevel">Are you ready for the next challenge?</span><span id="Games_linkTooltip">Save and link to blocks.</span><span id="Games_runTooltip">Run the program you wrote.</span><span id="Games_runProgram">Run Program</span><span id="Games_resetTooltip">Stop the program and reset the level.</span><span id="Games_resetProgram">Reset</span><span id="Games_help">Help</span><span id="Games_dialogOk">OK</span><span id="Games_dialogCancel">Cancel</span><span id="Games_catLogic">Logic</span><span id="Games_catLoops">Loops</span><span id="Games_catMath">Math</span><span id="Games_catText">Text</span><span id="Games_catLists">Lists</span><span id="Games_catColour">Colour</span><span id="Games_catVariables">Variables</span><span id="Games_catProcedures">Functions</span><span id="Games_httpRequestError">There was a problem with the request.</span><span id="Games_linkAlert">Share your blocks with this link:\\n\\n%1</span><span id="Games_hashError">Sorry, \'%1\' doesn\'t correspond with any saved program.</span><span id="Games_xmlError">Could not load your saved file. Perhaps it was created with a different version of Blockly?</span><span id="Games_listVariable">list</span><span id="Games_textVariable">text</span></div><div style="display: none"><span id="Turtle_moveTooltip">Moves the turtle forward or backward by the specified amount.</span><span id="Turtle_moveForward">move forward by</span><span id="Turtle_moveBackward">move backward by</span><span id="Turtle_turnTooltip">Turns the turtle left or right by the specified number of degrees.</span><span id="Turtle_turnRight">turn right by</span><span id="Turtle_turnLeft">turn left by</span><span id="Turtle_widthTooltip">Changes the width of the pen.</span><span id="Turtle_setWidth">set width to</span><span id="Turtle_colourTooltip">Changes the colour of the pen.</span><span id="Turtle_setColour">set colour to</span><span id="Turtle_penTooltip">Lifts or lowers the pen, to stop or start drawing.</span><span id="Turtle_penUp">pen up</span><span id="Turtle_penDown">pen down</span><span id="Turtle_turtleVisibilityTooltip">Makes the turtle (circle and arrow) visible or invisible.</span><span id="Turtle_hideTurtle">hide turtle</span><span id="Turtle_showTurtle">show turtle</span><span id="Turtle_printHelpUrl">https://en.wikipedia.org/wiki/Printing</span><span id="Turtle_printTooltip">Draws text in the turtle\'s direction at its location.</span><span id="Turtle_print">print</span><span id="Turtle_fontHelpUrl">https://en.wikipedia.org/wiki/Font</span><span id="Turtle_fontTooltip">Sets the font used by the print block.</span><span id="Turtle_font">font</span><span id="Turtle_fontSize">font size</span><span id="Turtle_fontNormal">normal</span><span id="Turtle_fontBold">bold</span><span id="Turtle_fontItalic">italic</span><span id="Turtle_submitDisabled">Run your program until it stops. Then you may submit your drawing to the gallery.</span></div>'}
;var ym="turtle";W.Nh=function(){window.location=window.location.protocol+"//"+window.location.host+"/movie?lang="+qm+"&level="+(U+2)};var an=[],bn=0,cn=null,dn=!0;
function en(){function a(){c.style.top=Math.max(10,d.offsetTop-window.pageYOffset)+"px";c.style.left=b?"10px":"420px";c.style.width=window.innerWidth-440+"px"}document.body.innerHTML=$m()+'<div id="header"><div id="logo"><a href="./"> <img src="./index/horizontal-logo-01.png"></a></div><div class="farSide"><select id="languageMenu"></select>&nbsp;<button id="signoutButton" onClick="location.href=\'/\'">Signout</button><button id="linkButton" title="Save and link to blocks."><img src="media/1x1.gif" class="link icon21"></button>&nbsp;<button id="helpButton">Help</button></div></div><div id="visualization"><canvas id="scratch" width="400" height="400" style="display: none"></canvas><canvas id="answer" width="400" height="400" style="display: none"></canvas><canvas id="display" width="400" height="400"></canvas></div><table style="padding-top: 1em;"><tr><td style="width: 190px; text-align: center; vertical-align: top;background-color:white;"><svg id="slider" xmlns="http://www.w3.org/2000/svg" xmlns:svg="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="150" height="50">\x3c!-- Slow icon. --\x3e<clipPath id="slowClipPath"><rect width=26 height=12 x=5 y=14 /></clipPath><image xlink:href="turtle/seaturtle.svg" height=32 width=74 x=-21 y=0 />\x3c!-- Fast icon. --\x3e<clipPath id="fastClipPath"><rect width=26 height=16 x=120 y=10 /></clipPath><image xlink:href="turtle/bunny.svg" height=32 width=74 x=92 y=0 /></svg></td><td style="width: 15px;"><img id="spinner" style="visibility: hidden;" src="turtle/loading.gif" height=15 width=15></td><td style="width: 190px; text-align: center"><button id="runButton" class="primary" title="Run the program you wrote."><img src="media/1x1.gif" class="run icon21"> Run Program</button><button id="resetButton" class="primary" style="display: none" title="Stop the program and reset the level."><img src="media/1x1.gif" class="stop icon21"> Reset</button></td></tr></table>'+(10!=
U||sm?"":'<table style="padding-top: 1em; width: 400px;"><tr><td style="text-align: center;"><form action="https://www.reddit.com/r/BlocklyGames/" target="gallery"><button type="submit" title="Open the gallery of drawings on Reddit."><img src="media/1x1.gif" class="reddit icon21"> See Gallery</button></form></td><td style="text-align: center;"><button id="submitButton" title="Submit your drawing to Reddit."><img src="media/1x1.gif" class="camera icon21"> Submit to Gallery</button><canvas id="thumbnail" width="100" height="100" style="display: none"></canvas><form id="t2r_form" action="turtle-reddit" method="POST" target="_blank" style="display: none"><input id="t2r_thumb" type="hidden" name="thumb"><input id="t2r_xml" type="hidden" name="xml"></form></td></tr>')+
('<xml id="toolbox" style="display: none"><category name="Directions"><block type="turtle_move_internal"></block><block type="turtle_turn_internal"><field name="VALUE">some</field></block>'+(3<U?'<block type="turtle_pen"></block>':"")+'</category><category name="Loops"><block type="turtle_repeat_internal"><field name="TIMES">4</field></block></category></xml>')+'<div id="blockly"></div><div id="dialogShadow" class="dialogAnimate"></div><div id="dialogBorder"></div><div id="dialog"></div><div id="dialogDone" class="dialogHiddenContent"><div style="font-size: large; margin: 1em;">Congratulations!</div><div id="dialogLinesText" style="font-size: large; margin: 1em;"></div><pre id="containerCode"></pre><div id="dialogDoneText" style="font-size: large; margin: 1em;"></div><div id="dialogDoneButtons" class="farSide" style="padding: 1ex 3ex 0"><button id="doneCancel">Cancel</button><button id="doneOk" class="secondary">OK</button></div></div><div id="dialogAbort" class="dialogHiddenContent">This level is extremely difficult. Would you like to skip it and go onto the next game? You can always come back later.<div id="dialogAbortButtons" class="farSide" style="padding: 1ex 3ex 0"><button id="abortCancel">Cancel</button><button id="abortOk" class="secondary">OK</button></div></div>'+
('<div id="dialogStorage" class="dialogHiddenContent"><div id="containerStorage"></div>'+Zm()+"</div>")+(4>U?'<div id="helpUseLoop" class="dialogHiddenContent"><div style="padding-bottom: 0.7ex">Your solution works, but you can solve the challenge with fewer blocks. Try using "Loops." '+(3>U?"Draw the shape with just three blocks.":"Draw the star with just four blocks.")+"</div>"+Zm()+"</div>":"")+'<div id="help" class="dialogHiddenContent"><div style="padding-bottom: 0.7ex">'+(1==U?'<h3> Learn Sequentiality! </h3>Put the blocks together to help the robot draw a square! Change the value of the fields to make the robot move correctly.<br><img src="turtle/square.gif" height=146 width=146 style="margin-bottom: -50px">':
"")+(2==U?"<h3> Learn Loops! </h3>Now, use a loop from the toolbar to help the robot draw a square.":"")+(3==U?"Now, help the robot draw a hexagon using loops.":"")+"</div>"+Zm()+"</div>"+(2==U?'<div id="helpToolbox" class="dialogHiddenContent"><div><img src="turtle/help_left.png" class="mirrorImg" height=23 width=64></div>Choose a category to see the blocks.</div>':"");W.g();var b=-1!=pm.indexOf(qm),c=document.getElementById("blockly"),d=document.getElementById("visualization");window.addEventListener("scroll",
function(){a();lh(window,"resize")});window.addEventListener("resize",a);a();10>U&&(Wk=3,Vk="#ff0000 #ffcc33 #ffff00 #009900 #3333ff #cc33cc #ffffff #999999 #000000".split(" "));if(1!=U)var e=document.getElementById("toolbox");ql(document.getElementById("blockly"),{media:"media/",rtl:b,toolbox:e,trashcan:!0});jl("moveForward,moveBackward,turnRight,turnLeft,penUp,penDown,penWidth,penColour,hideTurtle,showTurtle,print,font");document.getElementById("submitButton")&&zm("submitButton",Am.Hu);e=document.getElementById("slider");
Bm=new Nm(10,35,130,e);if(1==U)var h='<xml>  <block type="turtle_move_internal" x="70" y="120">  </block>  <block type="turtle_turn_internal" x="300" y="200">  <field name="VALUE">some</field>   </block>  <block type="turtle_move_internal" x="220" y="50">  </block>  <block type="turtle_turn_internal" x="600" y="150">  <field name="VALUE">some</field>   </block>  <block type="turtle_move_internal" x="600" y="330">  </block>  <block type="turtle_turn_internal" x="200" y="500">  <field name="VALUE">some</field>   </block>  <block type="turtle_move_internal" x="100" y="350">  </block>  <block type="turtle_turn_internal" x="500" y="450">  <field name="VALUE">some</field>   </block></xml>';
W.cs(h,!0);Cm=document.getElementById("display").getContext("2d");Dm=document.getElementById("answer").getContext("2d");Y=document.getElementById("scratch").getContext("2d");fn();Im();Dm.globalCompositeOperation="copy";Dm.drawImage(Y.canvas,0,0);Dm.globalCompositeOperation="source-over";fn();zm("runButton",gn);zm("resetButton",hn);Cl(["turtle/win.mp3","turtle/win.ogg"],"win");setTimeout(W.Ur,1);setTimeout(W.Vr,1);zm("helpButton",jn);2>location.hash.length&&!wm(U)&&(setTimeout(jn,1E3),9==U&&setTimeout(X.ej,
3E5))}window.location.pathname.match(/readonly.html$/)?window.addEventListener("load",function(){W.Wr($m()+'<div id="blockly"></div>')}):window.addEventListener("load",en);function jn(){var a=document.getElementById("help"),b=document.getElementById("helpButton");X.Kc(a,b,!0,!0,{width:"50%",left:"25%",top:"5em"},kn);X.oi()}function kn(){X.ri();2==U&&(ln(),setTimeout(mn,5E3))}
function mn(){if(!nn&&!X.Ac){var a=document.getElementById("helpToolbox"),b=document.getElementById(":0");X.Kc(a,b,!0,!1,{width:"25%",left:"525px",top:"5em"},null)}}var nn=!1;function ln(){B.Ta.V.J()&&(nn=!0,X.mb(!1));nn||setTimeout(ln,100)}function fn(){Fm=Em=200;Gm=0;dn=Hm=!0;Y.canvas.width=Y.canvas.width;Y.strokeStyle="#ec8fa1";Y.fillStyle="#ffffff";Y.lineWidth=5;Y.lineCap="round";Y.font="normal 18pt Arial";on();for(var a=0;a<an.length;a++)window.clearTimeout(an[a]);an.length=0;cn=null}
function on(){Cm.beginPath();Cm.rect(0,0,Cm.canvas.width,Cm.canvas.height);Cm.fillStyle="#444444";Cm.fill();Cm.globalCompositeOperation="source-over";Cm.globalAlpha=.2;Cm.drawImage(Dm.canvas,0,0);Cm.globalAlpha=1;Cm.globalCompositeOperation="source-over";Cm.drawImage(Y.canvas,0,0);if(dn){Cm.strokeStyle=Y.strokeStyle;Cm.fillStyle=Y.fillStyle;var a=Y.lineWidth/2+10,b=2*a,c=new Image;c.onload=function(){Cm.drawImage(c,Em-b,Fm-a,50,50)};c.src="./turtle/robot.svg";var d=2*Math.PI*Gm/360,e=Em+(a+10)*Math.sin(d),
h=Fm-(a+10)*Math.cos(d),d=d-.3,k=Em+(a+4)*Math.sin(d),m=Fm-(a+4)*Math.cos(d),d=d+.15,p=Em+(a+6)*Math.sin(d),y=Fm-(a+6)*Math.cos(d),d=d+.3,x=Em+(a+6)*Math.sin(d),E=Fm-(a+6)*Math.cos(d),d=d+.15,A=Em+(a+4)*Math.sin(d),d=Fm-(a+4)*Math.cos(d);Cm.beginPath();Cm.moveTo(e,h);Cm.lineTo(k,m);Cm.bezierCurveTo(p,y,x,E,A,d);Cm.closePath();Cm.fill()}}
function gn(a){if(!W.Wb(a)){a=document.getElementById("runButton");var b=document.getElementById("resetButton");b.style.minWidth||(b.style.minWidth=a.offsetWidth+"px");a.style.display="none";b.style.display="inline";document.getElementById("spinner").style.visibility="visible";Hh(B,!0);pn()}}
function hn(a){W.Wb(a)||(document.getElementById("runButton").style.display="inline",document.getElementById("resetButton").style.display="none",document.getElementById("spinner").style.visibility="hidden",Hh(B,!1),fn())}
function qn(a,b){var c;c=function(a,b){Z(a.valueOf(),b.toString())};a.setProperty(b,"moveForward",a.createNativeFunction(c));c=function(a,b){Z(-a.valueOf(),b.toString())};a.setProperty(b,"moveBackward",a.createNativeFunction(c));c=function(a,b){Jm(a.valueOf(),b.toString())};a.setProperty(b,"turnRight",a.createNativeFunction(c));c=function(a,b){Jm(-a.valueOf(),b.toString())};a.setProperty(b,"turnLeft",a.createNativeFunction(c));c=function(a){Lm(!1,a.toString())};a.setProperty(b,"penUp",a.createNativeFunction(c));
c=function(a){Lm(!0,a.toString())};a.setProperty(b,"penDown",a.createNativeFunction(c));c=function(a,b){var c=b.toString();Y.lineWidth=a.valueOf();rn(c)};a.setProperty(b,"penWidth",a.createNativeFunction(c));c=function(a,b){Km(a.toString(),b.toString())};a.setProperty(b,"penColour",a.createNativeFunction(c));c=function(a){a=a.toString();dn=!1;rn(a)};a.setProperty(b,"hideTurtle",a.createNativeFunction(c));c=function(a){a=a.toString();dn=!0;rn(a)};a.setProperty(b,"showTurtle",a.createNativeFunction(c));
c=function(a,b){var c=a.toString(),k=b.toString();Y.save();Y.translate(Em,Fm);Y.rotate(2*Math.PI*(Gm-90)/360);Y.fillText(c,0,0);Y.restore();rn(k)};a.setProperty(b,"print",a.createNativeFunction(c));c=function(a,b,c,k){k=k.toString();Y.font=c.toString()+" "+b.valueOf()+"pt "+a.toString();rn(k)};a.setProperty(b,"font",a.createNativeFunction(c))}
function pn(){if("Interpreter"in window){fn();var a=T,b=B,c=[];a.g(b);for(var b=Ka(b,!0),d=0,e;e=b[d];d++){var h=gl(a,e);ea(h)&&(h=h[0]);h&&(e.G&&a.Hk&&(h=a.Hk(h)),c.push(h))}c=c.join("\n");c=a.finish(c);c=c.replace(/^\s+\n/,"");c=c.replace(/\n\s+$/,"\n");c=c.replace(/[ \t]+\n/g,"\n");cn=new Interpreter(c,qn);an.push(setTimeout(sn,100))}else setTimeout(pn,250)}
function sn(){bn=an.length=0;var a;do{try{a=cn.step()}catch(b){alert(b),a=!1}a&&bn&&(a=!1,an.push(setTimeout(sn,bn)))}while(a);if(!bn){document.getElementById("spinner").style.visibility="hidden";Ih(null);a=Y.getImageData(0,0,400,400);for(var c=Dm.getImageData(0,0,400,400),d=Math.min(a.data.length,c.data.length),e=0,h=3;h<d;h+=4)64<Math.abs(a.data[h]-c.data[h])&&e++;Mm(e)?(W.Gs(),3>U&&(lk("win",.5),X.kr())):Km("#ff0000")}}
function rn(a){on();a&&(W.zh(a),a=1E3*Math.pow(1-Bm.Fa(),2),bn=Math.max(1,a))}function Z(a,b){Hm&&(Y.beginPath(),Y.moveTo(Em,Fm));if(a){Em+=a*Math.sin(2*Math.PI*Gm/360);Fm-=a*Math.cos(2*Math.PI*Gm/360);var c=0}else c=.1;Hm&&(Y.lineTo(Em,Fm+c),Y.stroke());rn(b)}function Jm(a,b){Gm+=a;Gm%=360;0>Gm&&(Gm+=360);rn(b)}function Lm(a,b){Hm=a;rn(b)}function Km(a,b){Y.strokeStyle=a;Y.fillStyle=a;rn(b)};
