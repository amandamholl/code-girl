...
f.m=function(){this.B=!1;Dh.k.m.call(this);this.o&&(Vb(this.o),this.o=null);this.de=this.aa=null;this.V&&(this.V.m(),this.V=null);this.Ab&&(this.Ab.m(),this.Ab=null)};function Fh(){var a=A;if(sa&&!z){a.Ab=new nh(a);var b=a.Ab.H();a.o.insertBefore(b,a.aa);a.Ab.g()}}f.pe=function(a){Dh.k.pe.call(this,a);Gh&&this==A&&-1==Hh.indexOf(a)&&Hh.push(a)};f.og=function(a){Dh.k.og.call(this,a);Gh&&this==A&&Hh.Gu(a)};f.clear=function(){hg();Dh.k.clear.call(this)};f.Kf=function(){return this.wc().wa};
...
qb("addTemplate() can only handle value inputs.")});d.push(1);a.Zr&&this.Lu(a.Zr);qi.prototype.sa.apply(this,d)}};b.Ia=a.Ou?function(){var b=a.ms?a.Cu():document.createElement("mutation");b.setAttribute("is_statement",this.isStatement||!1);return b}:a.ms;C[a.mu]=b}};/*
...
function bm(a,b){gapi.sc.Da.xk.list({fileId:a}).Yc(function(a){for(var d=0;d<a.items.length;d++){var e=a.items[d];if("owner"==e.Hu){b(e.domain);break}}})}
var fm={clientId:null,authButtonElementId:"authorizeButton",authDivElementId:"authButtonDiv",initializeModel:function(a){Si=a;var b=a.ou();a.Nd().set("blocks",b);b=a.nu();a.Nd().set("topBlocks",b);Ul&&a.Nd().set(Ul,a.pu(Vl))},autoCreate:!0,defaultTitle:"Realtime Blockly File",defaultFolderTitle:"Realtime Blockly Folder",newFileMimeType:null,onFileLoaded:function(a){Ql=a;a:{for(var b=a.Fr(),c=0;c<b.length;c++){var d=b[c];if(d.bs){Rl=d.Ju;break a}}Rl=void 0}Si=a.$f;Ui=Si.Nd().get("blocks");Hh=Si.Nd().get("topBlocks");
Si.Nd().addEventListener(gapi.Da.dc.Jg.Lt,Wl);Ui.addEventListener(gapi.Da.dc.Jg.hu,$l);Sl();a.addEventListener(gapi.Da.dc.Jg.ct,cm);a.addEventListener(gapi.Da.dc.Jg.dt,dm);em();a=Hh;for(b=0;b<a.length;b++)c=a.get(b),Yl(c,!0)},registerTypes:function(){var a=gapi.Da.dc.qu;a.Fu(qi,"Block");qi.prototype.id=a.ah("id");qi.prototype.Ai=a.ah("xmlDom");qi.prototype.kg=a.ah("relativeX");qi.prototype.lg=a.ah("relativeY");a.Ku(qi,qi.prototype.initialize)},afterAuth:function(){setTimeout(function(){},18E5)},afterCreate:function(a){var b=
...
(b.width-a.width)/3+"px";c.style.top=(b.height-a.height)/4+"px"}function em(){if(Pl){var a;a=Pl;a=l(a)?document.getElementById(a):a;Zb(a);for(var b=Ql.Fr(),c=0;c<b.length;c++){var d=b[c],e=D("img",{src:d.Eu||qh+"anon.jpeg",alt:d.displayName,title:d.displayName+(d.bs?" ("+G.jp+")":"")});e.style.backgroundColor=d.color;a.appendChild(e)}}}function cm(){em()}function dm(){em()}function pi(a){var b=Rl+"-"+a;return Ui.has(b)?pi("-"+a):b};/*
...
W.jr,!0)},Yr:function(a){document.body.innerHTML=a;a=document.getElementById("blockly");a.style.height=window.innerHeight+"px";rl(a,{media:"media/",readOnly:!0,Iu:-1!=qm.indexOf(rm),scrollbars:!1});a=um("xml","");W.hi("<xml>"+a+"</xml>")},gs:function(a,b){if("BlocklyStorage"in window&&1<window.location.hash.length)BlocklyStorage.retrieveXml(window.location.hash.substring(1));else{var c=null;try{c=window.sessionStorage.nk}catch(d){}c&&delete window.sessionStorage.nk;var e=xm(H),h=b&&xm(H-1);(c=c||
...
X.su=function(){var a=document.getElementById("dialogDone");A&&(document.getElementById("dialogLinesText").textContent='You have finished creating your avatar! Click "OK" to save a picture of your avatar or "Cancel" continue dressing up your avatar.');var b=document.getElementById("containerCode");a.removeChild(b);b=document.getElementById("doneCancel");b.addEventListener("click",X.mb,!0);b.addEventListener("touchend",X.mb,!0);b=document.getElementById("doneOk");document.getElementById("doneOk").innerHTML=
"OK";b.addEventListener("click",function(){html2canvas([document.getElementById("visualization")],{zs:function(a){a=a.toDataURL("image/png");window.Jd(a)}})},!0);b.addEventListener("touchend",function(){html2canvas([document.getElementById("visualization")],{zs:function(a){a=a.toDataURL("image/png");window.Jd(a)}})},!0);X.Kc(a,null,!1,!0,{width:"40%",left:"30%",top:"3em"},function(){document.body.removeEventListener("keydown",X.Ed,!0)});document.body.addEventListener("keydown",X.Ed,!0)};
X.Bu=function(){alert("login");document.getElementById("login")};
...
(1==a?'<h3> Learn Sequentiality! </h3>Put the blocks together to help Ada draw a square! Change the value of the fields to make Ada move correctly.<br><img src="turtle/square.gif" height=146 width=146 style="margin-bottom: -50px">':"")+(2==a?"<h3> Learn Loops! </h3>Now, use a loop from the toolbar to help Ada draw a square.":"")+(3==a?"Now, help Ada draw a hexagon using loops.":"")+"</div>"+$m()+"</div>"+(2==a?'<div id="helpToolbox" class="dialogHiddenContent"><div><img src="turtle/help_left.png" class="mirrorImg" height=23 width=64></div>Choose a category to see the blocks.</div>':
"")};var zm="turtle";W.Oh=function(){window.location=window.location.protocol+"//"+window.location.host+"/movie?lang="+rm+"&level="+(H+2)};var cn=[],dn=0,en=null,fn=!0;
